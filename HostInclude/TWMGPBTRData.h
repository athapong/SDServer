#ifndef AsdTWMGPBTRData_H
#define AsdTWMGPBTRData_H

#include <stdlib.h>
#ifdef  AsdTWMGPBTR_INTEGRITY_STRING
#undef  AsdTWMGPBTR_INTEGRITY_STRING
#endif
#define AsdTWMGPBTR_INTEGRITY_STRING        ""

#ifdef  AsdTWMGPBTR_CRC_STRING
#undef  AsdTWMGPBTR_CRC_STRING
#endif
#define AsdTWMGPBTR_CRC_STRING "1357454595"
...
//**************** Start AsdTWMGPBTRData Definition ****************
//                 Mega Tran With Passbook

//                 TWMGPBTRData.h generated by AceGen2 ver. 2.5.09

class AsdTWMGPBTRData
{
  public:
  ...
  public:
    AsdTWMGPBTRData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "TWMGPBTR.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdTWMGPBTR_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdTWMGPBTR_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdTWMGPBTR_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CTWMEGAIN.Save(&m_Sess);
        CSDSTPBMB.Save(&m_Sess);
        CSDSTPBMO.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "TWMGPBTR", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CTWMEGAIN.Load(&m_Sess);
                        CSDSTPBMB.Load(&m_Sess);
                        CSDSTPBMO.Load(&m_Sess);
                        CTWMEGFEE.Load(&m_Sess);
                        CSDSTPBPL.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "TWMGPBTR");
                    }
    ...
    class AsdTWMEGAIN
    {
      ...
      public:
        ...
        {
            return SetString(rwc, m_szNoOfDrItems, sizeof(m_szNoOfDrItems), &m_bNoOfDrItems);
        }
        ...
        {
            return SetString(rwc, m_szNoOfCrItems, sizeof(m_szNoOfCrItems), &m_bNoOfCrItems);
        }
        ...
        {
            return SetString(rwc, m_szCarryIn, sizeof(m_szCarryIn), &m_bCarryIn);
        }
        ...
        {
            return SetString(rwc, m_szCarryOut, sizeof(m_szCarryOut), &m_bCarryOut);
        }
        ...
        {
            return SetString(rwc, m_szOutstandingChksFlag, sizeof(m_szOutstandingChksFlag), &m_bOutstandingChksFlag);
        }
        ...
        {
            return SetString(rwc, m_szBackdateFlag, sizeof(m_szBackdateFlag), &m_bBackdateFlag);
        }
        ...
        {
            return SetString(rwc, m_szBackdateEffectiveDate, sizeof(m_szBackdateEffectiveDate), &m_bBackdateEffectiveDate);
        }
        ...
        {
            return SetString(rwc, m_szMegaComExpandArea, sizeof(m_szMegaComExpandArea), &m_bMegaComExpandArea);
        }
        ...
        class AsdDebitItems
        {
          ...
          public:
            ...
            {
                return SetString(rwc, m_szDrCtl1, sizeof(m_szDrCtl1), &m_bDrCtl1);
            }
            ...
            {
                return SetString(rwc, m_szDrCtl2, sizeof(m_szDrCtl2), &m_bDrCtl2);
            }
            ...
            {
                return SetString(rwc, m_szDrCtl3, sizeof(m_szDrCtl3), &m_bDrCtl3);
            }
            ...
            {
                return SetString(rwc, m_szDrCtl4, sizeof(m_szDrCtl4), &m_bDrCtl4);
            }
            ...
            {
                return SetString(rwc, m_szDrAcctNbr, sizeof(m_szDrAcctNbr), &m_bDrAcctNbr);
            }
            ...
            {
                return SetString(rwc, m_szDrType, sizeof(m_szDrType), &m_bDrType);
            }
            ...
            {
                return SetString(rwc, m_szDrUserTranCd, sizeof(m_szDrUserTranCd), &m_bDrUserTranCd);
            }
            ...
            {
                return SetString(rwc, m_szDrAmount, sizeof(m_szDrAmount), &m_bDrAmount);
            }
            ...
            {
                return SetString(rwc, m_szDrCheckNumber, sizeof(m_szDrCheckNumber), &m_bDrCheckNumber);
            }
            ...
            {
                return SetString(rwc, m_szDrNewAccount, sizeof(m_szDrNewAccount), &m_bDrNewAccount);
            }
            ...
            {
                return SetString(rwc, m_szDrWaiveFees, sizeof(m_szDrWaiveFees), &m_bDrWaiveFees);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeAmount, sizeof(m_szDrFeeAmount), &m_bDrFeeAmount);
            }
            ...
            {
                return SetString(rwc, m_szDrTraceNumber, sizeof(m_szDrTraceNumber), &m_bDrTraceNumber);
            }
            ...
            {
                return SetString(rwc, m_szDrTranDesc, sizeof(m_szDrTranDesc), &m_bDrTranDesc);
            }
            ...
            {
                return SetString(rwc, m_szDrRaCode, sizeof(m_szDrRaCode), &m_bDrRaCode);
            }
            ...
            {
                return SetString(rwc, m_szDrRaCalYear, sizeof(m_szDrRaCalYear), &m_bDrRaCalYear);
            }
            ...
            {
                return SetString(rwc, m_szDrAvailableBalance, sizeof(m_szDrAvailableBalance), &m_bDrAvailableBalance);
            }
            ...
            {
                return SetString(rwc, m_szDrEffectiveDate, sizeof(m_szDrEffectiveDate), &m_bDrEffectiveDate);
            }
            ...
            {
                return SetString(rwc, m_szDrAcctExpandArea, sizeof(m_szDrAcctExpandArea), &m_bDrAcctExpandArea);
            }
        ...
        class AsdCreditItems
        {
          ...
          public:
            ...
            {
                return SetString(rwc, m_szCrCtl1, sizeof(m_szCrCtl1), &m_bCrCtl1);
            }
            ...
            {
                return SetString(rwc, m_szCrCtl2, sizeof(m_szCrCtl2), &m_bCrCtl2);
            }
            ...
            {
                return SetString(rwc, m_szCrCtl3, sizeof(m_szCrCtl3), &m_bCrCtl3);
            }
            ...
            {
                return SetString(rwc, m_szCrCtl4, sizeof(m_szCrCtl4), &m_bCrCtl4);
            }
            ...
            {
                return SetString(rwc, m_szCrAcctNbr, sizeof(m_szCrAcctNbr), &m_bCrAcctNbr);
            }
            ...
            {
                return SetString(rwc, m_szCrType, sizeof(m_szCrType), &m_bCrType);
            }
            ...
            {
                return SetString(rwc, m_szCrUserTranCd, sizeof(m_szCrUserTranCd), &m_bCrUserTranCd);
            }
            ...
            {
                return SetString(rwc, m_szCrAmount, sizeof(m_szCrAmount), &m_bCrAmount);
            }
            ...
            {
                return SetString(rwc, m_szCrNewAccount, sizeof(m_szCrNewAccount), &m_bCrNewAccount);
            }
            ...
            {
                return SetString(rwc, m_szCrWaiveFees, sizeof(m_szCrWaiveFees), &m_bCrWaiveFees);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeAmount, sizeof(m_szCrFeeAmount), &m_bCrFeeAmount);
            }
            ...
            {
                return SetString(rwc, m_szCrTraceNumber, sizeof(m_szCrTraceNumber), &m_bCrTraceNumber);
            }
            ...
            {
                return SetString(rwc, m_szCrTranDesc, sizeof(m_szCrTranDesc), &m_bCrTranDesc);
            }
            ...
            {
                return SetString(rwc, m_szCrRaCode, sizeof(m_szCrRaCode), &m_bCrRaCode);
            }
            ...
            {
                return SetString(rwc, m_szCrRaCalYear, sizeof(m_szCrRaCalYear), &m_bCrRaCalYear);
            }
            ...
            {
                return SetString(rwc, m_szCrAvailableBalance, sizeof(m_szCrAvailableBalance), &m_bCrAvailableBalance);
            }
            ...
            {
                return SetString(rwc, m_szCrEffectiveDate, sizeof(m_szCrEffectiveDate), &m_bCrEffectiveDate);
            }
            ...
            {
                return SetString(rwc, m_szCrAcctExpandArea, sizeof(m_szCrAcctExpandArea), &m_bCrAcctExpandArea);
            }
        ...
        class AsdDebitCreditItems
        {
          ...
          public:
            ...
            {
                return SetString(rwc, m_szCrShortName, sizeof(m_szCrShortName), &m_bCrShortName);
            }
            ...
            {
                return SetString(rwc, m_szCrDateOpened, sizeof(m_szCrDateOpened), &m_bCrDateOpened);
            }
    ...
    //**************** Start AsdSDSTPBMB Definition ****************
    //                 PASSBOOK PRINT INFO FOR MONETARY TRANSACTIONS               
    ...
    class AsdSDSTPBMB
    {
      private:
        ...
        bool      m_bReceived;
        char      m_szSuppressBuff[100];
        bool      m_bDrBegPbkBalance;
        char      m_szDrBegPbkBalance[19+1];
        bool      m_bDrMoreIndicator;
        char      m_szDrMoreIndicator[1+1];
        bool      m_bDrNbrRecsReturned;
        char      m_szDrNbrRecsReturned[4+1];
        bool      m_bDrCtl1;
        char      m_szDrCtl1[2+1];
        bool      m_bDrCtl2;
        char      m_szDrCtl2[3+1];
        ...
        char      m_szDrCtl4[3+1];
        bool      m_bDrAcctNbr;
        char      m_szDrAcctNbr[14+1];
        bool      m_bDrSaveKey;
        char      m_szDrSaveKey[36+1];
        bool      m_bCrBegPbkBalance;
        char      m_szCrBegPbkBalance[19+1];
        bool      m_bCrMoreIndicator;
        char      m_szCrMoreIndicator[1+1];
        bool      m_bCrNbrRecsReturned;
        char      m_szCrNbrRecsReturned[4+1];
        bool      m_bCrCtl1;
        char      m_szCrCtl1[2+1];
        bool      m_bCrCtl2;
        char      m_szCrCtl2[3+1];
        ...
        char      m_szCrCtl4[3+1];
        bool      m_bCrAcctNbr;
        char      m_szCrAcctNbr[14+1];
        bool      m_bCrSaveKey;
        char      m_szCrSaveKey[36+1];
    
      public:
        long      m_lIndex;

        AsdSDSTPBMB ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            m_lIndex = -1;
            m_bDrBegPbkBalance = false;
            strcpy(m_szDrBegPbkBalance, "+000000000000000.00");
            m_bDrMoreIndicator = false;
            strcpy(m_szDrMoreIndicator, "");
            m_bDrNbrRecsReturned = false;
            strcpy(m_szDrNbrRecsReturned, "+000");
            m_bDrCtl1 = false;
            strcpy(m_szDrCtl1, "");
            m_bDrCtl2 = false;
            strcpy(m_szDrCtl2, "");
            ...
            strcpy(m_szDrAcctNbr, "");
            m_bDrSaveKey = false;
            strcpy(m_szDrSaveKey, "");
            m_bCrBegPbkBalance = false;
            strcpy(m_szCrBegPbkBalance, "+000000000000000.00");
            m_bCrMoreIndicator = false;
            strcpy(m_szCrMoreIndicator, "");
            m_bCrNbrRecsReturned = false;
            strcpy(m_szCrNbrRecsReturned, "+000");
            m_bCrCtl1 = false;
            strcpy(m_szCrCtl1, "");
            m_bCrCtl2 = false;
            strcpy(m_szCrCtl2, "");
        ...
        //    DR ITEM BEG PASSBOOK BALANCE
        long lDrBegPbkBalance () { return 19; };
        RWCString DrBegPbkBalance (void)
        {
            return AceZeroSupp(m_szDrBegPbkBalance, &m_szSuppressBuff[0]);
        }
        RWCString DrBegPbkBalanceRaw (void)
        {
            return m_szDrBegPbkBalance;
        }
        long DrBegPbkBalance (const RWCString& rwc)
        {
            return SetString(rwc, m_szDrBegPbkBalance, sizeof(m_szDrBegPbkBalance), &m_bDrBegPbkBalance);
        }
        
        //    DR ITEM MORE RECORDS INDICATOR
        long lDrMoreIndicator () { return 1; };
        RWCString DrMoreIndicator (void)
        {
            return m_szDrMoreIndicator;
        }
        long DrMoreIndicator (const RWCString& rwc)
        {
            return SetString(rwc, m_szDrMoreIndicator, sizeof(m_szDrMoreIndicator), &m_bDrMoreIndicator);
        }
        
        //    DR ITEM NBR RECORDS RETURNED
        long lDrNbrRecsReturned () { return 4; };
        RWCString DrNbrRecsReturned (void)
        {
            return AceZeroSupp(m_szDrNbrRecsReturned, &m_szSuppressBuff[0]);
        }
        RWCString DrNbrRecsReturnedRaw (void)
        {
            return m_szDrNbrRecsReturned;
        }
        long DrNbrRecsReturned (const RWCString& rwc)
        {
            return SetString(rwc, m_szDrNbrRecsReturned, sizeof(m_szDrNbrRecsReturned), &m_bDrNbrRecsReturned);
        }
        ...
        //    DR ITEM ACCOUNT NUMBER
        long lDrAcctNbr () { return 14; };
        RWCString DrAcctNbr (void)
        {
            return m_szDrAcctNbr;
        }
        ...
        //    DR ITEM SAVE KEY
        long lDrSaveKey () { return 36; };
        RWCString DrSaveKey (void)
        {
            return m_szDrSaveKey;
        }
        long DrSaveKey (const RWCString& rwc)
        {
            return SetString(rwc, m_szDrSaveKey, sizeof(m_szDrSaveKey), &m_bDrSaveKey);
        }
        
        //    CR ITEM BEG PASSBOOK BALANCE
        long lCrBegPbkBalance () { return 19; };
        RWCString CrBegPbkBalance (void)
        {
            return AceZeroSupp(m_szCrBegPbkBalance, &m_szSuppressBuff[0]);
        }
        RWCString CrBegPbkBalanceRaw (void)
        {
            return m_szCrBegPbkBalance;
        }
        long CrBegPbkBalance (const RWCString& rwc)
        {
            return SetString(rwc, m_szCrBegPbkBalance, sizeof(m_szCrBegPbkBalance), &m_bCrBegPbkBalance);
        }
        
        //    CR ITEM MORE RECORDS INDICATOR
        long lCrMoreIndicator () { return 1; };
        RWCString CrMoreIndicator (void)
        {
            return m_szCrMoreIndicator;
        }
        long CrMoreIndicator (const RWCString& rwc)
        {
            return SetString(rwc, m_szCrMoreIndicator, sizeof(m_szCrMoreIndicator), &m_bCrMoreIndicator);
        }
        
        //    CR ITEM NBR RECORDS RETURNED
        long lCrNbrRecsReturned () { return 4; };
        RWCString CrNbrRecsReturned (void)
        {
            return AceZeroSupp(m_szCrNbrRecsReturned, &m_szSuppressBuff[0]);
        }
        RWCString CrNbrRecsReturnedRaw (void)
        {
            return m_szCrNbrRecsReturned;
        }
        long CrNbrRecsReturned (const RWCString& rwc)
        {
            return SetString(rwc, m_szCrNbrRecsReturned, sizeof(m_szCrNbrRecsReturned), &m_bCrNbrRecsReturned);
        }
        ...
        //    CR ITEM ACCOUNT NUMBER
        long lCrAcctNbr () { return 14; };
        RWCString CrAcctNbr (void)
        {
            return m_szCrAcctNbr;
        }
        ...
        //    CR ITEM SAVE KEY
        long lCrSaveKey () { return 36; };
        RWCString CrSaveKey (void)
        {
            return m_szCrSaveKey;
        }
        long CrSaveKey (const RWCString& rwc)
        {
            return SetString(rwc, m_szCrSaveKey, sizeof(m_szCrSaveKey), &m_bCrSaveKey);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bDrBegPbkBalance) return true;
            if (m_bDrMoreIndicator) return true;
            if (m_bDrNbrRecsReturned) return true;
            if (m_bDrCtl1) return true;
            if (m_bDrCtl2) return true;
            if (m_bDrCtl3) return true;
            if (m_bDrCtl4) return true;
            if (m_bDrAcctNbr) return true;
            if (m_bDrSaveKey) return true;
            if (m_bCrBegPbkBalance) return true;
            if (m_bCrMoreIndicator) return true;
            if (m_bCrNbrRecsReturned) return true;
            if (m_bCrCtl1) return true;
            if (m_bCrCtl2) return true;
            if (m_bCrCtl3) return true;
            if (m_bCrCtl4) return true;
            if (m_bCrAcctNbr) return true;
            if (m_bCrSaveKey) return true;
            return false;
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDSTPBMB", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "DrBegPbkBalance", m_szDrBegPbkBalance, &m_bDrBegPbkBalance);
                AddXMLField(pSess, "DrMoreIndicator", m_szDrMoreIndicator, &m_bDrMoreIndicator);
                AddXMLField(pSess, "DrNbrRecsReturned", m_szDrNbrRecsReturned, &m_bDrNbrRecsReturned);
                AddXMLField(pSess, "DrCtl1", m_szDrCtl1, &m_bDrCtl1);
                AddXMLField(pSess, "DrCtl2", m_szDrCtl2, &m_bDrCtl2);
                AddXMLField(pSess, "DrCtl3", m_szDrCtl3, &m_bDrCtl3);
                AddXMLField(pSess, "DrCtl4", m_szDrCtl4, &m_bDrCtl4);
                AddXMLField(pSess, "DrAcctNbr", m_szDrAcctNbr, &m_bDrAcctNbr);
                AddXMLField(pSess, "DrSaveKey", m_szDrSaveKey, &m_bDrSaveKey);
                AddXMLField(pSess, "CrBegPbkBalance", m_szCrBegPbkBalance, &m_bCrBegPbkBalance);
                AddXMLField(pSess, "CrMoreIndicator", m_szCrMoreIndicator, &m_bCrMoreIndicator);
                AddXMLField(pSess, "CrNbrRecsReturned", m_szCrNbrRecsReturned, &m_bCrNbrRecsReturned);
                AddXMLField(pSess, "CrCtl1", m_szCrCtl1, &m_bCrCtl1);
                AddXMLField(pSess, "CrCtl2", m_szCrCtl2, &m_bCrCtl2);
                AddXMLField(pSess, "CrCtl3", m_szCrCtl3, &m_bCrCtl3);
                AddXMLField(pSess, "CrCtl4", m_szCrCtl4, &m_bCrCtl4);
                AddXMLField(pSess, "CrAcctNbr", m_szCrAcctNbr, &m_bCrAcctNbr);
                AddXMLField(pSess, "CrSaveKey", m_szCrSaveKey, &m_bCrSaveKey);
                AddXMLCloseRecord(pSess, "SDSTPBMB");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDSTPBMB", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "DrBegPbkBalance", m_szDrBegPbkBalance);
                GetXMLField(pSess, "DrMoreIndicator", m_szDrMoreIndicator);
                GetXMLField(pSess, "DrNbrRecsReturned", m_szDrNbrRecsReturned);
                GetXMLField(pSess, "DrCtl1", m_szDrCtl1);
                GetXMLField(pSess, "DrCtl2", m_szDrCtl2);
                GetXMLField(pSess, "DrCtl3", m_szDrCtl3);
                GetXMLField(pSess, "DrCtl4", m_szDrCtl4);
                GetXMLField(pSess, "DrAcctNbr", m_szDrAcctNbr);
                GetXMLField(pSess, "DrSaveKey", m_szDrSaveKey);
                GetXMLField(pSess, "CrBegPbkBalance", m_szCrBegPbkBalance);
                GetXMLField(pSess, "CrMoreIndicator", m_szCrMoreIndicator);
                GetXMLField(pSess, "CrNbrRecsReturned", m_szCrNbrRecsReturned);
                GetXMLField(pSess, "CrCtl1", m_szCrCtl1);
                GetXMLField(pSess, "CrCtl2", m_szCrCtl2);
                GetXMLField(pSess, "CrCtl3", m_szCrCtl3);
                GetXMLField(pSess, "CrCtl4", m_szCrCtl4);
                GetXMLField(pSess, "CrAcctNbr", m_szCrAcctNbr);
                GetXMLField(pSess, "CrSaveKey", m_szCrSaveKey);
                CloseXMLRecord(pSess, "SDSTPBMB");
            };
        }
    };

    AsdSDSTPBMB CSDSTPBMB;
    AsdSDSTPBMB *SDSTPBMB;
    
    //**************** End AsdSDSTPBMB Definition ****************

    
    //**************** Start AsdSDSTPBMO Definition ****************
    //                 PASSBOOK PRINT FOR MONETARY TRANSACTIONS                    
    
    //    SDSTPBMO.map
    //    generated by Dsm2Ace ver. 2.3.03
    //    on 03/21/03 14:53:09
    class AsdSDSTPBMO
    {
      private:
        bool      m_bHostInitOverride;
      ...
      public:
        ...
        AsdSDSTPBMO ()  // Constructor
        {
            ...
            {
                DrItemPrintRecord[lOccurs]  = &CDrItemPrintRecord[lOccurs];
                CDrItemPrintRecord[lOccurs].m_lIndex = lOccurs;
            }
        
            for (lOccurs = 0; lOccurs < 10; lOccurs++)
            {
                CrItemPrintRecord[lOccurs]  = &CCrItemPrintRecord[lOccurs];
                CCrItemPrintRecord[lOccurs].m_lIndex = lOccurs;
            }
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            for (lOccurs = 0; lOccurs < 10; lOccurs++)
            {
                if(CDrItemPrintRecord[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
            for (lOccurs = 0; lOccurs < 10; lOccurs++)
            {
                if(CCrItemPrintRecord[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDSTPBMO", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
                    CDrItemPrintRecord[lOccurs].Save(pSess);
                }
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
                    CCrItemPrintRecord[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "SDSTPBMO");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDSTPBMO", m_lIndex, &m_bReceived))
            {
                long lOccurs;
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
                    CDrItemPrintRecord[lOccurs].Load(pSess);
                }
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
                    CCrItemPrintRecord[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "SDSTPBMO");
            };
        }
        
        //**************** Start AsdDrItemPrintRecord Definition ****************
        //                 DR ITEM PRINT RECORD
        
        class AsdDrItemPrintRecord
        {
          private:
            bool      m_bReceived;
            char      m_szSuppressBuff[100];
            bool      m_bDrEffDate;
            char      m_szDrEffDate[8+1];
            bool      m_bDrPostDate;
            char      m_szDrPostDate[8+1];
            bool      m_bDrPhysBranch;
            char      m_szDrPhysBranch[4+1];
            bool      m_bDrTranTeller;
            char      m_szDrTranTeller[8+1];
            bool      m_bDrSerialNo;
            char      m_szDrSerialNo[8+1];
            bool      m_bDrTranTime;
            char      m_szDrTranTime[8+1];
            bool      m_bDrTranCode;
            char      m_szDrTranCode[2+1];
            bool      m_bDrTranAmt;
            char      m_szDrTranAmt[19+1];
            bool      m_bDrUserTranCode;
            char      m_szDrUserTranCode[4+1];
            bool      m_bDrUserSubCode;
            char      m_szDrUserSubCode[2+1];
            bool      m_bDrPrintStatus;
            char      m_szDrPrintStatus[1+1];
            bool      m_bDrPostStatus;
            char      m_szDrPostStatus[1+1];
            bool      m_bDrDeleteFlag;
            char      m_szDrDeleteFlag[1+1];
            bool      m_bDrReverseFlag;
            char      m_szDrReverseFlag[1+1];
            bool      m_bDrRunningBalance;
            char      m_szDrRunningBalance[19+1];
        
          public:
            long      m_lIndex;

            AsdDrItemPrintRecord ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bDrEffDate = false;
                strcpy(m_szDrEffDate, "");
                m_bDrPostDate = false;
                strcpy(m_szDrPostDate, "");
                m_bDrPhysBranch = false;
                strcpy(m_szDrPhysBranch, "");
                m_bDrTranTeller = false;
                strcpy(m_szDrTranTeller, "");
                m_bDrSerialNo = false;
                strcpy(m_szDrSerialNo, "");
                m_bDrTranTime = false;
                strcpy(m_szDrTranTime, "");
                m_bDrTranCode = false;
                strcpy(m_szDrTranCode, "");
                m_bDrTranAmt = false;
                strcpy(m_szDrTranAmt, "+000000000000000.00");
                m_bDrUserTranCode = false;
                strcpy(m_szDrUserTranCode, "");
                m_bDrUserSubCode = false;
                strcpy(m_szDrUserSubCode, "");
                m_bDrPrintStatus = false;
                strcpy(m_szDrPrintStatus, "");
                m_bDrPostStatus = false;
                strcpy(m_szDrPostStatus, "");
                m_bDrDeleteFlag = false;
                strcpy(m_szDrDeleteFlag, "");
                m_bDrReverseFlag = false;
                strcpy(m_szDrReverseFlag, "");
                m_bDrRunningBalance = false;
                strcpy(m_szDrRunningBalance, "+000000000000000.00");
            ...
            //    DR ITEM EFFECTIVE DATE
            long lDrEffDate () { return 8; };
            RWCString DrEffDate (void)
            {
                return m_szDrEffDate;
            }
            long DrEffDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrEffDate, sizeof(m_szDrEffDate), &m_bDrEffDate);
            }
            
            //    DR ITEM POST DATE
            long lDrPostDate () { return 8; };
            RWCString DrPostDate (void)
            {
                return m_szDrPostDate;
            }
            long DrPostDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrPostDate, sizeof(m_szDrPostDate), &m_bDrPostDate);
            }
            
            //    DR ITEM PHYSICAL BRANCH
            long lDrPhysBranch () { return 4; };
            RWCString DrPhysBranch (void)
            {
                return m_szDrPhysBranch;
            }
            long DrPhysBranch (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrPhysBranch, sizeof(m_szDrPhysBranch), &m_bDrPhysBranch);
            }
            
            //    DR ITEM TRAN TELLER
            long lDrTranTeller () { return 8; };
            RWCString DrTranTeller (void)
            {
                return m_szDrTranTeller;
            }
            long DrTranTeller (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrTranTeller, sizeof(m_szDrTranTeller), &m_bDrTranTeller);
            }
            
            //    DR ITEM SERIAL NUMBER
            long lDrSerialNo () { return 8; };
            RWCString DrSerialNo (void)
            {
                return m_szDrSerialNo;
            }
            long DrSerialNo (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrSerialNo, sizeof(m_szDrSerialNo), &m_bDrSerialNo);
            }
            
            //    DR ITEM TRAN TIME
            long lDrTranTime () { return 8; };
            RWCString DrTranTime (void)
            {
                return m_szDrTranTime;
            }
            long DrTranTime (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrTranTime, sizeof(m_szDrTranTime), &m_bDrTranTime);
            }
            
            //    DR ITEM TRAN CODE
            long lDrTranCode () { return 2; };
            RWCString DrTranCode (void)
            {
                return m_szDrTranCode;
            }
            long DrTranCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrTranCode, sizeof(m_szDrTranCode), &m_bDrTranCode);
            }
            
            //    DR ITEM TRAN AMOUNT
            long lDrTranAmt () { return 19; };
            RWCString DrTranAmt (void)
            {
                return AceZeroSupp(m_szDrTranAmt, &m_szSuppressBuff[0]);
            }
            RWCString DrTranAmtRaw (void)
            {
                return m_szDrTranAmt;
            }
            long DrTranAmt (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrTranAmt, sizeof(m_szDrTranAmt), &m_bDrTranAmt);
            }
            
            //    DR ITEM USER TRAN CODE
            long lDrUserTranCode () { return 4; };
            RWCString DrUserTranCode (void)
            {
                return m_szDrUserTranCode;
            }
            long DrUserTranCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrUserTranCode, sizeof(m_szDrUserTranCode), &m_bDrUserTranCode);
            }
            
            //    DR ITEM USER SUB CODE
            long lDrUserSubCode () { return 2; };
            RWCString DrUserSubCode (void)
            {
                return m_szDrUserSubCode;
            }
            long DrUserSubCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrUserSubCode, sizeof(m_szDrUserSubCode), &m_bDrUserSubCode);
            }
            
            //    DR ITEM PRINT STATUS
            long lDrPrintStatus () { return 1; };
            RWCString DrPrintStatus (void)
            {
                return m_szDrPrintStatus;
            }
            long DrPrintStatus (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrPrintStatus, sizeof(m_szDrPrintStatus), &m_bDrPrintStatus);
            }
            
            //    DR ITEM POST STATUS
            long lDrPostStatus () { return 1; };
            RWCString DrPostStatus (void)
            {
                return m_szDrPostStatus;
            }
            long DrPostStatus (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrPostStatus, sizeof(m_szDrPostStatus), &m_bDrPostStatus);
            }
            
            //    DR ITEM DELETE FLAG
            long lDrDeleteFlag () { return 1; };
            RWCString DrDeleteFlag (void)
            {
                return m_szDrDeleteFlag;
            }
            long DrDeleteFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrDeleteFlag, sizeof(m_szDrDeleteFlag), &m_bDrDeleteFlag);
            }
            
            //    DR ITEM REVERSE FLAG
            long lDrReverseFlag () { return 1; };
            RWCString DrReverseFlag (void)
            {
                return m_szDrReverseFlag;
            }
            long DrReverseFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrReverseFlag, sizeof(m_szDrReverseFlag), &m_bDrReverseFlag);
            }
            
            //    DR ITEM PASSBOOK RUNNING BALANCE
            long lDrRunningBalance () { return 19; };
            RWCString DrRunningBalance (void)
            {
                return AceZeroSupp(m_szDrRunningBalance, &m_szSuppressBuff[0]);
            }
            RWCString DrRunningBalanceRaw (void)
            {
                return m_szDrRunningBalance;
            }
            long DrRunningBalance (const RWCString& rwc)
            {
                return SetString(rwc, m_szDrRunningBalance, sizeof(m_szDrRunningBalance), &m_bDrRunningBalance);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bDrEffDate) return true;
                if (m_bDrPostDate) return true;
                if (m_bDrPhysBranch) return true;
                if (m_bDrTranTeller) return true;
                if (m_bDrSerialNo) return true;
                if (m_bDrTranTime) return true;
                if (m_bDrTranCode) return true;
                if (m_bDrTranAmt) return true;
                if (m_bDrUserTranCode) return true;
                if (m_bDrUserSubCode) return true;
                if (m_bDrPrintStatus) return true;
                if (m_bDrPostStatus) return true;
                if (m_bDrDeleteFlag) return true;
                if (m_bDrReverseFlag) return true;
                if (m_bDrRunningBalance) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "DrItemPrintRecord", m_lIndex);
                    AddXMLField(pSess, "DrEffDate", m_szDrEffDate, &m_bDrEffDate);
                    AddXMLField(pSess, "DrPostDate", m_szDrPostDate, &m_bDrPostDate);
                    AddXMLField(pSess, "DrPhysBranch", m_szDrPhysBranch, &m_bDrPhysBranch);
                    AddXMLField(pSess, "DrTranTeller", m_szDrTranTeller, &m_bDrTranTeller);
                    AddXMLField(pSess, "DrSerialNo", m_szDrSerialNo, &m_bDrSerialNo);
                    AddXMLField(pSess, "DrTranTime", m_szDrTranTime, &m_bDrTranTime);
                    AddXMLField(pSess, "DrTranCode", m_szDrTranCode, &m_bDrTranCode);
                    AddXMLField(pSess, "DrTranAmt", m_szDrTranAmt, &m_bDrTranAmt);
                    AddXMLField(pSess, "DrUserTranCode", m_szDrUserTranCode, &m_bDrUserTranCode);
                    AddXMLField(pSess, "DrUserSubCode", m_szDrUserSubCode, &m_bDrUserSubCode);
                    AddXMLField(pSess, "DrPrintStatus", m_szDrPrintStatus, &m_bDrPrintStatus);
                    AddXMLField(pSess, "DrPostStatus", m_szDrPostStatus, &m_bDrPostStatus);
                    AddXMLField(pSess, "DrDeleteFlag", m_szDrDeleteFlag, &m_bDrDeleteFlag);
                    AddXMLField(pSess, "DrReverseFlag", m_szDrReverseFlag, &m_bDrReverseFlag);
                    AddXMLField(pSess, "DrRunningBalance", m_szDrRunningBalance, &m_bDrRunningBalance);
                    AddXMLCloseRecord(pSess, "DrItemPrintRecord");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "DrItemPrintRecord", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "DrEffDate", m_szDrEffDate);
                    GetXMLField(pSess, "DrPostDate", m_szDrPostDate);
                    GetXMLField(pSess, "DrPhysBranch", m_szDrPhysBranch);
                    GetXMLField(pSess, "DrTranTeller", m_szDrTranTeller);
                    GetXMLField(pSess, "DrSerialNo", m_szDrSerialNo);
                    GetXMLField(pSess, "DrTranTime", m_szDrTranTime);
                    GetXMLField(pSess, "DrTranCode", m_szDrTranCode);
                    GetXMLField(pSess, "DrTranAmt", m_szDrTranAmt);
                    GetXMLField(pSess, "DrUserTranCode", m_szDrUserTranCode);
                    GetXMLField(pSess, "DrUserSubCode", m_szDrUserSubCode);
                    GetXMLField(pSess, "DrPrintStatus", m_szDrPrintStatus);
                    GetXMLField(pSess, "DrPostStatus", m_szDrPostStatus);
                    GetXMLField(pSess, "DrDeleteFlag", m_szDrDeleteFlag);
                    GetXMLField(pSess, "DrReverseFlag", m_szDrReverseFlag);
                    GetXMLField(pSess, "DrRunningBalance", m_szDrRunningBalance);
                    CloseXMLRecord(pSess, "DrItemPrintRecord");
                };
            }
        };

        AsdDrItemPrintRecord  CDrItemPrintRecord[10];
        AsdDrItemPrintRecord *DrItemPrintRecord[10];
        
        //**************** End AsdDrItemPrintRecord Definition ****************
        
        
        //**************** Start AsdCrItemPrintRecord Definition ****************
        //                 CR ITEM PRINT RECORD
        
        class AsdCrItemPrintRecord
        {
          private:
            bool      m_bReceived;
            char      m_szSuppressBuff[100];
            bool      m_bCrEffDate;
            char      m_szCrEffDate[8+1];
            bool      m_bCrPostDate;
            char      m_szCrPostDate[8+1];
            bool      m_bCrPhysBranch;
            char      m_szCrPhysBranch[4+1];
            bool      m_bCrTranTeller;
            char      m_szCrTranTeller[8+1];
            bool      m_bCrSerialNo;
            char      m_szCrSerialNo[8+1];
            bool      m_bCrTranTime;
            char      m_szCrTranTime[8+1];
            bool      m_bCrTranCode;
            char      m_szCrTranCode[2+1];
            bool      m_bCrTranAmt;
            char      m_szCrTranAmt[19+1];
            bool      m_bCrUserTranCode;
            char      m_szCrUserTranCode[4+1];
            bool      m_bCrUserSubCode;
            char      m_szCrUserSubCode[2+1];
            bool      m_bCrPrintStatus;
            char      m_szCrPrintStatus[1+1];
            bool      m_bCrPostStatus;
            char      m_szCrPostStatus[1+1];
            bool      m_bCrDeleteFlag;
            char      m_szCrDeleteFlag[1+1];
            bool      m_bCrReverseFlag;
            char      m_szCrReverseFlag[1+1];
            bool      m_bCrRunningBalance;
            char      m_szCrRunningBalance[19+1];
        
          public:
            long      m_lIndex;

            AsdCrItemPrintRecord ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bCrEffDate = false;
                strcpy(m_szCrEffDate, "");
                m_bCrPostDate = false;
                strcpy(m_szCrPostDate, "");
                m_bCrPhysBranch = false;
                strcpy(m_szCrPhysBranch, "");
                m_bCrTranTeller = false;
                strcpy(m_szCrTranTeller, "");
                m_bCrSerialNo = false;
                strcpy(m_szCrSerialNo, "");
                m_bCrTranTime = false;
                strcpy(m_szCrTranTime, "");
                m_bCrTranCode = false;
                strcpy(m_szCrTranCode, "");
                m_bCrTranAmt = false;
                strcpy(m_szCrTranAmt, "+000000000000000.00");
                m_bCrUserTranCode = false;
                strcpy(m_szCrUserTranCode, "");
                m_bCrUserSubCode = false;
                strcpy(m_szCrUserSubCode, "");
                m_bCrPrintStatus = false;
                strcpy(m_szCrPrintStatus, "");
                m_bCrPostStatus = false;
                strcpy(m_szCrPostStatus, "");
                m_bCrDeleteFlag = false;
                strcpy(m_szCrDeleteFlag, "");
                m_bCrReverseFlag = false;
                strcpy(m_szCrReverseFlag, "");
                m_bCrRunningBalance = false;
                strcpy(m_szCrRunningBalance, "+000000000000000.00");
            ...
            //    CR ITEM EFFECTIVE DATE
            long lCrEffDate () { return 8; };
            RWCString CrEffDate (void)
            {
                return m_szCrEffDate;
            }
            long CrEffDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrEffDate, sizeof(m_szCrEffDate), &m_bCrEffDate);
            }
            
            //    CR ITEM POST DATE
            long lCrPostDate () { return 8; };
            RWCString CrPostDate (void)
            {
                return m_szCrPostDate;
            }
            long CrPostDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrPostDate, sizeof(m_szCrPostDate), &m_bCrPostDate);
            }
            
            //    CR ITEM PHYSICAL BRANCH
            long lCrPhysBranch () { return 4; };
            RWCString CrPhysBranch (void)
            {
                return m_szCrPhysBranch;
            }
            long CrPhysBranch (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrPhysBranch, sizeof(m_szCrPhysBranch), &m_bCrPhysBranch);
            }
            
            //    CR ITEM TRAN TELLER
            long lCrTranTeller () { return 8; };
            RWCString CrTranTeller (void)
            {
                return m_szCrTranTeller;
            }
            long CrTranTeller (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrTranTeller, sizeof(m_szCrTranTeller), &m_bCrTranTeller);
            }
            
            //    CR ITEM SERIAL NUMBER
            long lCrSerialNo () { return 8; };
            RWCString CrSerialNo (void)
            {
                return m_szCrSerialNo;
            }
            long CrSerialNo (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrSerialNo, sizeof(m_szCrSerialNo), &m_bCrSerialNo);
            }
            
            //    CR ITEM TRAN TIME
            long lCrTranTime () { return 8; };
            RWCString CrTranTime (void)
            {
                return m_szCrTranTime;
            }
            long CrTranTime (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrTranTime, sizeof(m_szCrTranTime), &m_bCrTranTime);
            }
            
            //    CR ITEM TRAN CODE
            long lCrTranCode () { return 2; };
            RWCString CrTranCode (void)
            {
                return m_szCrTranCode;
            }
            long CrTranCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrTranCode, sizeof(m_szCrTranCode), &m_bCrTranCode);
            }
            
            //    CR ITEM TRAN AMOUNT
            long lCrTranAmt () { return 19; };
            RWCString CrTranAmt (void)
            {
                return AceZeroSupp(m_szCrTranAmt, &m_szSuppressBuff[0]);
            }
            RWCString CrTranAmtRaw (void)
            {
                return m_szCrTranAmt;
            }
            long CrTranAmt (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrTranAmt, sizeof(m_szCrTranAmt), &m_bCrTranAmt);
            }
            
            //    CR ITEM USER TRAN CODE
            long lCrUserTranCode () { return 4; };
            RWCString CrUserTranCode (void)
            {
                return m_szCrUserTranCode;
            }
            long CrUserTranCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrUserTranCode, sizeof(m_szCrUserTranCode), &m_bCrUserTranCode);
            }
            
            //    CR ITEM USER SUB CODE
            long lCrUserSubCode () { return 2; };
            RWCString CrUserSubCode (void)
            {
                return m_szCrUserSubCode;
            }
            long CrUserSubCode (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrUserSubCode, sizeof(m_szCrUserSubCode), &m_bCrUserSubCode);
            }
            
            //    CR ITEM PRINT STATUS
            long lCrPrintStatus () { return 1; };
            RWCString CrPrintStatus (void)
            {
                return m_szCrPrintStatus;
            }
            long CrPrintStatus (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrPrintStatus, sizeof(m_szCrPrintStatus), &m_bCrPrintStatus);
            }
            
            //    CR ITEM POST STATUS
            long lCrPostStatus () { return 1; };
            RWCString CrPostStatus (void)
            {
                return m_szCrPostStatus;
            }
            long CrPostStatus (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrPostStatus, sizeof(m_szCrPostStatus), &m_bCrPostStatus);
            }
            
            //    CR ITEM DELETE FLAG
            long lCrDeleteFlag () { return 1; };
            RWCString CrDeleteFlag (void)
            {
                return m_szCrDeleteFlag;
            }
            long CrDeleteFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrDeleteFlag, sizeof(m_szCrDeleteFlag), &m_bCrDeleteFlag);
            }
            
            //    CR ITEM REVERSE FLAG
            long lCrReverseFlag () { return 1; };
            RWCString CrReverseFlag (void)
            {
                return m_szCrReverseFlag;
            }
            long CrReverseFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrReverseFlag, sizeof(m_szCrReverseFlag), &m_bCrReverseFlag);
            }
            
            //    CR ITEM PASSBOOK RUNNING BALANCE
            long lCrRunningBalance () { return 19; };
            RWCString CrRunningBalance (void)
            {
                return AceZeroSupp(m_szCrRunningBalance, &m_szSuppressBuff[0]);
            }
            RWCString CrRunningBalanceRaw (void)
            {
                return m_szCrRunningBalance;
            }
            long CrRunningBalance (const RWCString& rwc)
            {
                return SetString(rwc, m_szCrRunningBalance, sizeof(m_szCrRunningBalance), &m_bCrRunningBalance);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bCrEffDate) return true;
                if (m_bCrPostDate) return true;
                if (m_bCrPhysBranch) return true;
                if (m_bCrTranTeller) return true;
                if (m_bCrSerialNo) return true;
                if (m_bCrTranTime) return true;
                if (m_bCrTranCode) return true;
                if (m_bCrTranAmt) return true;
                if (m_bCrUserTranCode) return true;
                if (m_bCrUserSubCode) return true;
                if (m_bCrPrintStatus) return true;
                if (m_bCrPostStatus) return true;
                if (m_bCrDeleteFlag) return true;
                if (m_bCrReverseFlag) return true;
                if (m_bCrRunningBalance) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "CrItemPrintRecord", m_lIndex);
                    AddXMLField(pSess, "CrEffDate", m_szCrEffDate, &m_bCrEffDate);
                    AddXMLField(pSess, "CrPostDate", m_szCrPostDate, &m_bCrPostDate);
                    AddXMLField(pSess, "CrPhysBranch", m_szCrPhysBranch, &m_bCrPhysBranch);
                    AddXMLField(pSess, "CrTranTeller", m_szCrTranTeller, &m_bCrTranTeller);
                    AddXMLField(pSess, "CrSerialNo", m_szCrSerialNo, &m_bCrSerialNo);
                    AddXMLField(pSess, "CrTranTime", m_szCrTranTime, &m_bCrTranTime);
                    AddXMLField(pSess, "CrTranCode", m_szCrTranCode, &m_bCrTranCode);
                    AddXMLField(pSess, "CrTranAmt", m_szCrTranAmt, &m_bCrTranAmt);
                    AddXMLField(pSess, "CrUserTranCode", m_szCrUserTranCode, &m_bCrUserTranCode);
                    AddXMLField(pSess, "CrUserSubCode", m_szCrUserSubCode, &m_bCrUserSubCode);
                    AddXMLField(pSess, "CrPrintStatus", m_szCrPrintStatus, &m_bCrPrintStatus);
                    AddXMLField(pSess, "CrPostStatus", m_szCrPostStatus, &m_bCrPostStatus);
                    AddXMLField(pSess, "CrDeleteFlag", m_szCrDeleteFlag, &m_bCrDeleteFlag);
                    AddXMLField(pSess, "CrReverseFlag", m_szCrReverseFlag, &m_bCrReverseFlag);
                    AddXMLField(pSess, "CrRunningBalance", m_szCrRunningBalance, &m_bCrRunningBalance);
                    AddXMLCloseRecord(pSess, "CrItemPrintRecord");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "CrItemPrintRecord", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "CrEffDate", m_szCrEffDate);
                    GetXMLField(pSess, "CrPostDate", m_szCrPostDate);
                    GetXMLField(pSess, "CrPhysBranch", m_szCrPhysBranch);
                    GetXMLField(pSess, "CrTranTeller", m_szCrTranTeller);
                    GetXMLField(pSess, "CrSerialNo", m_szCrSerialNo);
                    GetXMLField(pSess, "CrTranTime", m_szCrTranTime);
                    GetXMLField(pSess, "CrTranCode", m_szCrTranCode);
                    GetXMLField(pSess, "CrTranAmt", m_szCrTranAmt);
                    GetXMLField(pSess, "CrUserTranCode", m_szCrUserTranCode);
                    GetXMLField(pSess, "CrUserSubCode", m_szCrUserSubCode);
                    GetXMLField(pSess, "CrPrintStatus", m_szCrPrintStatus);
                    GetXMLField(pSess, "CrPostStatus", m_szCrPostStatus);
                    GetXMLField(pSess, "CrDeleteFlag", m_szCrDeleteFlag);
                    GetXMLField(pSess, "CrReverseFlag", m_szCrReverseFlag);
                    GetXMLField(pSess, "CrRunningBalance", m_szCrRunningBalance);
                    CloseXMLRecord(pSess, "CrItemPrintRecord");
                };
            }
        };

        AsdCrItemPrintRecord  CCrItemPrintRecord[10];
        AsdCrItemPrintRecord *CrItemPrintRecord[10];
        
        //**************** End AsdCrItemPrintRecord Definition ****************
        
    };

    AsdSDSTPBMO CSDSTPBMO;
    AsdSDSTPBMO *SDSTPBMO;
    
    //**************** End AsdSDSTPBMO Definition ****************
      ...
      public:
        ...
        class AsdDbFeeDetails
        {
          ...
          public:
            ...
            {
                return SetString(rwc, m_szDrFeeType1, sizeof(m_szDrFeeType1), &m_bDrFeeType1);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeAmount1, sizeof(m_szDrFeeAmount1), &m_bDrFeeAmount1);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeType2, sizeof(m_szDrFeeType2), &m_bDrFeeType2);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeAmount2, sizeof(m_szDrFeeAmount2), &m_bDrFeeAmount2);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeType3, sizeof(m_szDrFeeType3), &m_bDrFeeType3);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeAmount3, sizeof(m_szDrFeeAmount3), &m_bDrFeeAmount3);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeType4, sizeof(m_szDrFeeType4), &m_bDrFeeType4);
            }
            ...
            {
                return SetString(rwc, m_szDrFeeAmount4, sizeof(m_szDrFeeAmount4), &m_bDrFeeAmount4);
            }
        ...
        class AsdCrFeeDetails
        {
          ...
          public:
            ...
            {
                return SetString(rwc, m_szCrFeeType1, sizeof(m_szCrFeeType1), &m_bCrFeeType1);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeAmount1, sizeof(m_szCrFeeAmount1), &m_bCrFeeAmount1);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeType2, sizeof(m_szCrFeeType2), &m_bCrFeeType2);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeAmount2, sizeof(m_szCrFeeAmount2), &m_bCrFeeAmount2);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeType3, sizeof(m_szCrFeeType3), &m_bCrFeeType3);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeAmount3, sizeof(m_szCrFeeAmount3), &m_bCrFeeAmount3);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeType4, sizeof(m_szCrFeeType4), &m_bCrFeeType4);
            }
            ...
            {
                return SetString(rwc, m_szCrFeeAmount4, sizeof(m_szCrFeeAmount4), &m_bCrFeeAmount4);
            }
...
//**************** End AsdTWMGPBTRData Definition ****************

typedef AsdTWMGPBTRData *LPTWMGPBTR;
typedef AsdTWMGPBTRData::AsdTSHeader *LPTWMGPBTR_TSHeader;
typedef AsdTWMGPBTRData::AsdTWMEGAIN *LPTWMGPBTR_TWMEGAIN;
typedef AsdTWMGPBTRData::AsdTWMEGAIN::AsdDebitItems *LPTWMGPBTR_TWMEGAIN_DebitItems;
typedef AsdTWMGPBTRData::AsdTWMEGAIN::AsdCreditItems *LPTWMGPBTR_TWMEGAIN_CreditItems;
typedef AsdTWMGPBTRData::AsdTWMEGAIN::AsdDebitCreditItems *LPTWMGPBTR_TWMEGAIN_DebitCreditItems;
typedef AsdTWMGPBTRData::AsdSDSTPBMB *LPTWMGPBTR_SDSTPBMB;
typedef AsdTWMGPBTRData::AsdSDSTPBMO *LPTWMGPBTR_SDSTPBMO;
typedef AsdTWMGPBTRData::AsdSDSTPBMO::AsdDrItemPrintRecord *LPTWMGPBTR_SDSTPBMO_DrItemPrintRecord;
typedef AsdTWMGPBTRData::AsdSDSTPBMO::AsdCrItemPrintRecord *LPTWMGPBTR_SDSTPBMO_CrItemPrintRecord;
typedef AsdTWMGPBTRData::AsdTWMEGFEE *LPTWMGPBTR_TWMEGFEE;
typedef AsdTWMGPBTRData::AsdTWMEGFEE::AsdDbFeeDetails *LPTWMGPBTR_TWMEGFEE_DbFeeDetails;
typedef AsdTWMGPBTRData::AsdTWMEGFEE::AsdCrFeeDetails *LPTWMGPBTR_TWMEGFEE_CrFeeDetails;
typedef AsdTWMGPBTRData::AsdSDSTPBPL *LPTWMGPBTR_SDSTPBPL;
typedef AsdTWMGPBTRData::AsdTSMDA *LPTWMGPBTR_TSMDA;
typedef AsdTWMGPBTRData::AsdTSMDA::AsdMdaTrmMsg *LPTWMGPBTR_TSMDA_MdaTrmMsg;
typedef AsdTWMGPBTRData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPTWMGPBTR_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdTWMGPBTRData_H
