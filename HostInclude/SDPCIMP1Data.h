#ifndef AsdSDPCIMP1Data_H
#define AsdSDPCIMP1Data_H

#include <stdlib.h>
#ifdef  AsdSDPCIMP1_INTEGRITY_STRING
#undef  AsdSDPCIMP1_INTEGRITY_STRING
#endif
#define AsdSDPCIMP1_INTEGRITY_STRING        ""

#ifdef  AsdSDPCIMP1_CRC_STRING
#undef  AsdSDPCIMP1_CRC_STRING
#endif
#define AsdSDPCIMP1_CRC_STRING "1380389699"
...
//**************** Start AsdSDPCIMP1Data Definition ****************
//                 IM Stop/Hold Maintenance

//                 SDPCIMP1Data.h generated by AceGen2 ver. 2.5.09

class AsdSDPCIMP1Data
{
  public:
  ...
  public:
    AsdSDPCIMP1Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCIMP1.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCIMP1_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCIMP1_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCIMP1", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDIMCMST.Load(&m_Sess);
                        CSDIMSHMT.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCIMP1");
                    }
    ...
    //**************** Start AsdSDIMSHMT Definition ****************
    //                 SERVICE DELIVERY IM STOP/HOLD MAINTENANCE INPUT             
    
    //    SDIMSHMT.map
    //    generated by Dsm2Ace ver. 3.0.04
    //    on 07/04/02 15:39:00
    class AsdSDIMSHMT
    {
      private:
        bool      m_bHostInitOverride;
        ...
        bool      m_bSerNbr;
        char      m_szSerNbr[10+1];
        bool      m_bExpDate;
        char      m_szExpDate[8+1];
        bool      m_bDesc;
        char      m_szDesc[24+1];
        bool      m_bSpecInstr;
        char      m_szSpecInstr[46+1];
        bool      m_bSpecInstrCd;
        char      m_szSpecInstrCd[1+1];
        bool      m_bCustGen;
        char      m_szCustGen[1+1];
        bool      m_bAllFundsInd;
        char      m_szAllFundsInd[1+1];
        bool      m_bHighSerNbr;
        char      m_szHighSerNbr[10+1];
        bool      m_bExpDays;
        char      m_szExpDays[3+1];
        bool      m_bSeqNbr;
        char      m_szSeqNbr[4+1];
      ...
      public:
        ...
        AsdSDIMSHMT ()  // Constructor
        {
            ...
            strcpy(m_szTranCode, "");
            m_bAmount = false;
            strcpy(m_szAmount, "0000000000000.000");
            m_bSerNbr = false;
            strcpy(m_szSerNbr, "");
            m_bExpDate = false;
            strcpy(m_szExpDate, "");
            ...
            strcpy(m_szDesc, "");
            m_bSpecInstr = false;
            strcpy(m_szSpecInstr, "");
            m_bSpecInstrCd = false;
            strcpy(m_szSpecInstrCd, "");
            m_bCustGen = false;
            strcpy(m_szCustGen, "");
            m_bAllFundsInd = false;
            strcpy(m_szAllFundsInd, "");
            m_bHighSerNbr = false;
            strcpy(m_szHighSerNbr, "");
            m_bExpDays = false;
            strcpy(m_szExpDays, "");
            m_bSeqNbr = false;
            strcpy(m_szSeqNbr, "");
        ...
        //    STOP/HOLD SERIAL NUMBER
        long lSerNbr () { return 10; };
        RWCString SerNbr (void)
        {
            return m_szSerNbr;
        }
        long SerNbr (const RWCString& rwc)
        {
            return SetString(rwc, m_szSerNbr, sizeof(m_szSerNbr), &m_bSerNbr);
        }
        
        //    STOP/HOLD EXPIRATION DATE
        ...
        //    STOP/HOLD DESCRIPTION
        long lDesc () { return 24; };
        RWCString Desc (void)
        {
            return m_szDesc;
        }
        ...
        //    STOP/HOLD SPECIAL INSTRUCTION
        long lSpecInstr () { return 46; };
        RWCString SpecInstr (void)
        {
            return m_szSpecInstr;
        }
        long SpecInstr (const RWCString& rwc)
        {
            return SetString(rwc, m_szSpecInstr, sizeof(m_szSpecInstr), &m_bSpecInstr);
        }
        
        //    STOP/HOLD SPECIAL INSTRUCTION CODE
        long lSpecInstrCd () { return 1; };
        RWCString SpecInstrCd (void)
        {
            return m_szSpecInstrCd;
        }
        long SpecInstrCd (const RWCString& rwc)
        {
            return SetString(rwc, m_szSpecInstrCd, sizeof(m_szSpecInstrCd), &m_bSpecInstrCd);
        }
        ...
        //    STOP/HOLD ALL FUNDS INDICATOR
        long lAllFundsInd () { return 1; };
        RWCString AllFundsInd (void)
        {
            return m_szAllFundsInd;
        }
        long AllFundsInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szAllFundsInd, sizeof(m_szAllFundsInd), &m_bAllFundsInd);
        }
        
        //    STOP/HOLD HIGH SERIAL NUMBER
        long lHighSerNbr () { return 10; };
        RWCString HighSerNbr (void)
        {
            return m_szHighSerNbr;
        }
        long HighSerNbr (const RWCString& rwc)
        {
            return SetString(rwc, m_szHighSerNbr, sizeof(m_szHighSerNbr), &m_bHighSerNbr);
        }
        
        //    STOP/HOLD EXPIRATION DAYS
        long lExpDays () { return 3; };
        RWCString ExpDays (void)
        {
            return m_szExpDays;
        }
        long ExpDays (const RWCString& rwc)
        {
            return SetString(rwc, m_szExpDays, sizeof(m_szExpDays), &m_bExpDays);
        }
        
        //    STOP/HOLD SEQUENCE NUMBER
        long lSeqNbr () { return 4; };
        RWCString SeqNbr (void)
        {
            return m_szSeqNbr;
        }
        long SeqNbr (const RWCString& rwc)
        {
            return SetString(rwc, m_szSeqNbr, sizeof(m_szSeqNbr), &m_bSeqNbr);
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bSerNbr) return true;
            if (m_bExpDate) return true;
            if (m_bDesc) return true;
            if (m_bSpecInstr) return true;
            if (m_bSpecInstrCd) return true;
            if (m_bCustGen) return true;
            if (m_bAllFundsInd) return true;
            if (m_bHighSerNbr) return true;
            if (m_bExpDays) return true;
            if (m_bSeqNbr) return true;
            return false;
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDIMSHMT", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "TranCode", m_szTranCode, &m_bTranCode);
                AddXMLField(pSess, "Amount", m_szAmount, &m_bAmount);
                AddXMLField(pSess, "SerNbr", m_szSerNbr, &m_bSerNbr);
                AddXMLField(pSess, "ExpDate", m_szExpDate, &m_bExpDate);
                AddXMLField(pSess, "Desc", m_szDesc, &m_bDesc);
                AddXMLField(pSess, "SpecInstr", m_szSpecInstr, &m_bSpecInstr);
                AddXMLField(pSess, "SpecInstrCd", m_szSpecInstrCd, &m_bSpecInstrCd);
                AddXMLField(pSess, "CustGen", m_szCustGen, &m_bCustGen);
                AddXMLField(pSess, "AllFundsInd", m_szAllFundsInd, &m_bAllFundsInd);
                AddXMLField(pSess, "HighSerNbr", m_szHighSerNbr, &m_bHighSerNbr);
                AddXMLField(pSess, "ExpDays", m_szExpDays, &m_bExpDays);
                AddXMLField(pSess, "SeqNbr", m_szSeqNbr, &m_bSeqNbr);
                AddXMLCloseRecord(pSess, "SDIMSHMT");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDIMSHMT", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "TranCode", m_szTranCode);
                GetXMLField(pSess, "Amount", m_szAmount);
                GetXMLField(pSess, "SerNbr", m_szSerNbr);
                GetXMLField(pSess, "ExpDate", m_szExpDate);
                GetXMLField(pSess, "Desc", m_szDesc);
                GetXMLField(pSess, "SpecInstr", m_szSpecInstr);
                GetXMLField(pSess, "SpecInstrCd", m_szSpecInstrCd);
                GetXMLField(pSess, "CustGen", m_szCustGen);
                GetXMLField(pSess, "AllFundsInd", m_szAllFundsInd);
                GetXMLField(pSess, "HighSerNbr", m_szHighSerNbr);
                GetXMLField(pSess, "ExpDays", m_szExpDays);
                GetXMLField(pSess, "SeqNbr", m_szSeqNbr);
                CloseXMLRecord(pSess, "SDIMSHMT");
            };
        }
    };

    AsdSDIMSHMT CSDIMSHMT;
    AsdSDIMSHMT *SDIMSHMT;
    
    //**************** End AsdSDIMSHMT Definition ****************
...
//**************** End AsdSDPCIMP1Data Definition ****************

typedef AsdSDPCIMP1Data *LPSDPCIMP1;
typedef AsdSDPCIMP1Data::AsdTSHeader *LPSDPCIMP1_TSHeader;
typedef AsdSDPCIMP1Data::AsdSDIMCMST *LPSDPCIMP1_SDIMCMST;
typedef AsdSDPCIMP1Data::AsdSDIMSHMT *LPSDPCIMP1_SDIMSHMT;
typedef AsdSDPCIMP1Data::AsdTSMDA *LPSDPCIMP1_TSMDA;
typedef AsdSDPCIMP1Data::AsdTSMDA::AsdMdaTrmMsg *LPSDPCIMP1_TSMDA_MdaTrmMsg;
typedef AsdSDPCIMP1Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCIMP1_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCIMP1Data_H
