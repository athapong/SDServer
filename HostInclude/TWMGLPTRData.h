#ifndef AsdTWMGLPTRData_H
#define AsdTWMGLPTRData_H

#include <stdlib.h>
#ifdef  AsdTWMGLPTR_INTEGRITY_STRING
#undef  AsdTWMGLPTR_INTEGRITY_STRING
#endif
#define AsdTWMGLPTR_INTEGRITY_STRING        ""

#ifdef  AsdTWMGLPTR_CRC_STRING
#undef  AsdTWMGLPTR_CRC_STRING
#endif
#define AsdTWMGLPTR_CRC_STRING "3370586585"
...
//**************** Start AsdTWMGLPTRData Definition ****************
//                 Loan Payment

//                 TWMGLPTRData.h generated by AceGen2 ver. 2.5.09

class AsdTWMGLPTRData
{
  public:
  ...
  public:
    AsdTWMGLPTRData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "TWMGLPTR.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdTWMGLPTR_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdTWMGLPTR_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "TWMGLPTR", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CTWMEGAIN.Load(&m_Sess);
                        CTWMEGFEE.Load(&m_Sess);
                        CAMWKTRU1.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "TWMGLPTR");
                    }
    ...
    //**************** Start AsdAMWKTRU1 Definition ****************
    //                 ONLINE RECEIPT WORK DAG                                     
    
    //    AMWKTRU1.map
    //    generated by Dsm2Ace ver. 2.3.03
    //    on 06/14/04 10:00:27
    class AsdAMWKTRU1
    {
      private:
        bool      m_bHostInitOverride;
        ...
        bool      m_bTrNameLine1;
        char      m_szTrNameLine1[40+1];
        bool      m_bTrNameLine2;
        char      m_szTrNameLine2[40+1];
        bool      m_bTrEffDate;
        char      m_szTrEffDate[8+1];
        bool      m_bTrSysDate;
        char      m_szTrSysDate[8+1];
        bool      m_bTrTranCd;
        char      m_szTrTranCd[4+1];
        bool      m_bTrComment;
        char      m_szTrComment[15+1];
        bool      m_bTrPrinAmt;
        char      m_szTrPrinAmt[15+1];
        bool      m_bTrIntAmt;
        char      m_szTrIntAmt[15+1];
        bool      m_bTrFeeAmt;
        char      m_szTrFeeAmt[15+1];
        bool      m_bTrOthAmt;
        char      m_szTrOthAmt[15+1];
        bool      m_bTrTranAmt;
        char      m_szTrTranAmt[15+1];
        bool      m_bTrOutstdPrin;
        char      m_szTrOutstdPrin[15+1];
        bool      m_bTrOutstdInt;
        char      m_szTrOutstdInt[15+1];
        bool      m_bTrOutstdFee;
        char      m_szTrOutstdFee[15+1];
        bool      m_bTrServBr;
        char      m_szTrServBr[3+1];
        bool      m_bTr24PrimBr;
        char      m_szTr24PrimBr[5+1];
        bool      m_bFill0;
        char      m_szFill0[35+1];
      ...
      public:
        ...
        AsdAMWKTRU1 ()  // Constructor
        {
            ...
            strcpy(m_szRtEditedAcctNum, "000000000000000000");
            m_bRtCtl2 = false;
            strcpy(m_szRtCtl2, "000");
            m_bRtAcctType = false;
            strcpy(m_szRtAcctType, "");
            m_bTrNameLine1 = false;
            strcpy(m_szTrNameLine1, "0000000000000000000000000000000000000000");
            m_bTrNameLine2 = false;
            strcpy(m_szTrNameLine2, "0000000000000000000000000000000000000000");
            m_bTrEffDate = false;
            strcpy(m_szTrEffDate, "00000000");
            m_bTrSysDate = false;
            strcpy(m_szTrSysDate, "00000000");
            m_bTrTranCd = false;
            strcpy(m_szTrTranCd, "");
            m_bTrComment = false;
            strcpy(m_szTrComment, "");
            m_bTrPrinAmt = false;
            strcpy(m_szTrPrinAmt, "000000000000000");
            m_bTrIntAmt = false;
            strcpy(m_szTrIntAmt, "000000000000000");
            m_bTrFeeAmt = false;
            strcpy(m_szTrFeeAmt, "000000000000000");
            m_bTrOthAmt = false;
            strcpy(m_szTrOthAmt, "000000000000000");
            m_bTrTranAmt = false;
            strcpy(m_szTrTranAmt, "000000000000000");
            m_bTrOutstdPrin = false;
            strcpy(m_szTrOutstdPrin, "000000000000000");
            m_bTrOutstdInt = false;
            strcpy(m_szTrOutstdInt, "000000000000000");
            m_bTrOutstdFee = false;
            strcpy(m_szTrOutstdFee, "000000000000000");
            m_bTrServBr = false;
            strcpy(m_szTrServBr, "");
            m_bTr24PrimBr = false;
            strcpy(m_szTr24PrimBr, "");
            m_bFill0 = false;
            strcpy(m_szFill0, "");
        }
        ...
        //    NAME LINE 1
        long lTrNameLine1 () { return 40; };
        RWCString TrNameLine1 (void)
        {
            return m_szTrNameLine1;
        }
        long TrNameLine1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrNameLine1, sizeof(m_szTrNameLine1), &m_bTrNameLine1);
        }
        
        //    NAME LINE 2
        long lTrNameLine2 () { return 40; };
        RWCString TrNameLine2 (void)
        {
            return m_szTrNameLine2;
        }
        long TrNameLine2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrNameLine2, sizeof(m_szTrNameLine2), &m_bTrNameLine2);
        }
        ...
        //    SYSTEM DATE
        long lTrSysDate () { return 8; };
        RWCString TrSysDate (void)
        {
            return m_szTrSysDate;
        }
        long TrSysDate (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrSysDate, sizeof(m_szTrSysDate), &m_bTrSysDate);
        }
        ...
        //    A COMMENT AREA AVAILABLE TO THE USER.
        long lTrComment () { return 15; };
        RWCString TrComment (void)
        {
            return m_szTrComment;
        }
        long TrComment (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrComment, sizeof(m_szTrComment), &m_bTrComment);
        }
        
        //    PRINCIPAL PAYMENT AMT
        long lTrPrinAmt () { return 15; };
        RWCString TrPrinAmt (void)
        {
            return m_szTrPrinAmt;
        }
        long TrPrinAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrPrinAmt, sizeof(m_szTrPrinAmt), &m_bTrPrinAmt);
        }
        
        //    INTEREST PAYMENT AMOUNT
        long lTrIntAmt () { return 15; };
        RWCString TrIntAmt (void)
        {
            return m_szTrIntAmt;
        }
        long TrIntAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrIntAmt, sizeof(m_szTrIntAmt), &m_bTrIntAmt);
        }
        
        //    FEE PAYMENT AMT
        long lTrFeeAmt () { return 15; };
        RWCString TrFeeAmt (void)
        {
            return m_szTrFeeAmt;
        }
        long TrFeeAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrFeeAmt, sizeof(m_szTrFeeAmt), &m_bTrFeeAmt);
        }
        
        //    OTHER PAYMENT AMT
        long lTrOthAmt () { return 15; };
        RWCString TrOthAmt (void)
        {
            return m_szTrOthAmt;
        }
        long TrOthAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrOthAmt, sizeof(m_szTrOthAmt), &m_bTrOthAmt);
        }
        
        //    TRANSACTION AMT
        long lTrTranAmt () { return 15; };
        ...
        long lTrOutstdPrin () { return 15; };
        RWCString TrOutstdPrin (void)
        {
            return m_szTrOutstdPrin;
        }
        long TrOutstdPrin (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrOutstdPrin, sizeof(m_szTrOutstdPrin), &m_bTrOutstdPrin);
        }
        
        //    OUTSTANDING INTEREST
        long lTrOutstdInt () { return 15; };
        RWCString TrOutstdInt (void)
        {
            return m_szTrOutstdInt;
        }
        long TrOutstdInt (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrOutstdInt, sizeof(m_szTrOutstdInt), &m_bTrOutstdInt);
        }
        
        //    OUTSTANDING FEE
        long lTrOutstdFee () { return 15; };
        RWCString TrOutstdFee (void)
        {
            return m_szTrOutstdFee;
        }
        long TrOutstdFee (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrOutstdFee, sizeof(m_szTrOutstdFee), &m_bTrOutstdFee);
        }
        
        //    SERVICE BRANCH
        long lTrServBr () { return 3; };
        RWCString TrServBr (void)
        {
            return m_szTrServBr;
        }
        long TrServBr (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrServBr, sizeof(m_szTrServBr), &m_bTrServBr);
        }
        
        //    PRIMARY BRANCH CODE.
        long lTr24PrimBr () { return 5; };
        RWCString Tr24PrimBr (void)
        {
            return m_szTr24PrimBr;
        }
        long Tr24PrimBr (const RWCString& rwc)
        {
            return SetString(rwc, m_szTr24PrimBr, sizeof(m_szTr24PrimBr), &m_bTr24PrimBr);
        }
        
        //    FILLER
        long lFill0 () { return 35; };
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bTrNameLine1) return true;
            if (m_bTrNameLine2) return true;
            if (m_bTrEffDate) return true;
            if (m_bTrSysDate) return true;
            if (m_bTrTranCd) return true;
            if (m_bTrComment) return true;
            if (m_bTrPrinAmt) return true;
            if (m_bTrIntAmt) return true;
            if (m_bTrFeeAmt) return true;
            if (m_bTrOthAmt) return true;
            if (m_bTrTranAmt) return true;
            if (m_bTrOutstdPrin) return true;
            if (m_bTrOutstdInt) return true;
            if (m_bTrOutstdFee) return true;
            if (m_bTrServBr) return true;
            if (m_bTr24PrimBr) return true;
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "AMWKTRU1", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLField(pSess, "TrNameLine1", m_szTrNameLine1, &m_bTrNameLine1);
                AddXMLField(pSess, "TrNameLine2", m_szTrNameLine2, &m_bTrNameLine2);
                AddXMLField(pSess, "TrEffDate", m_szTrEffDate, &m_bTrEffDate);
                AddXMLField(pSess, "TrSysDate", m_szTrSysDate, &m_bTrSysDate);
                AddXMLField(pSess, "TrTranCd", m_szTrTranCd, &m_bTrTranCd);
                AddXMLField(pSess, "TrComment", m_szTrComment, &m_bTrComment);
                AddXMLField(pSess, "TrPrinAmt", m_szTrPrinAmt, &m_bTrPrinAmt);
                AddXMLField(pSess, "TrIntAmt", m_szTrIntAmt, &m_bTrIntAmt);
                AddXMLField(pSess, "TrFeeAmt", m_szTrFeeAmt, &m_bTrFeeAmt);
                AddXMLField(pSess, "TrOthAmt", m_szTrOthAmt, &m_bTrOthAmt);
                AddXMLField(pSess, "TrTranAmt", m_szTrTranAmt, &m_bTrTranAmt);
                AddXMLField(pSess, "TrOutstdPrin", m_szTrOutstdPrin, &m_bTrOutstdPrin);
                AddXMLField(pSess, "TrOutstdInt", m_szTrOutstdInt, &m_bTrOutstdInt);
                AddXMLField(pSess, "TrOutstdFee", m_szTrOutstdFee, &m_bTrOutstdFee);
                AddXMLField(pSess, "TrServBr", m_szTrServBr, &m_bTrServBr);
                AddXMLField(pSess, "Tr24PrimBr", m_szTr24PrimBr, &m_bTr24PrimBr);
                AddXMLField(pSess, "Fill0", m_szFill0, &m_bFill0);
                AddXMLCloseRecord(pSess, "AMWKTRU1");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "AMWKTRU1", m_lIndex, &m_bReceived))
            {
                ...
                GetXMLField(pSess, "TrNameLine1", m_szTrNameLine1);
                GetXMLField(pSess, "TrNameLine2", m_szTrNameLine2);
                GetXMLField(pSess, "TrEffDate", m_szTrEffDate);
                GetXMLField(pSess, "TrSysDate", m_szTrSysDate);
                GetXMLField(pSess, "TrTranCd", m_szTrTranCd);
                GetXMLField(pSess, "TrComment", m_szTrComment);
                GetXMLField(pSess, "TrPrinAmt", m_szTrPrinAmt);
                GetXMLField(pSess, "TrIntAmt", m_szTrIntAmt);
                GetXMLField(pSess, "TrFeeAmt", m_szTrFeeAmt);
                GetXMLField(pSess, "TrOthAmt", m_szTrOthAmt);
                GetXMLField(pSess, "TrTranAmt", m_szTrTranAmt);
                GetXMLField(pSess, "TrOutstdPrin", m_szTrOutstdPrin);
                GetXMLField(pSess, "TrOutstdInt", m_szTrOutstdInt);
                GetXMLField(pSess, "TrOutstdFee", m_szTrOutstdFee);
                GetXMLField(pSess, "TrServBr", m_szTrServBr);
                GetXMLField(pSess, "Tr24PrimBr", m_szTr24PrimBr);
                GetXMLField(pSess, "Fill0", m_szFill0);
                CloseXMLRecord(pSess, "AMWKTRU1");
            };
        }
    };

    AsdAMWKTRU1 CAMWKTRU1;
    AsdAMWKTRU1 *AMWKTRU1;
    
    //**************** End AsdAMWKTRU1 Definition ****************
...
//**************** End AsdTWMGLPTRData Definition ****************

typedef AsdTWMGLPTRData *LPTWMGLPTR;
typedef AsdTWMGLPTRData::AsdTSHeader *LPTWMGLPTR_TSHeader;
typedef AsdTWMGLPTRData::AsdTWMEGAIN *LPTWMGLPTR_TWMEGAIN;
typedef AsdTWMGLPTRData::AsdTWMEGAIN::AsdDebitItems *LPTWMGLPTR_TWMEGAIN_DebitItems;
typedef AsdTWMGLPTRData::AsdTWMEGAIN::AsdCreditItems *LPTWMGLPTR_TWMEGAIN_CreditItems;
typedef AsdTWMGLPTRData::AsdTWMEGAIN::AsdDebitCreditItems *LPTWMGLPTR_TWMEGAIN_DebitCreditItems;
typedef AsdTWMGLPTRData::AsdTWMEGFEE *LPTWMGLPTR_TWMEGFEE;
typedef AsdTWMGLPTRData::AsdTWMEGFEE::AsdDbFeeDetails *LPTWMGLPTR_TWMEGFEE_DbFeeDetails;
typedef AsdTWMGLPTRData::AsdTWMEGFEE::AsdCrFeeDetails *LPTWMGLPTR_TWMEGFEE_CrFeeDetails;
typedef AsdTWMGLPTRData::AsdAMWKTRU1 *LPTWMGLPTR_AMWKTRU1;
typedef AsdTWMGLPTRData::AsdTSMDA *LPTWMGLPTR_TSMDA;
typedef AsdTWMGLPTRData::AsdTSMDA::AsdMdaTrmMsg *LPTWMGLPTR_TSMDA_MdaTrmMsg;
typedef AsdTWMGLPTRData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPTWMGLPTR_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdTWMGLPTRData_H
