#ifndef AsdSDPCAMX2Data_H
#define AsdSDPCAMX2Data_H

#include <stdlib.h>
#ifdef  AsdSDPCAMX2_INTEGRITY_STRING
#undef  AsdSDPCAMX2_INTEGRITY_STRING
#endif
#define AsdSDPCAMX2_INTEGRITY_STRING        ""

#ifdef  AsdSDPCAMX2_CRC_STRING
#undef  AsdSDPCAMX2_CRC_STRING
#endif
#define AsdSDPCAMX2_CRC_STRING "3371728856"
...
//**************** Start AsdSDPCAMX2Data Definition ****************
//                 svLoanDueDateChange

//                 SDPCAMX2Data.h generated by AceGen2 ver. 2.5.09

class AsdSDPCAMX2Data
{
  public:
  ...
  public:
    AsdSDPCAMX2Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCAMX2.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCAMX2_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCAMX2_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDPCAMX2_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDAMRQII.Save(&m_Sess);
        CSDAMX2MI.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCAMX2", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDAMRQII.Load(&m_Sess);
                        CSDAMX2MI.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCAMX2");
                    }
    ...
    //**************** Start AsdSDAMRQII Definition ****************
    //                 SD ALS REPORT REQUEST INPUT                                 
    ...
    class AsdSDAMRQII
    {
      private:
        ...
        bool      m_bRequestType;
        char      m_szRequestType[2+1];
        bool      m_bRequestedBy;
        char      m_szRequestedBy[20+1];
        bool      m_bBillingDef;
        char      m_szBillingDef[3+1];
        bool      m_bCouponStartDate;
        char      m_szCouponStartDate[8+1];
        bool      m_bNumberOfCoupons;
        char      m_szNumberOfCoupons[3+1];
        bool      m_bDeliveryMethod;
        char      m_szDeliveryMethod[15+1];
        bool      m_bBillType;
        char      m_szBillType[2+1];
        bool      m_bBillDueDate1;
        char      m_szBillDueDate1[8+1];
        bool      m_bBillDueDate2;
        char      m_szBillDueDate2[8+1];
        bool      m_bBillDueDate3;
        char      m_szBillDueDate3[8+1];
        bool      m_bBillThruDate;
        char      m_szBillThruDate[8+1];
        bool      m_bAarApplId;
        ...
        bool      m_bChargeFee;
        char      m_szChargeFee[1+1];
        bool      m_bFeeAmt;
        char      m_szFeeAmt[17+1];
      ...
      public:
        ...
        AsdSDAMRQII ()  // Constructor
        {
            ...
            m_lIndex = -1;
            m_bRtCtl1 = false;
            strcpy(m_szRtCtl1, "00");
            m_bRtCtl2 = false;
            strcpy(m_szRtCtl2, "000");
            m_bRtCtl3 = false;
            strcpy(m_szRtCtl3, "000");
            m_bRtCtl4 = false;
            strcpy(m_szRtCtl4, "0000");
            m_bRtAcctNum = false;
            strcpy(m_szRtAcctNum, "00000000000000");
            m_bRequestType = false;
            strcpy(m_szRequestType, "");
            m_bRequestedBy = false;
            strcpy(m_szRequestedBy, "");
            m_bBillingDef = false;
            strcpy(m_szBillingDef, "");
            m_bCouponStartDate = false;
            strcpy(m_szCouponStartDate, "00000000");
            m_bNumberOfCoupons = false;
            strcpy(m_szNumberOfCoupons, "000");
            m_bDeliveryMethod = false;
            strcpy(m_szDeliveryMethod, "");
            m_bBillType = false;
            strcpy(m_szBillType, "");
            m_bBillDueDate1 = false;
            strcpy(m_szBillDueDate1, "00000000");
            m_bBillDueDate2 = false;
            strcpy(m_szBillDueDate2, "00000000");
            m_bBillDueDate3 = false;
            strcpy(m_szBillDueDate3, "00000000");
            m_bBillThruDate = false;
            strcpy(m_szBillThruDate, "00000000");
            m_bAarApplId = false;
            ...
            m_bChargeFee = false;
            strcpy(m_szChargeFee, "");
            m_bFeeAmt = false;
            strcpy(m_szFeeAmt, "+0000000000000.00");
        ...
        long lRequestType () { return 2; };
        RWCString RequestType (void)
        {
            return m_szRequestType;
        }
        long RequestType (const RWCString& rwc)
        {
            return SetString(rwc, m_szRequestType, sizeof(m_szRequestType), &m_bRequestType);
        }
        
        //    IDENTIFIES PERSON REQUESTING REPORT
        long lRequestedBy () { return 20; };
        RWCString RequestedBy (void)
        {
            return m_szRequestedBy;
        }
        long RequestedBy (const RWCString& rwc)
        {
            return SetString(rwc, m_szRequestedBy, sizeof(m_szRequestedBy), &m_bRequestedBy);
        }
        
        //    BILLING DEFINITION ID.
        long lBillingDef () { return 3; };
        RWCString BillingDef (void)
        {
            return m_szBillingDef;
        }
        long BillingDef (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillingDef, sizeof(m_szBillingDef), &m_bBillingDef);
        }
        
        //    COUPON START DATE
        long lCouponStartDate () { return 8; };
        RWCString CouponStartDate (void)
        {
            return m_szCouponStartDate;
        }
        long CouponStartDate (const RWCString& rwc)
        {
            return SetString(rwc, m_szCouponStartDate, sizeof(m_szCouponStartDate), &m_bCouponStartDate);
        }
        
        //    NUMBER OF COUPONS REQUESTED
        long lNumberOfCoupons () { return 3; };
        RWCString NumberOfCoupons (void)
        {
            return m_szNumberOfCoupons;
        }
        long NumberOfCoupons (const RWCString& rwc)
        {
            return SetString(rwc, m_szNumberOfCoupons, sizeof(m_szNumberOfCoupons), &m_bNumberOfCoupons);
        }
        
        //    DELIVERY METHOD
        long lDeliveryMethod () { return 15; };
        RWCString DeliveryMethod (void)
        {
            return m_szDeliveryMethod;
        }
        long DeliveryMethod (const RWCString& rwc)
        {
            return SetString(rwc, m_szDeliveryMethod, sizeof(m_szDeliveryMethod), &m_bDeliveryMethod);
        }
        
        //    PROCESSING TO BE DONE TO PRODUCE THE DESIRED BILL TYPE
        long lBillType () { return 2; };
        RWCString BillType (void)
        {
            return m_szBillType;
        }
        long BillType (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillType, sizeof(m_szBillType), &m_bBillType);
        }
        
        //    INDICATES THE NEXT DATE ON WHICH A PAYMENT IS DUE
        long lBillDueDate1 () { return 8; };
        RWCString BillDueDate1 (void)
        {
            return m_szBillDueDate1;
        }
        long BillDueDate1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillDueDate1, sizeof(m_szBillDueDate1), &m_bBillDueDate1);
        }
        
        //    INDICATES THE NEXT DATE ON WHICH A PAYMENT IS DUE
        long lBillDueDate2 () { return 8; };
        RWCString BillDueDate2 (void)
        {
            return m_szBillDueDate2;
        }
        long BillDueDate2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillDueDate2, sizeof(m_szBillDueDate2), &m_bBillDueDate2);
        }
        
        //    INDICATES THE NEXT DATE ON WHICH A PAYMENT IS DUE
        long lBillDueDate3 () { return 8; };
        RWCString BillDueDate3 (void)
        {
            return m_szBillDueDate3;
        }
        long BillDueDate3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillDueDate3, sizeof(m_szBillDueDate3), &m_bBillDueDate3);
        }
        
        //    END OF DATE RANGE FOR STATEMENT REQUESTS.
        long lBillThruDate () { return 8; };
        RWCString BillThruDate (void)
        {
            return m_szBillThruDate;
        }
        long BillThruDate (const RWCString& rwc)
        {
            return SetString(rwc, m_szBillThruDate, sizeof(m_szBillThruDate), &m_bBillThruDate);
        }
        ...
        //    CHARGE FEE FLAG
        long lChargeFee () { return 1; };
        RWCString ChargeFee (void)
        {
            return m_szChargeFee;
        }
        long ChargeFee (const RWCString& rwc)
        {
            return SetString(rwc, m_szChargeFee, sizeof(m_szChargeFee), &m_bChargeFee);
        }
        
        //    AMOUNT OF FEE TO CHARGE.
        long lFeeAmt () { return 17; };
        RWCString FeeAmt (void)
        {
            return AceZeroSupp(m_szFeeAmt, &m_szSuppressBuff[0]);
        }
        RWCString FeeAmtRaw (void)
        {
            return m_szFeeAmt;
        }
        long FeeAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szFeeAmt, sizeof(m_szFeeAmt), &m_bFeeAmt);
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bRequestType) return true;
            if (m_bRequestedBy) return true;
            if (m_bBillingDef) return true;
            if (m_bCouponStartDate) return true;
            if (m_bNumberOfCoupons) return true;
            if (m_bDeliveryMethod) return true;
            if (m_bBillType) return true;
            if (m_bBillDueDate1) return true;
            if (m_bBillDueDate2) return true;
            if (m_bBillDueDate3) return true;
            if (m_bBillThruDate) return true;
            ...
            if (m_bChargeFee) return true;
            if (m_bFeeAmt) return true;
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDAMRQII", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLField(pSess, "RequestType", m_szRequestType, &m_bRequestType);
                AddXMLField(pSess, "RequestedBy", m_szRequestedBy, &m_bRequestedBy);
                AddXMLField(pSess, "BillingDef", m_szBillingDef, &m_bBillingDef);
                AddXMLField(pSess, "CouponStartDate", m_szCouponStartDate, &m_bCouponStartDate);
                AddXMLField(pSess, "NumberOfCoupons", m_szNumberOfCoupons, &m_bNumberOfCoupons);
                AddXMLField(pSess, "DeliveryMethod", m_szDeliveryMethod, &m_bDeliveryMethod);
                AddXMLField(pSess, "BillType", m_szBillType, &m_bBillType);
                AddXMLField(pSess, "BillDueDate1", m_szBillDueDate1, &m_bBillDueDate1);
                AddXMLField(pSess, "BillDueDate2", m_szBillDueDate2, &m_bBillDueDate2);
                AddXMLField(pSess, "BillDueDate3", m_szBillDueDate3, &m_bBillDueDate3);
                AddXMLField(pSess, "BillThruDate", m_szBillThruDate, &m_bBillThruDate);
                ...
                AddXMLField(pSess, "ChargeFee", m_szChargeFee, &m_bChargeFee);
                AddXMLField(pSess, "FeeAmt", m_szFeeAmt, &m_bFeeAmt);
                AddXMLField(pSess, "UserTranCode", m_szUserTranCode, &m_bUserTranCode);
                AddXMLField(pSess, "Batch", m_szBatch, &m_bBatch);
                AddXMLCloseRecord(pSess, "SDAMRQII");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDAMRQII", m_lIndex, &m_bReceived))
            {
                ...
                GetXMLField(pSess, "RequestType", m_szRequestType);
                GetXMLField(pSess, "RequestedBy", m_szRequestedBy);
                GetXMLField(pSess, "BillingDef", m_szBillingDef);
                GetXMLField(pSess, "CouponStartDate", m_szCouponStartDate);
                GetXMLField(pSess, "NumberOfCoupons", m_szNumberOfCoupons);
                GetXMLField(pSess, "DeliveryMethod", m_szDeliveryMethod);
                GetXMLField(pSess, "BillType", m_szBillType);
                GetXMLField(pSess, "BillDueDate1", m_szBillDueDate1);
                GetXMLField(pSess, "BillDueDate2", m_szBillDueDate2);
                GetXMLField(pSess, "BillDueDate3", m_szBillDueDate3);
                GetXMLField(pSess, "BillThruDate", m_szBillThruDate);
                ...
                GetXMLField(pSess, "ChargeFee", m_szChargeFee);
                GetXMLField(pSess, "FeeAmt", m_szFeeAmt);
                GetXMLField(pSess, "UserTranCode", m_szUserTranCode);
                GetXMLField(pSess, "Batch", m_szBatch);
                CloseXMLRecord(pSess, "SDAMRQII");
            };
        }
    };

    AsdSDAMRQII CSDAMRQII;
    AsdSDAMRQII *SDAMRQII;
    
    //**************** End AsdSDAMRQII Definition ****************

    
    //**************** Start AsdSDAMX2MI Definition ****************
    //                 SD ALS ACCOUNT STATUS INPUT                                 
    ...
    class AsdSDAMX2MI
    {
      private:
        ...
        bool      m_bRtAcctNum;
        char      m_szRtAcctNum[14+1];
        bool      m_bWkFrstDueAftExt;
        char      m_szWkFrstDueAftExt[8+1];
        bool      m_bWkDueDay;
        char      m_szWkDueDay[2+1];
        bool      m_bWkStartDateExt;
        char      m_szWkStartDateExt[8+1];
    
      public:
        long      m_lIndex;

        AsdSDAMX2MI ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            ...
            m_bRtAcctNum = false;
            strcpy(m_szRtAcctNum, "00000000000000");
            m_bWkFrstDueAftExt = false;
            strcpy(m_szWkFrstDueAftExt, "00000000");
            m_bWkDueDay = false;
            strcpy(m_szWkDueDay, "00");
            m_bWkStartDateExt = false;
            strcpy(m_szWkStartDateExt, "00000000");
        }
        ...
        //    FIRST DUE DATE AFTER EXTENSION
        long lWkFrstDueAftExt () { return 8; };
        RWCString WkFrstDueAftExt (void)
        {
            return m_szWkFrstDueAftExt;
        }
        long WkFrstDueAftExt (const RWCString& rwc)
        {
            return SetString(rwc, m_szWkFrstDueAftExt, sizeof(m_szWkFrstDueAftExt), &m_bWkFrstDueAftExt);
        }
        
        //    DUE DAY
        long lWkDueDay () { return 2; };
        RWCString WkDueDay (void)
        {
            return m_szWkDueDay;
        }
        long WkDueDay (const RWCString& rwc)
        {
            return SetString(rwc, m_szWkDueDay, sizeof(m_szWkDueDay), &m_bWkDueDay);
        }
        
        //    EXTENSION START DATE
        long lWkStartDateExt () { return 8; };
        RWCString WkStartDateExt (void)
        {
            return m_szWkStartDateExt;
        }
        long WkStartDateExt (const RWCString& rwc)
        {
            return SetString(rwc, m_szWkStartDateExt, sizeof(m_szWkStartDateExt), &m_bWkStartDateExt);
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bRtCtl4) return true;
            if (m_bRtAcctNum) return true;
            if (m_bWkFrstDueAftExt) return true;
            if (m_bWkDueDay) return true;
            if (m_bWkStartDateExt) return true;
            return false;
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDAMX2MI", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "RtCtl1", m_szRtCtl1, &m_bRtCtl1);
                AddXMLField(pSess, "RtCtl2", m_szRtCtl2, &m_bRtCtl2);
                AddXMLField(pSess, "RtCtl3", m_szRtCtl3, &m_bRtCtl3);
                AddXMLField(pSess, "RtCtl4", m_szRtCtl4, &m_bRtCtl4);
                AddXMLField(pSess, "RtAcctNum", m_szRtAcctNum, &m_bRtAcctNum);
                AddXMLField(pSess, "WkFrstDueAftExt", m_szWkFrstDueAftExt, &m_bWkFrstDueAftExt);
                AddXMLField(pSess, "WkDueDay", m_szWkDueDay, &m_bWkDueDay);
                AddXMLField(pSess, "WkStartDateExt", m_szWkStartDateExt, &m_bWkStartDateExt);
                AddXMLCloseRecord(pSess, "SDAMX2MI");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDAMX2MI", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "RtCtl1", m_szRtCtl1);
                GetXMLField(pSess, "RtCtl2", m_szRtCtl2);
                GetXMLField(pSess, "RtCtl3", m_szRtCtl3);
                GetXMLField(pSess, "RtCtl4", m_szRtCtl4);
                GetXMLField(pSess, "RtAcctNum", m_szRtAcctNum);
                GetXMLField(pSess, "WkFrstDueAftExt", m_szWkFrstDueAftExt);
                GetXMLField(pSess, "WkDueDay", m_szWkDueDay);
                GetXMLField(pSess, "WkStartDateExt", m_szWkStartDateExt);
                CloseXMLRecord(pSess, "SDAMX2MI");
            };
        }
    };

    AsdSDAMX2MI CSDAMX2MI;
    AsdSDAMX2MI *SDAMX2MI;
    
    //**************** End AsdSDAMX2MI Definition ****************
...
//**************** End AsdSDPCAMX2Data Definition ****************

typedef AsdSDPCAMX2Data *LPSDPCAMX2;
typedef AsdSDPCAMX2Data::AsdTSHeader *LPSDPCAMX2_TSHeader;
typedef AsdSDPCAMX2Data::AsdSDAMRQII *LPSDPCAMX2_SDAMRQII;
typedef AsdSDPCAMX2Data::AsdSDAMX2MI *LPSDPCAMX2_SDAMX2MI;
typedef AsdSDPCAMX2Data::AsdTSMDA *LPSDPCAMX2_TSMDA;
typedef AsdSDPCAMX2Data::AsdTSMDA::AsdMdaTrmMsg *LPSDPCAMX2_TSMDA_MdaTrmMsg;
typedef AsdSDPCAMX2Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCAMX2_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCAMX2Data_H
