#ifndef AsdSDPCLGIQData_H
#define AsdSDPCLGIQData_H

#include <stdlib.h>
#ifdef  AsdSDPCLGIQ_INTEGRITY_STRING
#undef  AsdSDPCLGIQ_INTEGRITY_STRING
#endif
#define AsdSDPCLGIQ_INTEGRITY_STRING        ""

#ifdef  AsdSDPCLGIQ_CRC_STRING
#undef  AsdSDPCLGIQ_CRC_STRING
#endif
#define AsdSDPCLGIQ_CRC_STRING "3014649981"
...
//**************** Start AsdSDPCLGIQData Definition ****************
//                 IM/ST Todays Transactions

//                 SDPCLGIQData.h generated by AceGen2 ver. 2.5.09

class AsdSDPCLGIQData
{
  public:
  ...
  public:
    AsdSDPCLGIQData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCLGIQ.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCLGIQ_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCLGIQ_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDPCLGIQ_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDLOGIN.Save(&m_Sess);
        CSDLOGOUT.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCLGIQ", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDLOGIN.Load(&m_Sess);
                        CSDLOGOUT.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCLGIQ");
                    }
    ...
    //**************** Start AsdSDLOGIN Definition ****************
    //                 INPUT DAG USED TO OBTAIN APPL LOG DATA                      
    
    //    SDLOGIN.map
    //    generated by Dsm2Ace ver. 3.0.04
    //    on 07/04/02 15:38:30
    class AsdSDLOGIN
    {
      private:
        bool      m_bHostInitOverride;
        ...
        char      m_szSuppressBuff[100];
        bool      m_bCurApplId;
        char      m_szCurApplId[2+1];
        bool      m_bCurApplCtl1;
        char      m_szCurApplCtl1[4+1];
        bool      m_bCurApplCtl2;
        char      m_szCurApplCtl2[4+1];
        bool      m_bCurApplCtl3;
        char      m_szCurApplCtl3[4+1];
        bool      m_bCurApplCtl4;
        char      m_szCurApplCtl4[4+1];
        bool      m_bCurApplAcctNbr;
        char      m_szCurApplAcctNbr[27+1];
        bool      m_bMaxEntries;
        char      m_szMaxEntries[2+1];
        bool      m_bMoreDataFlag;
        char      m_szMoreDataFlag[1+1];
        bool      m_bNextTslogRecordRba;
        long      m_lNextTslogRecordRba;
        bool      m_bNextFilogRecordRba;
        long      m_lNextFilogRecordRba;
        bool      m_bNextFileName;
        char      m_szNextFileName[8+1];
        bool      m_bNextFileGroupNbr;
        char      m_szNextFileGroupNbr[2+1];
    
      public:
        long      m_lIndex;

        AsdSDLOGIN ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            m_lIndex = -1;
            m_bCurApplId = false;
            strcpy(m_szCurApplId, "");
            m_bCurApplCtl1 = false;
            strcpy(m_szCurApplCtl1, "");
            m_bCurApplCtl2 = false;
            strcpy(m_szCurApplCtl2, "");
            m_bCurApplCtl3 = false;
            strcpy(m_szCurApplCtl3, "");
            m_bCurApplCtl4 = false;
            strcpy(m_szCurApplCtl4, "");
            m_bCurApplAcctNbr = false;
            strcpy(m_szCurApplAcctNbr, "");
            m_bMaxEntries = false;
            strcpy(m_szMaxEntries, "00");
            m_bMoreDataFlag = false;
            strcpy(m_szMoreDataFlag, "");
            m_bNextTslogRecordRba = false;
            m_lNextTslogRecordRba = 0;
            m_bNextFilogRecordRba = false;
            m_lNextFilogRecordRba = 0;
            m_bNextFileName = false;
            strcpy(m_szNextFileName, "");
            m_bNextFileGroupNbr = false;
            strcpy(m_szNextFileGroupNbr, "");
        }
        ...
        long lCurApplId () { return 2; };
        RWCString CurApplId (void)
        {
            return m_szCurApplId;
        }
        long CurApplId (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplId, sizeof(m_szCurApplId), &m_bCurApplId);
        }
        
        //    CURRENT APPLICATION HIGHEST LEVEL OF CONTROL
        long lCurApplCtl1 () { return 4; };
        RWCString CurApplCtl1 (void)
        {
            return m_szCurApplCtl1;
        }
        long CurApplCtl1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplCtl1, sizeof(m_szCurApplCtl1), &m_bCurApplCtl1);
        }
        
        //    CURRENT APPLICATION SECOND LEVEL OF CONTROL
        long lCurApplCtl2 () { return 4; };
        RWCString CurApplCtl2 (void)
        {
            return m_szCurApplCtl2;
        }
        long CurApplCtl2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplCtl2, sizeof(m_szCurApplCtl2), &m_bCurApplCtl2);
        }
        
        //    CURRENT APPLICATION THIRD LEVEL OF CONTROL
        long lCurApplCtl3 () { return 4; };
        RWCString CurApplCtl3 (void)
        {
            return m_szCurApplCtl3;
        }
        long CurApplCtl3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplCtl3, sizeof(m_szCurApplCtl3), &m_bCurApplCtl3);
        }
        
        //    CURRENT APPLICATION FOURTH LEVEL OF CONTROL
        long lCurApplCtl4 () { return 4; };
        RWCString CurApplCtl4 (void)
        {
            return m_szCurApplCtl4;
        }
        long CurApplCtl4 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplCtl4, sizeof(m_szCurApplCtl4), &m_bCurApplCtl4);
        }
        
        //    CURRENT APPLICATION ACCOUNT NUMBER
        long lCurApplAcctNbr () { return 27; };
        RWCString CurApplAcctNbr (void)
        {
            return m_szCurApplAcctNbr;
        }
        long CurApplAcctNbr (const RWCString& rwc)
        {
            return SetString(rwc, m_szCurApplAcctNbr, sizeof(m_szCurApplAcctNbr), &m_bCurApplAcctNbr);
        }
        
        //    MAXIMUM NUMBER OF ENTRIES ALLOWED IN TABLE
        long lMaxEntries () { return 2; };
        RWCString MaxEntries (void)
        {
            return m_szMaxEntries;
        }
        long MaxEntries (const RWCString& rwc)
        {
            return SetString(rwc, m_szMaxEntries, sizeof(m_szMaxEntries), &m_bMaxEntries);
        }
        
        //    MORE RECORDS REMAIN IN THE LOG FILES
        long lMoreDataFlag () { return 1; };
        RWCString MoreDataFlag (void)
        {
            return m_szMoreDataFlag;
        }
        long MoreDataFlag (const RWCString& rwc)
        {
            return SetString(rwc, m_szMoreDataFlag, sizeof(m_szMoreDataFlag), &m_bMoreDataFlag);
        }
        
        //    THE RBA OF THE NEXT TSLOG RECORD
        long NextTslogRecordRba (void)
        {
            return m_lNextTslogRecordRba;
        }
        long NextTslogRecordRba (long lValue)
        {
            return SetLong(lValue, &m_lNextTslogRecordRba, &m_bNextTslogRecordRba);
        }
        
        //    THE RBA OF THE NEXT FILOG RECORD
        long NextFilogRecordRba (void)
        {
            return m_lNextFilogRecordRba;
        }
        long NextFilogRecordRba (long lValue)
        {
            return SetLong(lValue, &m_lNextFilogRecordRba, &m_bNextFilogRecordRba);
        }
        
        //    NAME OF THE NEXT LOG FILE TO READ
        long lNextFileName () { return 8; };
        RWCString NextFileName (void)
        {
            return m_szNextFileName;
        }
        long NextFileName (const RWCString& rwc)
        {
            return SetString(rwc, m_szNextFileName, sizeof(m_szNextFileName), &m_bNextFileName);
        }
        
        //    FILE GROUP NUMBER OF NEXT LOG FILE
        long lNextFileGroupNbr () { return 2; };
        RWCString NextFileGroupNbr (void)
        {
            return m_szNextFileGroupNbr;
        }
        long NextFileGroupNbr (const RWCString& rwc)
        {
            return SetString(rwc, m_szNextFileGroupNbr, sizeof(m_szNextFileGroupNbr), &m_bNextFileGroupNbr);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bCurApplId) return true;
            if (m_bCurApplCtl1) return true;
            if (m_bCurApplCtl2) return true;
            if (m_bCurApplCtl3) return true;
            if (m_bCurApplCtl4) return true;
            if (m_bCurApplAcctNbr) return true;
            if (m_bMaxEntries) return true;
            if (m_bMoreDataFlag) return true;
            if (m_bNextTslogRecordRba) return true;
            if (m_bNextFilogRecordRba) return true;
            if (m_bNextFileName) return true;
            if (m_bNextFileGroupNbr) return true;
            return false;
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDLOGIN", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "CurApplId", m_szCurApplId, &m_bCurApplId);
                AddXMLField(pSess, "CurApplCtl1", m_szCurApplCtl1, &m_bCurApplCtl1);
                AddXMLField(pSess, "CurApplCtl2", m_szCurApplCtl2, &m_bCurApplCtl2);
                AddXMLField(pSess, "CurApplCtl3", m_szCurApplCtl3, &m_bCurApplCtl3);
                AddXMLField(pSess, "CurApplCtl4", m_szCurApplCtl4, &m_bCurApplCtl4);
                AddXMLField(pSess, "CurApplAcctNbr", m_szCurApplAcctNbr, &m_bCurApplAcctNbr);
                AddXMLField(pSess, "MaxEntries", m_szMaxEntries, &m_bMaxEntries);
                AddXMLField(pSess, "MoreDataFlag", m_szMoreDataFlag, &m_bMoreDataFlag);
                AddXMLField(pSess, "NextTslogRecordRba", m_lNextTslogRecordRba, &m_bNextTslogRecordRba);
                AddXMLField(pSess, "NextFilogRecordRba", m_lNextFilogRecordRba, &m_bNextFilogRecordRba);
                AddXMLField(pSess, "NextFileName", m_szNextFileName, &m_bNextFileName);
                AddXMLField(pSess, "NextFileGroupNbr", m_szNextFileGroupNbr, &m_bNextFileGroupNbr);
                AddXMLCloseRecord(pSess, "SDLOGIN");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDLOGIN", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "CurApplId", m_szCurApplId);
                GetXMLField(pSess, "CurApplCtl1", m_szCurApplCtl1);
                GetXMLField(pSess, "CurApplCtl2", m_szCurApplCtl2);
                GetXMLField(pSess, "CurApplCtl3", m_szCurApplCtl3);
                GetXMLField(pSess, "CurApplCtl4", m_szCurApplCtl4);
                GetXMLField(pSess, "CurApplAcctNbr", m_szCurApplAcctNbr);
                GetXMLField(pSess, "MaxEntries", m_szMaxEntries);
                GetXMLField(pSess, "MoreDataFlag", m_szMoreDataFlag);
                GetXMLField(pSess, "NextTslogRecordRba", &m_lNextTslogRecordRba);
                GetXMLField(pSess, "NextFilogRecordRba", &m_lNextFilogRecordRba);
                GetXMLField(pSess, "NextFileName", m_szNextFileName);
                GetXMLField(pSess, "NextFileGroupNbr", m_szNextFileGroupNbr);
                CloseXMLRecord(pSess, "SDLOGIN");
            };
        }
    };
    ...
    //**************** End AsdSDLOGIN Definition ****************

    
    //**************** Start AsdSDLOGOUT Definition ****************
    //                 OUTPUT DAG USED TO OBTAIN LOG DATA                          
    
    //    SDLOGOUT.map
    //    generated by Dsm2Ace ver. 3.0.04
    //    on 07/17/02 13:38:51
    class AsdSDLOGOUT
    {
      private:
        bool      m_bHostInitOverride;
        ...
        bool      m_bReceived;
        char      m_szSuppressBuff[100];
        bool      m_bNbrOfEntries;
        char      m_szNbrOfEntries[2+1];
        bool      m_bMoreDataFlag;
        char      m_szMoreDataFlag[1+1];
        bool      m_bNextTslogRecordRba;
        long      m_lNextTslogRecordRba;
        ...
        char      m_szNextFileGroupNbr[2+1];
        bool      m_bRowLimit;
        char      m_szRowLimit[4+1];
        bool      m_bCommonAreaLength;
        char      m_szCommonAreaLength[4+1];
    
      public:
        long      m_lIndex;

        AsdSDLOGOUT ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            m_lIndex = -1;
            m_bNbrOfEntries = false;
            strcpy(m_szNbrOfEntries, "00");
            m_bMoreDataFlag = false;
            strcpy(m_szMoreDataFlag, "");
            m_bNextTslogRecordRba = false;
            m_lNextTslogRecordRba = 0;
            ...
            strcpy(m_szNextFileGroupNbr, "");
            m_bRowLimit = false;
            strcpy(m_szRowLimit, "0000");
            m_bCommonAreaLength = false;
            strcpy(m_szCommonAreaLength, "0000");
            long lOccurs;
        
            for (lOccurs = 0; lOccurs < 50; lOccurs++)
            {
                TransactionData[lOccurs]  = &CTransactionData[lOccurs];
                CTransactionData[lOccurs].m_lIndex = lOccurs;
            }
        }
        ...
        //    ACTUAL NUMBER OF ENTRIES IN TABLE
        long lNbrOfEntries () { return 2; };
        RWCString NbrOfEntries (void)
        {
            return m_szNbrOfEntries;
        }
        long NbrOfEntries (const RWCString& rwc)
        {
            return SetString(rwc, m_szNbrOfEntries, sizeof(m_szNbrOfEntries), &m_bNbrOfEntries);
        }
        ...
        //    MAXIMUM SIZE OF ONE ROW IN TABLE
        long lRowLimit () { return 4; };
        RWCString RowLimit (void)
        {
            return m_szRowLimit;
        }
        long RowLimit (const RWCString& rwc)
        {
            return SetString(rwc, m_szRowLimit, sizeof(m_szRowLimit), &m_bRowLimit);
        }
        
        //    LENGTH OF DAG COMMON AREA
        long lCommonAreaLength () { return 4; };
        RWCString CommonAreaLength (void)
        {
            return m_szCommonAreaLength;
        }
        long CommonAreaLength (const RWCString& rwc)
        {
            return SetString(rwc, m_szCommonAreaLength, sizeof(m_szCommonAreaLength), &m_bCommonAreaLength);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bNbrOfEntries) return true;
            if (m_bMoreDataFlag) return true;
            if (m_bNextTslogRecordRba) return true;
            if (m_bNextFilogRecordRba) return true;
            if (m_bNextFileName) return true;
            if (m_bNextFileGroupNbr) return true;
            if (m_bRowLimit) return true;
            if (m_bCommonAreaLength) return true;
            long lOccurs;
            for (lOccurs = 0; lOccurs < 50; lOccurs++)
            {
                if(CTransactionData[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDLOGOUT", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "NbrOfEntries", m_szNbrOfEntries, &m_bNbrOfEntries);
                AddXMLField(pSess, "MoreDataFlag", m_szMoreDataFlag, &m_bMoreDataFlag);
                AddXMLField(pSess, "NextTslogRecordRba", m_lNextTslogRecordRba, &m_bNextTslogRecordRba);
                AddXMLField(pSess, "NextFilogRecordRba", m_lNextFilogRecordRba, &m_bNextFilogRecordRba);
                AddXMLField(pSess, "NextFileName", m_szNextFileName, &m_bNextFileName);
                AddXMLField(pSess, "NextFileGroupNbr", m_szNextFileGroupNbr, &m_bNextFileGroupNbr);
                AddXMLField(pSess, "RowLimit", m_szRowLimit, &m_bRowLimit);
                AddXMLField(pSess, "CommonAreaLength", m_szCommonAreaLength, &m_bCommonAreaLength);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 50; lOccurs++)
                {
                    CTransactionData[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "SDLOGOUT");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDLOGOUT", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "NbrOfEntries", m_szNbrOfEntries);
                GetXMLField(pSess, "MoreDataFlag", m_szMoreDataFlag);
                GetXMLField(pSess, "NextTslogRecordRba", &m_lNextTslogRecordRba);
                GetXMLField(pSess, "NextFilogRecordRba", &m_lNextFilogRecordRba);
                GetXMLField(pSess, "NextFileName", m_szNextFileName);
                GetXMLField(pSess, "NextFileGroupNbr", m_szNextFileGroupNbr);
                GetXMLField(pSess, "RowLimit", m_szRowLimit);
                GetXMLField(pSess, "CommonAreaLength", m_szCommonAreaLength);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 50; lOccurs++)
                {
                    CTransactionData[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "SDLOGOUT");
            };
        }
        
        //**************** Start AsdTransactionData Definition ****************
        //                 TRANSACTION DATA
        
        class AsdTransactionData
        {
          private:
            bool      m_bReceived;
            char      m_szSuppressBuff[100];
            ...
            bool      m_bTranDescription;
            char      m_szTranDescription[15+1];
            bool      m_bApplDbCrFlag;
            char      m_szApplDbCrFlag[2+1];
            bool      m_bTdaAmount;
            char      m_szTdaAmount[19+1];
            bool      m_bApplIntrnlDescrTxt;
            char      m_szApplIntrnlDescrTxt[80+1];
            bool      m_bFileName;
            char      m_szFileName[5+1];
            bool      m_bFileGroupNumber;
            char      m_szFileGroupNumber[2+1];
            bool      m_bRbaOfRecord;
            long      m_lRbaOfRecord;
            bool      m_bLogSequenceNumber;
            char      m_szLogSequenceNumber[2+1];
            bool      m_bTransactionDate;
            char      m_szTransactionDate[8+1];
            bool      m_bTranTime;
            char      m_szTranTime[6+1];
            bool      m_bEmpId;
            char      m_szEmpId[8+1];
            bool      m_bTermId;
            char      m_szTermId[4+1];
            bool      m_bTranPhysicalLoc;
            char      m_szTranPhysicalLoc[4+1];
            bool      m_bTranProcessedFlag;
            char      m_szTranProcessedFlag[1+1];
            bool      m_bTranReversalFlag;
            char      m_szTranReversalFlag[1+1];
            bool      m_bTranReversalSeqNo;
            char      m_szTranReversalSeqNo[8+1];
            bool      m_bTranReentryFlag;
            char      m_szTranReentryFlag[1+1];
            bool      m_bTranTotalDepartment;
            char      m_szTranTotalDepartment[3+1];
            bool      m_bTranTotalBatch;
            char      m_szTranTotalBatch[5+1];
            bool      m_bTranTotalSubBatch;
            char      m_szTranTotalSubBatch[5+1];
        
          public:
            long      m_lIndex;

            AsdTransactionData ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bUserTranCode = false;
                strcpy(m_szUserTranCode, "");
                m_bTranDescription = false;
                strcpy(m_szTranDescription, "");
                m_bApplDbCrFlag = false;
                strcpy(m_szApplDbCrFlag, "");
                m_bTdaAmount = false;
                strcpy(m_szTdaAmount, "+000000000000000.00");
                m_bApplIntrnlDescrTxt = false;
                strcpy(m_szApplIntrnlDescrTxt, "");
                m_bFileName = false;
                strcpy(m_szFileName, "");
                m_bFileGroupNumber = false;
                strcpy(m_szFileGroupNumber, "");
                m_bRbaOfRecord = false;
                m_lRbaOfRecord = 0;
                m_bLogSequenceNumber = false;
                strcpy(m_szLogSequenceNumber, "00");
                m_bTransactionDate = false;
                strcpy(m_szTransactionDate, "");
                m_bTranTime = false;
                strcpy(m_szTranTime, "000000");
                m_bEmpId = false;
                strcpy(m_szEmpId, "");
                m_bTermId = false;
                strcpy(m_szTermId, "");
                m_bTranPhysicalLoc = false;
                strcpy(m_szTranPhysicalLoc, "");
                m_bTranProcessedFlag = false;
                strcpy(m_szTranProcessedFlag, "");
                m_bTranReversalFlag = false;
                strcpy(m_szTranReversalFlag, "");
                m_bTranReversalSeqNo = false;
                strcpy(m_szTranReversalSeqNo, "");
                m_bTranReentryFlag = false;
                strcpy(m_szTranReentryFlag, "");
                m_bTranTotalDepartment = false;
                strcpy(m_szTranTotalDepartment, "");
                m_bTranTotalBatch = false;
                strcpy(m_szTranTotalBatch, "");
                m_bTranTotalSubBatch = false;
                strcpy(m_szTranTotalSubBatch, "");
            ...
            long lTranDescription () { return 15; };
            RWCString TranDescription (void)
            {
                return m_szTranDescription;
            }
            long TranDescription (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranDescription, sizeof(m_szTranDescription), &m_bTranDescription);
            }
            
            //    APPL DB/CR FLAG
            long lApplDbCrFlag () { return 2; };
            RWCString ApplDbCrFlag (void)
            {
                return m_szApplDbCrFlag;
            }
            long ApplDbCrFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szApplDbCrFlag, sizeof(m_szApplDbCrFlag), &m_bApplDbCrFlag);
            }
            
            //    LOG TRANSACTION AMOUNT
            long lTdaAmount () { return 19; };
            RWCString TdaAmount (void)
            {
                return AceZeroSupp(m_szTdaAmount, &m_szSuppressBuff[0]);
            }
            RWCString TdaAmountRaw (void)
            {
                return m_szTdaAmount;
            }
            long TdaAmount (const RWCString& rwc)
            {
                return SetString(rwc, m_szTdaAmount, sizeof(m_szTdaAmount), &m_bTdaAmount);
            }
            
            //    APPLICATION INTERNAL DESCRIPTION
            long lApplIntrnlDescrTxt () { return 80; };
            RWCString ApplIntrnlDescrTxt (void)
            {
                return m_szApplIntrnlDescrTxt;
            }
            long ApplIntrnlDescrTxt (const RWCString& rwc)
            {
                return SetString(rwc, m_szApplIntrnlDescrTxt, sizeof(m_szApplIntrnlDescrTxt), &m_bApplIntrnlDescrTxt);
            }
            
            //    NEXT LOG FILE NAME
            long lFileName () { return 5; };
            RWCString FileName (void)
            {
                return m_szFileName;
            }
            long FileName (const RWCString& rwc)
            {
                return SetString(rwc, m_szFileName, sizeof(m_szFileName), &m_bFileName);
            }
            
            //    LOG FILE GROUP NUMBER
            long lFileGroupNumber () { return 2; };
            RWCString FileGroupNumber (void)
            {
                return m_szFileGroupNumber;
            }
            long FileGroupNumber (const RWCString& rwc)
            {
                return SetString(rwc, m_szFileGroupNumber, sizeof(m_szFileGroupNumber), &m_bFileGroupNumber);
            }
            
            //    THE RBA OF THE LOG RECORD
            long RbaOfRecord (void)
            {
                return m_lRbaOfRecord;
            }
            long RbaOfRecord (long lValue)
            {
                return SetLong(lValue, &m_lRbaOfRecord, &m_bRbaOfRecord);
            }
            
            //    LOG RECORD SEQUENCE NUMBER
            long lLogSequenceNumber () { return 2; };
            RWCString LogSequenceNumber (void)
            {
                return m_szLogSequenceNumber;
            }
            long LogSequenceNumber (const RWCString& rwc)
            {
                return SetString(rwc, m_szLogSequenceNumber, sizeof(m_szLogSequenceNumber), &m_bLogSequenceNumber);
            }
            
            //    DATE OF LOG REC TRANSACTION
            long lTransactionDate () { return 8; };
            RWCString TransactionDate (void)
            {
                return m_szTransactionDate;
            }
            long TransactionDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szTransactionDate, sizeof(m_szTransactionDate), &m_bTransactionDate);
            }
            
            //    LOG REC TRANSACTION TIME
            long lTranTime () { return 6; };
            RWCString TranTime (void)
            {
                return m_szTranTime;
            ...
            //    EMPLOYEE ID
            long lEmpId () { return 8; };
            RWCString EmpId (void)
            {
                return m_szEmpId;
            }
            long EmpId (const RWCString& rwc)
            {
                return SetString(rwc, m_szEmpId, sizeof(m_szEmpId), &m_bEmpId);
            }
            ...
            //    LOG TRANSACTION PHYSICAL LOCATION
            long lTranPhysicalLoc () { return 4; };
            RWCString TranPhysicalLoc (void)
            {
                return m_szTranPhysicalLoc;
            }
            long TranPhysicalLoc (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranPhysicalLoc, sizeof(m_szTranPhysicalLoc), &m_bTranPhysicalLoc);
            }
            
            //    LOG TRANSACTION PROCESSED FLAG
            long lTranProcessedFlag () { return 1; };
            RWCString TranProcessedFlag (void)
            {
                return m_szTranProcessedFlag;
            }
            long TranProcessedFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranProcessedFlag, sizeof(m_szTranProcessedFlag), &m_bTranProcessedFlag);
            }
            
            //    LOG TRANSACTION REVERSAL FLAG
            long lTranReversalFlag () { return 1; };
            RWCString TranReversalFlag (void)
            {
                return m_szTranReversalFlag;
            }
            long TranReversalFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranReversalFlag, sizeof(m_szTranReversalFlag), &m_bTranReversalFlag);
            }
            
            //    LOG TRANSACTION REVERSAL SEQUENCE NUMBER
            long lTranReversalSeqNo () { return 8; };
            RWCString TranReversalSeqNo (void)
            {
                return m_szTranReversalSeqNo;
            }
            long TranReversalSeqNo (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranReversalSeqNo, sizeof(m_szTranReversalSeqNo), &m_bTranReversalSeqNo);
            }
            
            //    LOG TRANSACTION RE-ENTRY FLAG
            long lTranReentryFlag () { return 1; };
            RWCString TranReentryFlag (void)
            {
                return m_szTranReentryFlag;
            }
            long TranReentryFlag (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranReentryFlag, sizeof(m_szTranReentryFlag), &m_bTranReentryFlag);
            }
            
            //    LOG TRANSACTION TOTAL DEPARTMENT
            long lTranTotalDepartment () { return 3; };
            RWCString TranTotalDepartment (void)
            {
                return m_szTranTotalDepartment;
            }
            long TranTotalDepartment (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranTotalDepartment, sizeof(m_szTranTotalDepartment), &m_bTranTotalDepartment);
            }
            
            //    LOG TRANSACTION TOTAL BATCH
            long lTranTotalBatch () { return 5; };
            RWCString TranTotalBatch (void)
            {
                return m_szTranTotalBatch;
            }
            long TranTotalBatch (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranTotalBatch, sizeof(m_szTranTotalBatch), &m_bTranTotalBatch);
            }
            
            //    LOG TRANSACTION TOTAL SUB-BATCH
            long lTranTotalSubBatch () { return 5; };
            RWCString TranTotalSubBatch (void)
            {
                return m_szTranTotalSubBatch;
            }
            long TranTotalSubBatch (const RWCString& rwc)
            {
                return SetString(rwc, m_szTranTotalSubBatch, sizeof(m_szTranTotalSubBatch), &m_bTranTotalSubBatch);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bUserTranCode) return true;
                if (m_bTranDescription) return true;
                if (m_bApplDbCrFlag) return true;
                if (m_bTdaAmount) return true;
                if (m_bApplIntrnlDescrTxt) return true;
                if (m_bFileName) return true;
                if (m_bFileGroupNumber) return true;
                if (m_bRbaOfRecord) return true;
                if (m_bLogSequenceNumber) return true;
                if (m_bTransactionDate) return true;
                if (m_bTranTime) return true;
                if (m_bEmpId) return true;
                if (m_bTermId) return true;
                if (m_bTranPhysicalLoc) return true;
                if (m_bTranProcessedFlag) return true;
                if (m_bTranReversalFlag) return true;
                if (m_bTranReversalSeqNo) return true;
                if (m_bTranReentryFlag) return true;
                if (m_bTranTotalDepartment) return true;
                if (m_bTranTotalBatch) return true;
                if (m_bTranTotalSubBatch) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "TransactionData", m_lIndex);
                    AddXMLField(pSess, "UserTranCode", m_szUserTranCode, &m_bUserTranCode);
                    AddXMLField(pSess, "TranDescription", m_szTranDescription, &m_bTranDescription);
                    AddXMLField(pSess, "ApplDbCrFlag", m_szApplDbCrFlag, &m_bApplDbCrFlag);
                    AddXMLField(pSess, "TdaAmount", m_szTdaAmount, &m_bTdaAmount);
                    AddXMLField(pSess, "ApplIntrnlDescrTxt", m_szApplIntrnlDescrTxt, &m_bApplIntrnlDescrTxt);
                    AddXMLField(pSess, "FileName", m_szFileName, &m_bFileName);
                    AddXMLField(pSess, "FileGroupNumber", m_szFileGroupNumber, &m_bFileGroupNumber);
                    AddXMLField(pSess, "RbaOfRecord", m_lRbaOfRecord, &m_bRbaOfRecord);
                    AddXMLField(pSess, "LogSequenceNumber", m_szLogSequenceNumber, &m_bLogSequenceNumber);
                    AddXMLField(pSess, "TransactionDate", m_szTransactionDate, &m_bTransactionDate);
                    AddXMLField(pSess, "TranTime", m_szTranTime, &m_bTranTime);
                    AddXMLField(pSess, "EmpId", m_szEmpId, &m_bEmpId);
                    AddXMLField(pSess, "TermId", m_szTermId, &m_bTermId);
                    AddXMLField(pSess, "TranPhysicalLoc", m_szTranPhysicalLoc, &m_bTranPhysicalLoc);
                    AddXMLField(pSess, "TranProcessedFlag", m_szTranProcessedFlag, &m_bTranProcessedFlag);
                    AddXMLField(pSess, "TranReversalFlag", m_szTranReversalFlag, &m_bTranReversalFlag);
                    AddXMLField(pSess, "TranReversalSeqNo", m_szTranReversalSeqNo, &m_bTranReversalSeqNo);
                    AddXMLField(pSess, "TranReentryFlag", m_szTranReentryFlag, &m_bTranReentryFlag);
                    AddXMLField(pSess, "TranTotalDepartment", m_szTranTotalDepartment, &m_bTranTotalDepartment);
                    AddXMLField(pSess, "TranTotalBatch", m_szTranTotalBatch, &m_bTranTotalBatch);
                    AddXMLField(pSess, "TranTotalSubBatch", m_szTranTotalSubBatch, &m_bTranTotalSubBatch);
                    AddXMLCloseRecord(pSess, "TransactionData");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "TransactionData", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "UserTranCode", m_szUserTranCode);
                    GetXMLField(pSess, "TranDescription", m_szTranDescription);
                    GetXMLField(pSess, "ApplDbCrFlag", m_szApplDbCrFlag);
                    GetXMLField(pSess, "TdaAmount", m_szTdaAmount);
                    GetXMLField(pSess, "ApplIntrnlDescrTxt", m_szApplIntrnlDescrTxt);
                    GetXMLField(pSess, "FileName", m_szFileName);
                    GetXMLField(pSess, "FileGroupNumber", m_szFileGroupNumber);
                    GetXMLField(pSess, "RbaOfRecord", &m_lRbaOfRecord);
                    GetXMLField(pSess, "LogSequenceNumber", m_szLogSequenceNumber);
                    GetXMLField(pSess, "TransactionDate", m_szTransactionDate);
                    GetXMLField(pSess, "TranTime", m_szTranTime);
                    GetXMLField(pSess, "EmpId", m_szEmpId);
                    GetXMLField(pSess, "TermId", m_szTermId);
                    GetXMLField(pSess, "TranPhysicalLoc", m_szTranPhysicalLoc);
                    GetXMLField(pSess, "TranProcessedFlag", m_szTranProcessedFlag);
                    GetXMLField(pSess, "TranReversalFlag", m_szTranReversalFlag);
                    GetXMLField(pSess, "TranReversalSeqNo", m_szTranReversalSeqNo);
                    GetXMLField(pSess, "TranReentryFlag", m_szTranReentryFlag);
                    GetXMLField(pSess, "TranTotalDepartment", m_szTranTotalDepartment);
                    GetXMLField(pSess, "TranTotalBatch", m_szTranTotalBatch);
                    GetXMLField(pSess, "TranTotalSubBatch", m_szTranTotalSubBatch);
                    CloseXMLRecord(pSess, "TransactionData");
                };
            }
        };

        AsdTransactionData  CTransactionData[50];
        AsdTransactionData *TransactionData[50];
        
        //**************** End AsdTransactionData Definition ****************
        
    };

    AsdSDLOGOUT CSDLOGOUT;
    AsdSDLOGOUT *SDLOGOUT;
    
    //**************** End AsdSDLOGOUT Definition ****************
...
//**************** End AsdSDPCLGIQData Definition ****************

typedef AsdSDPCLGIQData *LPSDPCLGIQ;
typedef AsdSDPCLGIQData::AsdTSHeader *LPSDPCLGIQ_TSHeader;
typedef AsdSDPCLGIQData::AsdSDLOGIN *LPSDPCLGIQ_SDLOGIN;
typedef AsdSDPCLGIQData::AsdSDLOGOUT *LPSDPCLGIQ_SDLOGOUT;
typedef AsdSDPCLGIQData::AsdSDLOGOUT::AsdTransactionData *LPSDPCLGIQ_SDLOGOUT_TransactionData;
typedef AsdSDPCLGIQData::AsdTSMDA *LPSDPCLGIQ_TSMDA;
typedef AsdSDPCLGIQData::AsdTSMDA::AsdMdaTrmMsg *LPSDPCLGIQ_TSMDA_MdaTrmMsg;
typedef AsdSDPCLGIQData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCLGIQ_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCLGIQData_H
