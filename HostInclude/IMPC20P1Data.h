#ifndef AsdIMPC20P1Data_H
#define AsdIMPC20P1Data_H

#include <stdlib.h>
#ifdef  AsdIMPC20P1_INTEGRITY_STRING
#undef  AsdIMPC20P1_INTEGRITY_STRING
#endif
#define AsdIMPC20P1_INTEGRITY_STRING        ""

#ifdef  AsdIMPC20P1_CRC_STRING
#undef  AsdIMPC20P1_CRC_STRING
#endif
#define AsdIMPC20P1_CRC_STRING "4072432272"
...
//**************** Start AsdIMPC20P1Data Definition ****************
//                 IM Generic Field Maintenance

//                 IMPC20P1Data.h generated by AceGen2 ver. 2.5.09

class AsdIMPC20P1Data
{
  public:
  ...
  public:
    AsdIMPC20P1Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "IMPC20P1.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdIMPC20P1_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdIMPC20P1_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "IMPC20P1", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CIMCMSD00.Load(&m_Sess);
                        CIMTRMNT1.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "IMPC20P1");
                    }
    ...
    class AsdIMTRMNT1
    {
      ...
      public:
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "IMTRMNT1", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
                ...
                AddXMLCloseRecord(pSess, "IMTRMNT1");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "IMTRMNT1", m_lIndex, &m_bReceived))
            {
                long lOccurs;
                for (lOccurs = 0; lOccurs < 10; lOccurs++)
                {
        ...
        class AsdRecord
        {
          ...
          public:
            ...
            //    MAINT TRAN CUSTOMER REQUEST FLAG
            ...
            //    MAINT TRAN NEGATIVE INDICATOR
            long lNegInd () { return 1; };
            RWCString NegInd (void)
            {
                return m_szNegInd;
            }
            long NegInd (const RWCString& rwc)
            {
                return SetString(rwc, m_szNegInd, sizeof(m_szNegInd), &m_bNegInd);
            }
            ...
            //    MAINT TRAN POSTING SEQUENCE
            long lPostSeq () { return 1; };
            RWCString PostSeq (void)
            {
                return m_szPostSeq;
            }
            long PostSeq (const RWCString& rwc)
            {
                return SetString(rwc, m_szPostSeq, sizeof(m_szPostSeq), &m_bPostSeq);
            }
            ...
            bool HasDataToSave (void)
            {
                ...
                if (m_bNegInd) return true;
                if (m_bNewData) return true;
                if (m_bPostSeq) return true;
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    ...
                    AddXMLField(pSess, "NegInd", m_szNegInd, &m_bNegInd);
                    AddXMLField(pSess, "NewData", m_szNewData, &m_bNewData);
                    AddXMLField(pSess, "PostSeq", m_szPostSeq, &m_bPostSeq);
            ...
            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "Record", m_lIndex, &m_bReceived))
                {
                    ...
                    GetXMLField(pSess, "NegInd", m_szNegInd);
                    GetXMLField(pSess, "NewData", m_szNewData);
                    GetXMLField(pSess, "PostSeq", m_szPostSeq);
    ...
    AsdIMTRMNT1 CIMTRMNT1;
    AsdIMTRMNT1 *IMTRMNT1;
    
    //**************** End AsdIMTRMNT1 Definition ****************
    ...
    class AsdTSMDA
    {
      private:
        ...
        bool      m_bMdaStmAcct;
        char      m_szMdaStmAcct[50+1];
        bool      m_bMdaStemCtlsLen;
        short     m_nMdaStemCtlsLen;
        bool      m_bFill1;
        char      m_szFill1[20+1];
        bool      m_bFill5;
        char      m_szFill5[140+1];
      ...
      public:
        ...
        AsdTSMDA ()  // Constructor
        {
            ...
            m_bMdaStmAcct = false;
            strcpy(m_szMdaStmAcct, "");
            m_bMdaStemCtlsLen = false;
            m_nMdaStemCtlsLen = 0;
            m_bFill1 = false;
            strcpy(m_szFill1, "");
            m_bFill5 = false;
        ...
        //    MDA STM ACCT KEY
        long lMdaStmAcct () { return 50; };
        RWCString MdaStmAcct (void)
        {
            return m_szMdaStmAcct;
        }
        long MdaStmAcct (const RWCString& rwc)
        {
            return SetString(rwc, m_szMdaStmAcct, sizeof(m_szMdaStmAcct), &m_bMdaStmAcct);
        }
        
        //    MDA STEM CTLS LENGTH
        short MdaStemCtlsLen (void)
        {
            return m_nMdaStemCtlsLen;
        }
        long MdaStemCtlsLen (const short nValue)
        {
            return SetShort(nValue, &m_nMdaStemCtlsLen, &m_bMdaStemCtlsLen);
        }
        
        long lFill1 () { return 20; };
        ...
        long lFill5 () { return 140; };
        RWCString Fill5 (void)
        {
            return m_szFill5;
        }
        long Fill5 (const RWCString& rwc)
        {
            return SetString(rwc, m_szFill5, sizeof(m_szFill5), &m_bFill5);
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bMdaStmAcct) return true;
            if (m_bMdaStemCtlsLen) return true;
            if (m_bFill1) return true;
            if (m_bFill5) return true;
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                ...
                AddXMLField(pSess, "MdaStmAcct", m_szMdaStmAcct, &m_bMdaStmAcct);
                AddXMLField(pSess, "MdaStemCtlsLen", m_nMdaStemCtlsLen, &m_bMdaStemCtlsLen);
                AddXMLField(pSess, "Fill1", m_szFill1, &m_bFill1);
                AddXMLField(pSess, "Fill5", m_szFill5, &m_bFill5);
        ...
        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "TSMDA", m_lIndex, &m_bReceived))
            {
                ...
                GetXMLField(pSess, "MdaStmAcct", m_szMdaStmAcct);
                GetXMLField(pSess, "MdaStemCtlsLen", &m_nMdaStemCtlsLen);
                GetXMLField(pSess, "Fill1", m_szFill1);
                GetXMLField(pSess, "Fill5", m_szFill5);
          ...
          public:
            ...
            class AsdMdaMsg
            {
              private:
                ...
                bool      m_bMdaAcctKey;
                char      m_szMdaAcctKey[50+1];
                bool      m_bMdaCtlsLength;
                short     m_nMdaCtlsLength;
                bool      m_bFill2;
                char      m_szFill2[20+1];
              ...
              public:
                ...
                //    MDA CTLS LENGTH
                short MdaCtlsLength (void)
                {
                    return m_nMdaCtlsLength;
                }
                long MdaCtlsLength (const short nValue)
                {
                    return SetShort(nValue, &m_nMdaCtlsLength, &m_bMdaCtlsLength);
                }
                
                long lFill2 () { return 20; };
                ...
                bool HasDataToSave (void)
                {
                    ...
                    if (m_bMdaCtlsLength) return true;
                ...
                void Save (SESSIONDATA *pSess)
                {
                    if (HasDataToSave())
                    {
                        ...
                        AddXMLField(pSess, "MdaCtlsLength", m_nMdaCtlsLength, &m_bMdaCtlsLength);
                ...
                void Load (SESSIONDATA *pSess)
                {
                    if (GetXMLRecord(pSess, "MdaMsg", m_lIndex, &m_bReceived))
                    {
                        ...
                        GetXMLField(pSess, "MdaCtlsLength", &m_nMdaCtlsLength);
...
//**************** End AsdIMPC20P1Data Definition ****************

typedef AsdIMPC20P1Data *LPIMPC20P1;
typedef AsdIMPC20P1Data::AsdTSHeader *LPIMPC20P1_TSHeader;
typedef AsdIMPC20P1Data::AsdIMCMSD00 *LPIMPC20P1_IMCMSD00;
typedef AsdIMPC20P1Data::AsdIMTRMNT1 *LPIMPC20P1_IMTRMNT1;
typedef AsdIMPC20P1Data::AsdIMTRMNT1::AsdRecord *LPIMPC20P1_IMTRMNT1_Record;
typedef AsdIMPC20P1Data::AsdTSMDA *LPIMPC20P1_TSMDA;
typedef AsdIMPC20P1Data::AsdTSMDA::AsdMdaTrmMsg *LPIMPC20P1_TSMDA_MdaTrmMsg;
typedef AsdIMPC20P1Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPIMPC20P1_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdIMPC20P1Data_H
