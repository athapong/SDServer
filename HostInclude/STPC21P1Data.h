#ifndef AsdSTPC21P1Data_H
#define AsdSTPC21P1Data_H

#include <stdlib.h>
#ifdef  AsdSTPC21P1_INTEGRITY_STRING
#undef  AsdSTPC21P1_INTEGRITY_STRING
#endif
#define AsdSTPC21P1_INTEGRITY_STRING        ""

#ifdef  AsdSTPC21P1_CRC_STRING
#undef  AsdSTPC21P1_CRC_STRING
#endif
#define AsdSTPC21P1_CRC_STRING "1027352350"
...
//**************** Start AsdSTPC21P1Data Definition ****************
//                 ST N/A Maintenance

//                 STPC21P1Data.h generated by AceGen2 ver. 2.5.09

class AsdSTPC21P1Data
{
  public:
  ...
  public:
    AsdSTPC21P1Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "STPC21P1.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSTPC21P1_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSTPC21P1_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "STPC21P1", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDSTCMMI.Load(&m_Sess);
                        CSTTRNAME.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "STPC21P1");
                    }
    ...
    //**************** Start AsdSTTRNAME Definition ****************
    //                 ST APPC NAME/ADDR MAINT DAG                                 
    ...
    class AsdSTTRNAME
    {
      private:
        ...
        bool      m_bStNaTrlrSpecInstr;
        char      m_szStNaTrlrSpecInstr[1+1];
        bool      m_bSpecialInstructions;
        char      m_szSpecialInstructions[40+1];
        bool      m_bStShortName;
        char      m_szStShortName[13+1];
        bool      m_bTinName;
        char      m_szTinName[40+1];
        bool      m_bGenrPrp;
        char      m_szGenrPrp[1+1];
        bool      m_bGenrOfficerInit;
        char      m_szGenrOfficerInit[3+1];
        bool      m_bGenrCustGen;
        char      m_szGenrCustGen[1+1];
        bool      m_bStHpnAreaCode;
        char      m_szStHpnAreaCode[3+1];
        bool      m_bHomePhone;
        char      m_szHomePhone[7+1];
        bool      m_bStOpnAreaCode;
        char      m_szStOpnAreaCode[3+1];
        bool      m_bOfficePhone;
        char      m_szOfficePhone[7+1];
        bool      m_bTinCode;
        char      m_szTinCode[1+1];
        bool      m_bStTinNumber;
        char      m_szStTinNumber[9+1];
    
      public:
        long      m_lIndex;

        AsdSTTRNAME ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            ...
            m_bStNaTrlrSpecInstr = false;
            strcpy(m_szStNaTrlrSpecInstr, "");
            m_bSpecialInstructions = false;
            strcpy(m_szSpecialInstructions, "");
            ...
            m_bGenrPrp = false;
            strcpy(m_szGenrPrp, "");
            m_bGenrOfficerInit = false;
            strcpy(m_szGenrOfficerInit, "");
            m_bGenrCustGen = false;
            strcpy(m_szGenrCustGen, "");
            m_bStHpnAreaCode = false;
            strcpy(m_szStHpnAreaCode, "");
            m_bHomePhone = false;
            strcpy(m_szHomePhone, "");
            m_bStOpnAreaCode = false;
            strcpy(m_szStOpnAreaCode, "");
            m_bOfficePhone = false;
            strcpy(m_szOfficePhone, "");
            m_bTinCode = false;
            strcpy(m_szTinCode, "");
            m_bStTinNumber = false;
            strcpy(m_szStTinNumber, "");
            long lOccurs;
        ...
        //    C/S CODE
        long lGenrCsCode () { return 3; };
        RWCString GenrCsCode (void)
        {
            return m_szGenrCsCode;
        }
        long GenrCsCode (const RWCString& rwc)
        {
            return SetString(rwc, m_szGenrCsCode, sizeof(m_szGenrCsCode), &m_bGenrCsCode);
        }
        ...
        //    CONTAINS THE ZIP CODE FIELDS FOR SORTING FOR MAILERS
        ...
        long lStNaTrlrSpecInstr () { return 1; };
        RWCString StNaTrlrSpecInstr (void)
        {
            return m_szStNaTrlrSpecInstr;
        }
        long StNaTrlrSpecInstr (const RWCString& rwc)
        {
            return SetString(rwc, m_szStNaTrlrSpecInstr, sizeof(m_szStNaTrlrSpecInstr), &m_bStNaTrlrSpecInstr);
        }
        
        //    SPECIAL INSTRUCTION LINE
        long lSpecialInstructions () { return 40; };
        RWCString SpecialInstructions (void)
        {
            return m_szSpecialInstructions;
        }
        long SpecialInstructions (const RWCString& rwc)
        {
            return SetString(rwc, m_szSpecialInstructions, sizeof(m_szSpecialInstructions), &m_bSpecialInstructions);
        }
        
        //    SHORT NAME/USED FOR SORTING ALPHABETICALLY
        ...
        //    NAME ON TAX ID NUMBER
        long lTinName () { return 40; };
        RWCString TinName (void)
        {
            return m_szTinName;
        }
        long TinName (const RWCString& rwc)
        {
            return SetString(rwc, m_szTinName, sizeof(m_szTinName), &m_bTinName);
        }
        
        //    EXTEND CHG TO ALL ACCTS WITH SAME CUST NMBR
        long lGenrPrp () { return 1; };
        RWCString GenrPrp (void)
        {
            return m_szGenrPrp;
        }
        long GenrPrp (const RWCString& rwc)
        {
            return SetString(rwc, m_szGenrPrp, sizeof(m_szGenrPrp), &m_bGenrPrp);
        }
        
        //    INITIALS OF THE OFFICER GIVING AUTHORIZATION
        long lGenrOfficerInit () { return 3; };
        RWCString GenrOfficerInit (void)
        {
            return m_szGenrOfficerInit;
        }
        long GenrOfficerInit (const RWCString& rwc)
        {
            return SetString(rwc, m_szGenrOfficerInit, sizeof(m_szGenrOfficerInit), &m_bGenrOfficerInit);
        }
        
        //    CUSTOMER REQUEST / GENERATED CODE
        long lGenrCustGen () { return 1; };
        RWCString GenrCustGen (void)
        {
            return m_szGenrCustGen;
        }
        long GenrCustGen (const RWCString& rwc)
        {
            return SetString(rwc, m_szGenrCustGen, sizeof(m_szGenrCustGen), &m_bGenrCustGen);
        }
        ...
        long lHomePhone () { return 7; };
        RWCString HomePhone (void)
        {
            return m_szHomePhone;
        }
        long HomePhone (const RWCString& rwc)
        {
            return SetString(rwc, m_szHomePhone, sizeof(m_szHomePhone), &m_bHomePhone);
        }
        ...
        //    OFFICE PHONE NUMBER
        long lOfficePhone () { return 7; };
        RWCString OfficePhone (void)
        {
            return m_szOfficePhone;
        }
        long OfficePhone (const RWCString& rwc)
        {
            return SetString(rwc, m_szOfficePhone, sizeof(m_szOfficePhone), &m_bOfficePhone);
        }
        
        //    FEDERAL TAX IDENTIFICATION CODE/1 = BUSINESS ID  2 = SSN
        long lTinCode () { return 1; };
        RWCString TinCode (void)
        {
            return m_szTinCode;
        }
        long TinCode (const RWCString& rwc)
        {
            return SetString(rwc, m_szTinCode, sizeof(m_szTinCode), &m_bTinCode);
        }
        
        //    CONTAINS THE FIELDS THAT MAKE UP THE SOCIAL SECURITY NUMBER
        long lStTinNumber () { return 9; };
        RWCString StTinNumber (void)
        {
            return m_szStTinNumber;
        }
        long StTinNumber (const RWCString& rwc)
        {
            return SetString(rwc, m_szStTinNumber, sizeof(m_szStTinNumber), &m_bStTinNumber);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bGenrCsCode) return true;
            if (m_bCityState) return true;
            if (m_bZipCode) return true;
            if (m_bForeignAddrInd) return true;
            if (m_bStNaTrlrCountry) return true;
            if (m_bStNaTrlrSpecInstr) return true;
            if (m_bSpecialInstructions) return true;
            if (m_bStShortName) return true;
            if (m_bTinName) return true;
            if (m_bGenrPrp) return true;
            if (m_bGenrOfficerInit) return true;
            if (m_bGenrCustGen) return true;
            if (m_bStHpnAreaCode) return true;
            if (m_bHomePhone) return true;
            if (m_bStOpnAreaCode) return true;
            if (m_bOfficePhone) return true;
            if (m_bTinCode) return true;
            if (m_bStTinNumber) return true;
            long lOccurs;
            for (lOccurs = 0; lOccurs < 4; lOccurs++)
            {
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "STTRNAME", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "GenrCsCode", m_szGenrCsCode, &m_bGenrCsCode);
                ...
                AddXMLField(pSess, "StNaTrlrSpecInstr", m_szStNaTrlrSpecInstr, &m_bStNaTrlrSpecInstr);
                AddXMLField(pSess, "SpecialInstructions", m_szSpecialInstructions, &m_bSpecialInstructions);
                AddXMLField(pSess, "StShortName", m_szStShortName, &m_bStShortName);
                AddXMLField(pSess, "TinName", m_szTinName, &m_bTinName);
                AddXMLField(pSess, "GenrPrp", m_szGenrPrp, &m_bGenrPrp);
                AddXMLField(pSess, "GenrOfficerInit", m_szGenrOfficerInit, &m_bGenrOfficerInit);
                AddXMLField(pSess, "GenrCustGen", m_szGenrCustGen, &m_bGenrCustGen);
                AddXMLField(pSess, "StHpnAreaCode", m_szStHpnAreaCode, &m_bStHpnAreaCode);
                AddXMLField(pSess, "HomePhone", m_szHomePhone, &m_bHomePhone);
                AddXMLField(pSess, "StOpnAreaCode", m_szStOpnAreaCode, &m_bStOpnAreaCode);
                AddXMLField(pSess, "OfficePhone", m_szOfficePhone, &m_bOfficePhone);
                AddXMLField(pSess, "TinCode", m_szTinCode, &m_bTinCode);
                AddXMLField(pSess, "StTinNumber", m_szStTinNumber, &m_bStTinNumber);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 4; lOccurs++)
                {
                    CWmsNaLine[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "STTRNAME");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "STTRNAME", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "GenrCsCode", m_szGenrCsCode);
                ...
                GetXMLField(pSess, "StNaTrlrSpecInstr", m_szStNaTrlrSpecInstr);
                GetXMLField(pSess, "SpecialInstructions", m_szSpecialInstructions);
                GetXMLField(pSess, "StShortName", m_szStShortName);
                GetXMLField(pSess, "TinName", m_szTinName);
                GetXMLField(pSess, "GenrPrp", m_szGenrPrp);
                GetXMLField(pSess, "GenrOfficerInit", m_szGenrOfficerInit);
                GetXMLField(pSess, "GenrCustGen", m_szGenrCustGen);
                GetXMLField(pSess, "StHpnAreaCode", m_szStHpnAreaCode);
                GetXMLField(pSess, "HomePhone", m_szHomePhone);
                GetXMLField(pSess, "StOpnAreaCode", m_szStOpnAreaCode);
                GetXMLField(pSess, "OfficePhone", m_szOfficePhone);
                GetXMLField(pSess, "TinCode", m_szTinCode);
                GetXMLField(pSess, "StTinNumber", m_szStTinNumber);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 4; lOccurs++)
                {
                    CWmsNaLine[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "STTRNAME");
            };
        }
        ...
        class AsdWmsNaLine
        {
          ...
          public:
            ...
            AsdWmsNaLine ()  // Constructor
            {
                ...
                m_bStNaTrlrSeq = false;
                strcpy(m_szStNaTrlrSeq, "");
            ...
            long lStNaTrlrSeq () { return 1; };
            RWCString StNaTrlrSeq (void)
            {
                return m_szStNaTrlrSeq;
            }
            long StNaTrlrSeq (const RWCString& rwc)
            {
                return SetString(rwc, m_szStNaTrlrSeq, sizeof(m_szStNaTrlrSeq), &m_bStNaTrlrSeq);
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    ...
                    AddXMLField(pSess, "StNaTrlrSeq", m_szStNaTrlrSeq, &m_bStNaTrlrSeq);
            ...
            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "WmsNaLine", m_lIndex, &m_bReceived))
                {
                    ...
                    GetXMLField(pSess, "StNaTrlrSeq", m_szStNaTrlrSeq);
    ...
    AsdSTTRNAME CSTTRNAME;
    AsdSTTRNAME *STTRNAME;
    
    //**************** End AsdSTTRNAME Definition ****************
...
//**************** End AsdSTPC21P1Data Definition ****************

typedef AsdSTPC21P1Data *LPSTPC21P1;
typedef AsdSTPC21P1Data::AsdTSHeader *LPSTPC21P1_TSHeader;
typedef AsdSTPC21P1Data::AsdSDSTCMMI *LPSTPC21P1_SDSTCMMI;
typedef AsdSTPC21P1Data::AsdSTTRNAME *LPSTPC21P1_STTRNAME;
typedef AsdSTPC21P1Data::AsdSTTRNAME::AsdWmsNaLine *LPSTPC21P1_STTRNAME_WmsNaLine;
typedef AsdSTPC21P1Data::AsdTSMDA *LPSTPC21P1_TSMDA;
typedef AsdSTPC21P1Data::AsdTSMDA::AsdMdaTrmMsg *LPSTPC21P1_TSMDA_MdaTrmMsg;
typedef AsdSTPC21P1Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSTPC21P1_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSTPC21P1Data_H
