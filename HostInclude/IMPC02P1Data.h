#ifndef AsdIMPC02P1Data_H
#define AsdIMPC02P1Data_H

#include <stdlib.h>
#ifdef  AsdIMPC02P1_INTEGRITY_STRING
#undef  AsdIMPC02P1_INTEGRITY_STRING
#endif
#define AsdIMPC02P1_INTEGRITY_STRING        ""

#ifdef  AsdIMPC02P1_CRC_STRING
#undef  AsdIMPC02P1_CRC_STRING
#endif
#define AsdIMPC02P1_CRC_STRING "851520719"
...
//**************** Start AsdIMPC02P1Data Definition ****************
//                 IM N/A Maintenance

//                 IMPC02P1Data.h generated by AceGen2 ver. 2.5.09

class AsdIMPC02P1Data
{
  public:
  ...
  public:
    AsdIMPC02P1Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "IMPC02P1.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdIMPC02P1_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdIMPC02P1_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "IMPC02P1", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CIMCMSD00.Load(&m_Sess);
                        CIMTRNAME.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "IMPC02P1");
                    }
    ...
    //**************** Start AsdIMTRNAME Definition ****************
    //                 IM APPC NAME/ADDR MAINT DAG                                 
    ...
    class AsdIMTRNAME
    {
      private:
        ...
        bool      m_bReceived;
        char      m_szSuppressBuff[100];
        bool      m_bWmsNaStartDate1;
        char      m_szWmsNaStartDate1[6+1];
        bool      m_bWmsNaStopDate1;
        char      m_szWmsNaStopDate1[6+1];
        bool      m_bWmsNaNbrStmts1;
        char      m_szWmsNaNbrStmts1[3+1];
        bool      m_bWmsNaUseCode1;
        char      m_szWmsNaUseCode1[1+1];
        bool      m_bWmsNaSsnCode1;
        char      m_szWmsNaSsnCode1[1+1];
        bool      m_bWmsNaSsnPre1;
        char      m_szWmsNaSsnPre1[1+1];
        bool      m_bWmsNaSsnNo1;
        char      m_szWmsNaSsnNo1[9+1];
        bool      m_bWmsNaSsnSuf1;
        char      m_szWmsNaSsnSuf1[1+1];
        bool      m_bWmsNaPartPct1;
        char      m_szWmsNaPartPct1[3+1];
        bool      m_bWmsNaUser1;
        char      m_szWmsNaUser1[1+1];
        bool      m_bWmsCityState;
        char      m_szWmsCityState[30+1];
        bool      m_bWmsNaZipCode;
        char      m_szWmsNaZipCode[10+1];
        bool      m_bNaForeignAddrInd;
        char      m_szNaForeignAddrInd[1+1];
        ...
        bool      m_bCustReq;
        char      m_szCustReq[1+1];
    
      public:
        long      m_lIndex;

        AsdIMTRNAME ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            m_lIndex = -1;
            m_bWmsNaStartDate1 = false;
            strcpy(m_szWmsNaStartDate1, "");
            m_bWmsNaStopDate1 = false;
            strcpy(m_szWmsNaStopDate1, "");
            m_bWmsNaNbrStmts1 = false;
            strcpy(m_szWmsNaNbrStmts1, "");
            m_bWmsNaUseCode1 = false;
            strcpy(m_szWmsNaUseCode1, "");
            m_bWmsNaSsnCode1 = false;
            strcpy(m_szWmsNaSsnCode1, "");
            m_bWmsNaSsnPre1 = false;
            strcpy(m_szWmsNaSsnPre1, "");
            m_bWmsNaSsnNo1 = false;
            strcpy(m_szWmsNaSsnNo1, "");
            m_bWmsNaSsnSuf1 = false;
            strcpy(m_szWmsNaSsnSuf1, "");
            m_bWmsNaPartPct1 = false;
            strcpy(m_szWmsNaPartPct1, "");
            m_bWmsNaUser1 = false;
            strcpy(m_szWmsNaUser1, "");
            m_bWmsCityState = false;
            strcpy(m_szWmsCityState, "");
            m_bWmsNaZipCode = false;
            strcpy(m_szWmsNaZipCode, "");
            m_bNaForeignAddrInd = false;
            strcpy(m_szNaForeignAddrInd, "");
        ...
        //    WMS-NA-START-DATE-1
        long lWmsNaStartDate1 () { return 6; };
        RWCString WmsNaStartDate1 (void)
        {
            return m_szWmsNaStartDate1;
        }
        long WmsNaStartDate1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaStartDate1, sizeof(m_szWmsNaStartDate1), &m_bWmsNaStartDate1);
        }
        
        //    WMS-NA-STOP-DATE-1
        long lWmsNaStopDate1 () { return 6; };
        RWCString WmsNaStopDate1 (void)
        {
            return m_szWmsNaStopDate1;
        }
        long WmsNaStopDate1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaStopDate1, sizeof(m_szWmsNaStopDate1), &m_bWmsNaStopDate1);
        }
        
        //    NUMBER OF STATEMENTS TO BE PRINTED
        long lWmsNaNbrStmts1 () { return 3; };
        RWCString WmsNaNbrStmts1 (void)
        {
            return m_szWmsNaNbrStmts1;
        }
        long WmsNaNbrStmts1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaNbrStmts1, sizeof(m_szWmsNaNbrStmts1), &m_bWmsNaNbrStmts1);
        }
        
        //    CODE DENOTING USE OF NAME/ADDRESS TRAILER
        long lWmsNaUseCode1 () { return 1; };
        RWCString WmsNaUseCode1 (void)
        {
            return m_szWmsNaUseCode1;
        }
        long WmsNaUseCode1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaUseCode1, sizeof(m_szWmsNaUseCode1), &m_bWmsNaUseCode1);
        }
        
        //    TAX NUMBER CODE
        long lWmsNaSsnCode1 () { return 1; };
        RWCString WmsNaSsnCode1 (void)
        {
            return m_szWmsNaSsnCode1;
        }
        long WmsNaSsnCode1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaSsnCode1, sizeof(m_szWmsNaSsnCode1), &m_bWmsNaSsnCode1);
        }
        
        //    SOCIAL SECURITY PREFIX
        long lWmsNaSsnPre1 () { return 1; };
        RWCString WmsNaSsnPre1 (void)
        {
            return m_szWmsNaSsnPre1;
        }
        long WmsNaSsnPre1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaSsnPre1, sizeof(m_szWmsNaSsnPre1), &m_bWmsNaSsnPre1);
        }
        
        //    SOCIAL SECURITY NUMBER
        long lWmsNaSsnNo1 () { return 9; };
        RWCString WmsNaSsnNo1 (void)
        {
            return m_szWmsNaSsnNo1;
        }
        long WmsNaSsnNo1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaSsnNo1, sizeof(m_szWmsNaSsnNo1), &m_bWmsNaSsnNo1);
        }
        
        //    SOCIAL SECURITY SUFFIX
        long lWmsNaSsnSuf1 () { return 1; };
        RWCString WmsNaSsnSuf1 (void)
        {
            return m_szWmsNaSsnSuf1;
        }
        long WmsNaSsnSuf1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaSsnSuf1, sizeof(m_szWmsNaSsnSuf1), &m_bWmsNaSsnSuf1);
        }
        
        //    PARTNERSHIP PERCENTAGE
        long lWmsNaPartPct1 () { return 3; };
        RWCString WmsNaPartPct1 (void)
        {
            return m_szWmsNaPartPct1;
        }
        long WmsNaPartPct1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaPartPct1, sizeof(m_szWmsNaPartPct1), &m_bWmsNaPartPct1);
        }
        
        //    USER DEFINED CODE
        long lWmsNaUser1 () { return 1; };
        RWCString WmsNaUser1 (void)
        {
            return m_szWmsNaUser1;
        }
        long WmsNaUser1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szWmsNaUser1, sizeof(m_szWmsNaUser1), &m_bWmsNaUser1);
        }
        ...
        //    FOREIGN ADDR IND
        long lNaForeignAddrInd () { return 1; };
        RWCString NaForeignAddrInd (void)
        {
            return m_szNaForeignAddrInd;
        }
        long NaForeignAddrInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szNaForeignAddrInd, sizeof(m_szNaForeignAddrInd), &m_bNaForeignAddrInd);
        }
        ...
        //    CUSTOMERS BUSINESS PHONE NUMBER
        ...
        long lCustReq () { return 1; };
        RWCString CustReq (void)
        {
            return m_szCustReq;
        }
        long CustReq (const RWCString& rwc)
        {
            return SetString(rwc, m_szCustReq, sizeof(m_szCustReq), &m_bCustReq);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bWmsNaStartDate1) return true;
            if (m_bWmsNaStopDate1) return true;
            if (m_bWmsNaNbrStmts1) return true;
            if (m_bWmsNaUseCode1) return true;
            if (m_bWmsNaSsnCode1) return true;
            if (m_bWmsNaSsnPre1) return true;
            if (m_bWmsNaSsnNo1) return true;
            if (m_bWmsNaSsnSuf1) return true;
            if (m_bWmsNaPartPct1) return true;
            if (m_bWmsNaUser1) return true;
            if (m_bWmsCityState) return true;
            if (m_bWmsNaZipCode) return true;
            if (m_bNaForeignAddrInd) return true;
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "IMTRNAME", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "WmsNaStartDate1", m_szWmsNaStartDate1, &m_bWmsNaStartDate1);
                AddXMLField(pSess, "WmsNaStopDate1", m_szWmsNaStopDate1, &m_bWmsNaStopDate1);
                AddXMLField(pSess, "WmsNaNbrStmts1", m_szWmsNaNbrStmts1, &m_bWmsNaNbrStmts1);
                AddXMLField(pSess, "WmsNaUseCode1", m_szWmsNaUseCode1, &m_bWmsNaUseCode1);
                AddXMLField(pSess, "WmsNaSsnCode1", m_szWmsNaSsnCode1, &m_bWmsNaSsnCode1);
                AddXMLField(pSess, "WmsNaSsnPre1", m_szWmsNaSsnPre1, &m_bWmsNaSsnPre1);
                AddXMLField(pSess, "WmsNaSsnNo1", m_szWmsNaSsnNo1, &m_bWmsNaSsnNo1);
                AddXMLField(pSess, "WmsNaSsnSuf1", m_szWmsNaSsnSuf1, &m_bWmsNaSsnSuf1);
                AddXMLField(pSess, "WmsNaPartPct1", m_szWmsNaPartPct1, &m_bWmsNaPartPct1);
                AddXMLField(pSess, "WmsNaUser1", m_szWmsNaUser1, &m_bWmsNaUser1);
                ...
                AddXMLField(pSess, "NaForeignAddrInd", m_szNaForeignAddrInd, &m_bNaForeignAddrInd);
                ...
                AddXMLField(pSess, "CustReq", m_szCustReq, &m_bCustReq);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 4; lOccurs++)
                {
                    CWmsNaLine[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "IMTRNAME");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "IMTRNAME", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "WmsNaStartDate1", m_szWmsNaStartDate1);
                GetXMLField(pSess, "WmsNaStopDate1", m_szWmsNaStopDate1);
                GetXMLField(pSess, "WmsNaNbrStmts1", m_szWmsNaNbrStmts1);
                GetXMLField(pSess, "WmsNaUseCode1", m_szWmsNaUseCode1);
                GetXMLField(pSess, "WmsNaSsnCode1", m_szWmsNaSsnCode1);
                GetXMLField(pSess, "WmsNaSsnPre1", m_szWmsNaSsnPre1);
                GetXMLField(pSess, "WmsNaSsnNo1", m_szWmsNaSsnNo1);
                GetXMLField(pSess, "WmsNaSsnSuf1", m_szWmsNaSsnSuf1);
                GetXMLField(pSess, "WmsNaPartPct1", m_szWmsNaPartPct1);
                GetXMLField(pSess, "WmsNaUser1", m_szWmsNaUser1);
                GetXMLField(pSess, "WmsCityState", m_szWmsCityState);
                GetXMLField(pSess, "WmsNaZipCode", m_szWmsNaZipCode);
                GetXMLField(pSess, "NaForeignAddrInd", m_szNaForeignAddrInd);
                ...
                GetXMLField(pSess, "CustReq", m_szCustReq);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 4; lOccurs++)
                {
                    CWmsNaLine[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "IMTRNAME");
            };
        }
        ...
        AsdWmsNaLine  CWmsNaLine[4];
        AsdWmsNaLine *WmsNaLine[4];
        
        //**************** End AsdWmsNaLine Definition ****************
        
    };

    AsdIMTRNAME CIMTRNAME;
    AsdIMTRNAME *IMTRNAME;
    
    //**************** End AsdIMTRNAME Definition ****************
...
//**************** End AsdIMPC02P1Data Definition ****************

typedef AsdIMPC02P1Data *LPIMPC02P1;
typedef AsdIMPC02P1Data::AsdTSHeader *LPIMPC02P1_TSHeader;
typedef AsdIMPC02P1Data::AsdIMCMSD00 *LPIMPC02P1_IMCMSD00;
typedef AsdIMPC02P1Data::AsdIMTRNAME *LPIMPC02P1_IMTRNAME;
typedef AsdIMPC02P1Data::AsdIMTRNAME::AsdWmsNaLine *LPIMPC02P1_IMTRNAME_WmsNaLine;
typedef AsdIMPC02P1Data::AsdTSMDA *LPIMPC02P1_TSMDA;
typedef AsdIMPC02P1Data::AsdTSMDA::AsdMdaTrmMsg *LPIMPC02P1_TSMDA_MdaTrmMsg;
typedef AsdIMPC02P1Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPIMPC02P1_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdIMPC02P1Data_H
