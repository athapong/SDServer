#ifndef AsdSDPCAM95Data_H
#define AsdSDPCAM95Data_H

#include <stdlib.h>
#ifdef  AsdSDPCAM95_INTEGRITY_STRING
#undef  AsdSDPCAM95_INTEGRITY_STRING
#endif
#define AsdSDPCAM95_INTEGRITY_STRING        ""

#ifdef  AsdSDPCAM95_CRC_STRING
#undef  AsdSDPCAM95_CRC_STRING
#endif
#define AsdSDPCAM95_CRC_STRING "196663102"
...
//**************** Start AsdSDPCAM95Data Definition ****************
//                 Account Status

//                 SDPCAM95Data.h generated by AceGen2 ver. 2.5.09

class AsdSDPCAM95Data
{
  public:
  ...
  public:
    AsdSDPCAM95Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCAM95.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCAM95_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCAM95_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDPCAM95_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDAM95II.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCAM95", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDAM95II.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCAM95");
                    }
    ...
    class AsdSDAM95II
    {
      private:
        ...
        bool      m_bTrNewStat;
        char      m_szTrNewStat[2+1];
    
      public:
        long      m_lIndex;

        AsdSDAM95II ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
        ...
        //    NEW ACCOUNT STATUS
        long lTrNewStat () { return 2; };
        RWCString TrNewStat (void)
        {
            return m_szTrNewStat;
        }
        long TrNewStat (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrNewStat, sizeof(m_szTrNewStat), &m_bTrNewStat);
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDAM95II", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLField(pSess, "TrNewStat", m_szTrNewStat, &m_bTrNewStat);
                AddXMLCloseRecord(pSess, "SDAM95II");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDAM95II", m_lIndex, &m_bReceived))
            {
                ...
                GetXMLField(pSess, "TrNewStat", m_szTrNewStat);
                CloseXMLRecord(pSess, "SDAM95II");
            };
        }
    };

    AsdSDAM95II CSDAM95II;
    AsdSDAM95II *SDAM95II;
    
    //**************** End AsdSDAM95II Definition ****************
...
//**************** End AsdSDPCAM95Data Definition ****************

typedef AsdSDPCAM95Data *LPSDPCAM95;
typedef AsdSDPCAM95Data::AsdTSHeader *LPSDPCAM95_TSHeader;
typedef AsdSDPCAM95Data::AsdSDAM95II *LPSDPCAM95_SDAM95II;
typedef AsdSDPCAM95Data::AsdTSMDA *LPSDPCAM95_TSMDA;
typedef AsdSDPCAM95Data::AsdTSMDA::AsdMdaTrmMsg *LPSDPCAM95_TSMDA_MdaTrmMsg;
typedef AsdSDPCAM95Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCAM95_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCAM95Data_H
