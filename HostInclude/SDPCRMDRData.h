#ifndef AsdSDPCRMDRData_H
#define AsdSDPCRMDRData_H

#include <stdlib.h>
#ifdef  AsdSDPCRMDR_INTEGRITY_STRING
#undef  AsdSDPCRMDR_INTEGRITY_STRING
#endif
#define AsdSDPCRMDR_INTEGRITY_STRING        ""

#ifdef  AsdSDPCRMDR_CRC_STRING
#undef  AsdSDPCRMDR_CRC_STRING
#endif
#define AsdSDPCRMDR_CRC_STRING "3099816689"
...
//**************** Start AsdSDPCRMDRData Definition ****************
//                 SD RM NICKNAME (IBMSG) MAINT

//                 SDPCRMDRData.h generated by AceGen2 ver. 2.5.09

class AsdSDPCRMDRData
{
  public:
  ...
  public:
    AsdSDPCRMDRData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCRMDR.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCRMDR_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCRMDR_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDPCRMDR_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDRMUCMI.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCRMDR", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDRMUCMI.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCRMDR");
                    }
    ...
    //**************** Start AsdSDRMUCMI Definition ****************
    //                 SD RM NICKNAME (IBMSG) MAINT                                
    
    //    SDRMUCMI.map
    //    generated by Dsm2Ace ver. 2.3.03
    //    on 06/26/02 14:16:41
    class AsdSDRMUCMI
    {
      private:
        bool      m_bHostInitOverride;
      ...
      public:
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDRMUCMI", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLCloseRecord(pSess, "SDRMUCMI");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDRMUCMI", m_lIndex, &m_bReceived))
            {
                ...
                CloseXMLRecord(pSess, "SDRMUCMI");
            };
        }
    };

    AsdSDRMUCMI CSDRMUCMI;
    AsdSDRMUCMI *SDRMUCMI;
    
    //**************** End AsdSDRMUCMI Definition ****************
...
//**************** End AsdSDPCRMDRData Definition ****************

typedef AsdSDPCRMDRData *LPSDPCRMDR;
typedef AsdSDPCRMDRData::AsdTSHeader *LPSDPCRMDR_TSHeader;
typedef AsdSDPCRMDRData::AsdSDRMUCMI *LPSDPCRMDR_SDRMUCMI;
typedef AsdSDPCRMDRData::AsdTSMDA *LPSDPCRMDR_TSMDA;
typedef AsdSDPCRMDRData::AsdTSMDA::AsdMdaTrmMsg *LPSDPCRMDR_TSMDA_MdaTrmMsg;
typedef AsdSDPCRMDRData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCRMDR_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCRMDRData_H
