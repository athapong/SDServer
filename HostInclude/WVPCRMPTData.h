#ifndef AsdWVPCRMPTData_H
#define AsdWVPCRMPTData_H

#include <stdlib.h>
#ifdef  AsdWVPCRMPT_INTEGRITY_STRING
#undef  AsdWVPCRMPT_INTEGRITY_STRING
#endif
#define AsdWVPCRMPT_INTEGRITY_STRING        ""

#ifdef  AsdWVPCRMPT_CRC_STRING
#undef  AsdWVPCRMPT_CRC_STRING
#endif
#define AsdWVPCRMPT_CRC_STRING "2086510072"
...
//**************** Start AsdWVPCRMPTData Definition ****************
//                 RM Customer Post Prospect

//                 WVPCRMPTData.h generated by AceGen2 ver. 2.5.09

class AsdWVPCRMPTData
{
  public:
  ...
  public:
    AsdWVPCRMPTData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "WVPCRMPT.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdWVPCRMPT_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdWVPCRMPT_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdWVPCRMPT_CRC_STRING, NULL);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "WVPCRMPT", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CWVRMPTA.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "WVPCRMPT");
                    }
...
//**************** End AsdWVPCRMPTData Definition ****************

typedef AsdWVPCRMPTData *LPWVPCRMPT;
typedef AsdWVPCRMPTData::AsdTSHeader *LPWVPCRMPT_TSHeader;
typedef AsdWVPCRMPTData::AsdWVRMPTA *LPWVPCRMPT_WVRMPTA;
typedef AsdWVPCRMPTData::AsdWVRMPTA::AsdPhInfo *LPWVPCRMPT_WVRMPTA_PhInfo;
typedef AsdWVPCRMPTData::AsdWVRMPTA::AsdOldPhInfo *LPWVPCRMPT_WVRMPTA_OldPhInfo;
typedef AsdWVPCRMPTData::AsdTSMDA *LPWVPCRMPT_TSMDA;
typedef AsdWVPCRMPTData::AsdTSMDA::AsdMdaTrmMsg *LPWVPCRMPT_TSMDA_MdaTrmMsg;
typedef AsdWVPCRMPTData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPWVPCRMPT_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdWVPCRMPTData_H
