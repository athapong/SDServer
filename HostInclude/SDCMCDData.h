#ifndef AsdSDCMCDData_H
#define AsdSDCMCDData_H

#include <stdlib.h>
#ifdef  AsdSDCMCD_INTEGRITY_STRING
#undef  AsdSDCMCD_INTEGRITY_STRING
#endif
#define AsdSDCMCD_INTEGRITY_STRING        ""

#ifdef  AsdSDCMCD_CRC_STRING
#undef  AsdSDCMCD_CRC_STRING
#endif
#define AsdSDCMCD_CRC_STRING "1413771245"
...
//**************** Start AsdSDCMCDData Definition ****************
//                 ST Combined Account Inquiry

//                 SDCMCDData.h generated by AceGen2 ver. 2.5.09
...
class AsdSDCMCDData
{
  ...
  public:
    AsdSDCMCDData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDCMCD.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDCMCD_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDCMCD_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDCMCD_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDSTCMCD.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDCMCD", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDSTCMCD.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDCMCD");
                    }
    ...
    //**************** Start AsdSDSTCMCD Definition ****************
    //                 COMBINED CD DEPOSITS ENQUIRY DETAILS                        
    
    //    SDSTCMCD.map
    //    generated by Dsm2Ace ver. 3.0.04
    //    on 10/28/02 11:52:05
    class AsdSDSTCMCD
    {
      private:
        bool      m_bHostInitOverride;
        ...
        char      m_szCntl4[3+1];
        bool      m_bCdNumber;
        char      m_szCdNumber[11+1];
        bool      m_bTotalAmount;
        char      m_szTotalAmount[17+1];
        bool      m_bSentRecCount;
        char      m_szSentRecCount[2+1];
        bool      m_bErrorMessage;
        char      m_szErrorMessage[30+1];
        bool      m_bUserCharFld;
        char      m_szUserCharFld[30+1];
    
      public:
        long      m_lIndex;

        AsdSDSTCMCD ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            ...
            m_bCdNumber = false;
            strcpy(m_szCdNumber, "");
            m_bTotalAmount = false;
            strcpy(m_szTotalAmount, "+0000000000000.00");
            m_bSentRecCount = false;
            strcpy(m_szSentRecCount, "");
            m_bErrorMessage = false;
            strcpy(m_szErrorMessage, "");
            m_bUserCharFld = false;
            strcpy(m_szUserCharFld, "");
            long lOccurs;
        
            for (lOccurs = 0; lOccurs < 50; lOccurs++)
            {
                OccursData[lOccurs]  = &COccursData[lOccurs];
                COccursData[lOccurs].m_lIndex = lOccurs;
            }
        }
        ...
        //    CONTROL 1
        long lCntl1 () { return 2; };
        RWCString Cntl1 (void)
        {
            return m_szCntl1;
        }
        long Cntl1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCntl1, sizeof(m_szCntl1), &m_bCntl1);
        }
        
        //    CONTROL 2
        long lCntl2 () { return 3; };
        RWCString Cntl2 (void)
        {
            return m_szCntl2;
        }
        long Cntl2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCntl2, sizeof(m_szCntl2), &m_bCntl2);
        }
        
        //    CONTROL 3
        long lCntl3 () { return 3; };
        RWCString Cntl3 (void)
        {
            return m_szCntl3;
        }
        long Cntl3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCntl3, sizeof(m_szCntl3), &m_bCntl3);
        }
        
        //    CONTROL 4
        long lCntl4 () { return 3; };
        RWCString Cntl4 (void)
        {
            return m_szCntl4;
        }
        long Cntl4 (const RWCString& rwc)
        {
            return SetString(rwc, m_szCntl4, sizeof(m_szCntl4), &m_bCntl4);
        }
        
        //    CD NUMBER
        long lCdNumber () { return 11; };
        RWCString CdNumber (void)
        {
            return m_szCdNumber;
        }
        long CdNumber (const RWCString& rwc)
        {
            return SetString(rwc, m_szCdNumber, sizeof(m_szCdNumber), &m_bCdNumber);
        }
        
        //    CD TOTAL AMOUNT
        long lTotalAmount () { return 17; };
        RWCString TotalAmount (void)
        {
            return AceZeroSupp(m_szTotalAmount, &m_szSuppressBuff[0]);
        }
        RWCString TotalAmountRaw (void)
        {
            return m_szTotalAmount;
        }
        long TotalAmount (const RWCString& rwc)
        {
            return SetString(rwc, m_szTotalAmount, sizeof(m_szTotalAmount), &m_bTotalAmount);
        }
        
        //    RECORDS BEING SENT
        long lSentRecCount () { return 2; };
        RWCString SentRecCount (void)
        {
            return m_szSentRecCount;
        }
        long SentRecCount (const RWCString& rwc)
        {
            return SetString(rwc, m_szSentRecCount, sizeof(m_szSentRecCount), &m_bSentRecCount);
        }
        
        //    ERROR MESSAGE
        long lErrorMessage () { return 30; };
        RWCString ErrorMessage (void)
        {
            return m_szErrorMessage;
        }
        long ErrorMessage (const RWCString& rwc)
        {
            return SetString(rwc, m_szErrorMessage, sizeof(m_szErrorMessage), &m_bErrorMessage);
        }
        
        //    FOR FUTURE USE
        long lUserCharFld () { return 30; };
        RWCString UserCharFld (void)
        {
            return m_szUserCharFld;
        }
        long UserCharFld (const RWCString& rwc)
        {
            return SetString(rwc, m_szUserCharFld, sizeof(m_szUserCharFld), &m_bUserCharFld);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bCntl1) return true;
            if (m_bCntl2) return true;
            if (m_bCntl3) return true;
            if (m_bCntl4) return true;
            if (m_bCdNumber) return true;
            if (m_bTotalAmount) return true;
            if (m_bSentRecCount) return true;
            if (m_bErrorMessage) return true;
            if (m_bUserCharFld) return true;
            long lOccurs;
            for (lOccurs = 0; lOccurs < 50; lOccurs++)
            {
                if(COccursData[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDSTCMCD", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "Cntl1", m_szCntl1, &m_bCntl1);
                AddXMLField(pSess, "Cntl2", m_szCntl2, &m_bCntl2);
                AddXMLField(pSess, "Cntl3", m_szCntl3, &m_bCntl3);
                AddXMLField(pSess, "Cntl4", m_szCntl4, &m_bCntl4);
                AddXMLField(pSess, "CdNumber", m_szCdNumber, &m_bCdNumber);
                AddXMLField(pSess, "TotalAmount", m_szTotalAmount, &m_bTotalAmount);
                AddXMLField(pSess, "SentRecCount", m_szSentRecCount, &m_bSentRecCount);
                AddXMLField(pSess, "ErrorMessage", m_szErrorMessage, &m_bErrorMessage);
                AddXMLField(pSess, "UserCharFld", m_szUserCharFld, &m_bUserCharFld);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 50; lOccurs++)
                {
                    COccursData[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "SDSTCMCD");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDSTCMCD", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "Cntl1", m_szCntl1);
                GetXMLField(pSess, "Cntl2", m_szCntl2);
                GetXMLField(pSess, "Cntl3", m_szCntl3);
                GetXMLField(pSess, "Cntl4", m_szCntl4);
                GetXMLField(pSess, "CdNumber", m_szCdNumber);
                GetXMLField(pSess, "TotalAmount", m_szTotalAmount);
                GetXMLField(pSess, "SentRecCount", m_szSentRecCount);
                GetXMLField(pSess, "ErrorMessage", m_szErrorMessage);
                GetXMLField(pSess, "UserCharFld", m_szUserCharFld);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 50; lOccurs++)
                {
                    COccursData[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "SDSTCMCD");
            };
        }
        
        //**************** Start AsdOccursData Definition ****************
        //                 OCCURS DATA
        ...
        class AsdOccursData
        {
          private:
            bool      m_bReceived;
            char      m_szSuppressBuff[100];
            bool      m_bDepositNumber;
            char      m_szDepositNumber[3+1];
            bool      m_bDepositDate;
            char      m_szDepositDate[8+1];
            bool      m_bBalance;
            char      m_szBalance[17+1];
            bool      m_bTermType;
            char      m_szTermType[1+1];
            bool      m_bTermQuantity;
            char      m_szTermQuantity[6+1];
            bool      m_bIntRate;
            char      m_szIntRate[11+1];
        
          public:
            long      m_lIndex;

            AsdOccursData ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bDepositNumber = false;
                strcpy(m_szDepositNumber, "");
                m_bDepositDate = false;
                strcpy(m_szDepositDate, "");
                m_bBalance = false;
                strcpy(m_szBalance, "+0000000000000.00");
                m_bTermType = false;
                strcpy(m_szTermType, "");
                m_bTermQuantity = false;
                strcpy(m_szTermQuantity, "+00000");
                m_bIntRate = false;
                strcpy(m_szIntRate, "+000.000000");
            ...
            //    CD DEPOSIT NUMBER
            long lDepositNumber () { return 3; };
            RWCString DepositNumber (void)
            {
                return m_szDepositNumber;
            }
            long DepositNumber (const RWCString& rwc)
            {
                return SetString(rwc, m_szDepositNumber, sizeof(m_szDepositNumber), &m_bDepositNumber);
            }
            
            //    CD DEPOSIT DATE
            long lDepositDate () { return 8; };
            RWCString DepositDate (void)
            {
                return m_szDepositDate;
            }
            long DepositDate (const RWCString& rwc)
            {
                return SetString(rwc, m_szDepositDate, sizeof(m_szDepositDate), &m_bDepositDate);
            }
            
            //    CD BALANCE
            long lBalance () { return 17; };
            RWCString Balance (void)
            {
                return AceZeroSupp(m_szBalance, &m_szSuppressBuff[0]);
            }
            RWCString BalanceRaw (void)
            {
                return m_szBalance;
            }
            long Balance (const RWCString& rwc)
            {
                return SetString(rwc, m_szBalance, sizeof(m_szBalance), &m_bBalance);
            }
            
            //    TERM TYPE
            long lTermType () { return 1; };
            RWCString TermType (void)
            {
                return m_szTermType;
            }
            long TermType (const RWCString& rwc)
            {
                return SetString(rwc, m_szTermType, sizeof(m_szTermType), &m_bTermType);
            }
            
            //    TERM QUANTITY
            long lTermQuantity () { return 6; };
            RWCString TermQuantity (void)
            {
                return AceZeroSupp(m_szTermQuantity, &m_szSuppressBuff[0]);
            }
            RWCString TermQuantityRaw (void)
            {
                return m_szTermQuantity;
            }
            long TermQuantity (const RWCString& rwc)
            {
                return SetString(rwc, m_szTermQuantity, sizeof(m_szTermQuantity), &m_bTermQuantity);
            }
            
            //    INTEREST RATE
            long lIntRate () { return 11; };
            RWCString IntRate (void)
            {
                return AceZeroSupp(m_szIntRate, &m_szSuppressBuff[0]);
            }
            RWCString IntRateRaw (void)
            {
                return m_szIntRate;
            }
            long IntRate (const RWCString& rwc)
            {
                return SetString(rwc, m_szIntRate, sizeof(m_szIntRate), &m_bIntRate);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bDepositNumber) return true;
                if (m_bDepositDate) return true;
                if (m_bBalance) return true;
                if (m_bTermType) return true;
                if (m_bTermQuantity) return true;
                if (m_bIntRate) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "OccursData", m_lIndex);
                    AddXMLField(pSess, "DepositNumber", m_szDepositNumber, &m_bDepositNumber);
                    AddXMLField(pSess, "DepositDate", m_szDepositDate, &m_bDepositDate);
                    AddXMLField(pSess, "Balance", m_szBalance, &m_bBalance);
                    AddXMLField(pSess, "TermType", m_szTermType, &m_bTermType);
                    AddXMLField(pSess, "TermQuantity", m_szTermQuantity, &m_bTermQuantity);
                    AddXMLField(pSess, "IntRate", m_szIntRate, &m_bIntRate);
                    AddXMLCloseRecord(pSess, "OccursData");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "OccursData", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "DepositNumber", m_szDepositNumber);
                    GetXMLField(pSess, "DepositDate", m_szDepositDate);
                    GetXMLField(pSess, "Balance", m_szBalance);
                    GetXMLField(pSess, "TermType", m_szTermType);
                    GetXMLField(pSess, "TermQuantity", m_szTermQuantity);
                    GetXMLField(pSess, "IntRate", m_szIntRate);
                    CloseXMLRecord(pSess, "OccursData");
                };
            }
        };

        AsdOccursData  COccursData[50];
        AsdOccursData *OccursData[50];
        
        //**************** End AsdOccursData Definition ****************
        
    };

    AsdSDSTCMCD CSDSTCMCD;
    AsdSDSTCMCD *SDSTCMCD;
    
    //**************** End AsdSDSTCMCD Definition ****************
...
//**************** End AsdSDCMCDData Definition ****************

typedef AsdSDCMCDData *LPSDCMCD;
typedef AsdSDCMCDData::AsdTSHeader *LPSDCMCD_TSHeader;
typedef AsdSDCMCDData::AsdSDSTCMCD *LPSDCMCD_SDSTCMCD;
typedef AsdSDCMCDData::AsdSDSTCMCD::AsdOccursData *LPSDCMCD_SDSTCMCD_OccursData;
typedef AsdSDCMCDData::AsdTSMDA *LPSDCMCD_TSMDA;
typedef AsdSDCMCDData::AsdTSMDA::AsdMdaTrmMsg *LPSDCMCD_TSMDA_MdaTrmMsg;
typedef AsdSDCMCDData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDCMCD_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDCMCDData_H
