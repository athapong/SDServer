#ifndef AsdTSST8001Data_H
#define AsdTSST8001Data_H

#include <stdlib.h>
#ifdef  AsdTSST8001_INTEGRITY_STRING
#undef  AsdTSST8001_INTEGRITY_STRING
#endif
#define AsdTSST8001_INTEGRITY_STRING        ""

#ifdef  AsdTSST8001_CRC_STRING
#undef  AsdTSST8001_CRC_STRING
#endif
#define AsdTSST8001_CRC_STRING "2365585834"
...
//**************** Start AsdTSST8001Data Definition ****************
//                 ST Monetary

//                 TSST8001Data.h generated by AceGen2 ver. 2.5.09

class AsdTSST8001Data
{
  public:
  ...
  public:
    AsdTSST8001Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "TSST8001.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdTSST8001_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdTSST8001_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "TSST8001", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDSTCMMI.Load(&m_Sess);
                        CSTTRMONY.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "TSST8001");
                    }
    ...
    class AsdSTTRMONY
    {
      ...
      public:
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "STTRMONY", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLCloseRecord(pSess, "STTRMONY");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "STTRMONY", m_lIndex, &m_bReceived))
            {
        ...
        class AsdExtAmtInfo
        {
          private:
            ...
            char      m_szSuppressBuff[100];
            bool      m_bExtAmtLit;
            char      m_szExtAmtLit[11+1];
            bool      m_bExtAmt;
            char      m_szExtAmt[13+1];
    ...
    AsdSTTRMONY CSTTRMONY;
    AsdSTTRMONY *STTRMONY;
    
    //**************** End AsdSTTRMONY Definition ****************
...
//**************** End AsdTSST8001Data Definition ****************

typedef AsdTSST8001Data *LPTSST8001;
typedef AsdTSST8001Data::AsdTSHeader *LPTSST8001_TSHeader;
typedef AsdTSST8001Data::AsdSDSTCMMI *LPTSST8001_SDSTCMMI;
typedef AsdTSST8001Data::AsdSTTRMONY *LPTSST8001_STTRMONY;
typedef AsdTSST8001Data::AsdSTTRMONY::AsdExtAmtInfo *LPTSST8001_STTRMONY_ExtAmtInfo;
typedef AsdTSST8001Data::AsdTSMDA *LPTSST8001_TSMDA;
typedef AsdTSST8001Data::AsdTSMDA::AsdMdaTrmMsg *LPTSST8001_TSMDA_MdaTrmMsg;
typedef AsdTSST8001Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPTSST8001_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdTSST8001Data_H
