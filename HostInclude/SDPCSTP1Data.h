#ifndef AsdSDPCSTP1Data_H
#define AsdSDPCSTP1Data_H

#include <stdlib.h>
#ifdef  AsdSDPCSTP1_INTEGRITY_STRING
#undef  AsdSDPCSTP1_INTEGRITY_STRING
#endif
#define AsdSDPCSTP1_INTEGRITY_STRING        ""

#ifdef  AsdSDPCSTP1_CRC_STRING
#undef  AsdSDPCSTP1_CRC_STRING
#endif
#define AsdSDPCSTP1_CRC_STRING "652459463"
...
//**************** Start AsdSDPCSTP1Data Definition ****************
//                 ST Stop/Hold Maintenance

//                 SDPCSTP1Data.h generated by AceGen2 ver. 2.5.09

class AsdSDPCSTP1Data
{
  public:
  ...
  public:
    AsdSDPCSTP1Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCSTP1.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCSTP1_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCSTP1_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCSTP1", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDSTCMST.Load(&m_Sess);
                        CSDSTSHMT.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCSTP1");
                    }
    ...
    //**************** Start AsdSDSTSHMT Definition ****************
    //                 SERVICE DELIVERY ST STOP/HOLD MAINTENANCE INPUT             
    ...
    class AsdSDSTSHMT
    {
      private:
        ...
        bool      m_bAmount;
        char      m_szAmount[16+1];
        bool      m_bHighSerNbr;
        char      m_szHighSerNbr[10+1];
        bool      m_bExpDays;
        char      m_szExpDays[4+1];
        bool      m_bSeqNbr;
        char      m_szSeqNbr[4+1];
        bool      m_bCustGen;
      ...
      public:
        ...
        AsdSDSTSHMT ()  // Constructor
        {
            ...
            strcpy(m_szExpDate, "");
            m_bAmount = false;
            strcpy(m_szAmount, "0000000000000000");
            m_bHighSerNbr = false;
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDSTSHMT", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLCloseRecord(pSess, "SDSTSHMT");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDSTSHMT", m_lIndex, &m_bReceived))
            {
                ...
                CloseXMLRecord(pSess, "SDSTSHMT");
            };
        }
    };

    AsdSDSTSHMT CSDSTSHMT;
    AsdSDSTSHMT *SDSTSHMT;
    
    //**************** End AsdSDSTSHMT Definition ****************
...
//**************** End AsdSDPCSTP1Data Definition ****************

typedef AsdSDPCSTP1Data *LPSDPCSTP1;
typedef AsdSDPCSTP1Data::AsdTSHeader *LPSDPCSTP1_TSHeader;
typedef AsdSDPCSTP1Data::AsdSDSTCMST *LPSDPCSTP1_SDSTCMST;
typedef AsdSDPCSTP1Data::AsdSDSTSHMT *LPSDPCSTP1_SDSTSHMT;
typedef AsdSDPCSTP1Data::AsdTSMDA *LPSDPCSTP1_TSMDA;
typedef AsdSDPCSTP1Data::AsdTSMDA::AsdMdaTrmMsg *LPSDPCSTP1_TSMDA_MdaTrmMsg;
typedef AsdSDPCSTP1Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCSTP1_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCSTP1Data_H
