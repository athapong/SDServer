#ifndef AsdWVPCAMPQData_H
#define AsdWVPCAMPQData_H

#include <stdlib.h>
#ifdef  AsdWVPCAMPQ_INTEGRITY_STRING
#undef  AsdWVPCAMPQ_INTEGRITY_STRING
#endif
#define AsdWVPCAMPQ_INTEGRITY_STRING        ""

#ifdef  AsdWVPCAMPQ_CRC_STRING
#undef  AsdWVPCAMPQ_CRC_STRING
#endif
#define AsdWVPCAMPQ_CRC_STRING "2711319210"
...
//**************** Start AsdWVPCAMPQData Definition ****************
//                 Loan Payoff Quote

//                 WVPCAMPQData.h generated by AceGen2 ver. 2.5.09

class AsdWVPCAMPQData
{
  public:
  ...
  public:
    AsdWVPCAMPQData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "WVPCAMPQ.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdWVPCAMPQ_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdWVPCAMPQ_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdWVPCAMPQ_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CWVAMPOQO.Save(&m_Sess);
        CWVAMPOQI.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "WVPCAMPQ", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CWVAMPOQO.Load(&m_Sess);
                        CWVAMPOQI.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "WVPCAMPQ");
                    }
    ...
    //**************** Start AsdWVAMPOQO Definition ****************
    //                 CCW INTERFACE WITH ALS - PAYOFF INQUIRY                     
    ...
    class AsdWVAMPOQO
    {
      private:
        ...
        short     m_nPageSub;
        bool      m_bNumEntries;
        char      m_szNumEntries[4+1];
        bool      m_bPayoffAmt;
        char      m_szPayoffAmt[17+1];
        bool      m_bMinPoff;
        char      m_szMinPoff[17+1];
        bool      m_bMaxPoff;
        char      m_szMaxPoff[17+1];
        bool      m_bPnltyCd;
        char      m_szPnltyCd[1+1];
        bool      m_bCalcPnlty;
        char      m_szCalcPnlty[17+1];
        bool      m_bUserPnlty;
        char      m_szUserPnlty[17+1];
        bool      m_bDlyAmt;
        char      m_szDlyAmt[19+1];
        bool      m_bPoffChgDate;
        char      m_szPoffChgDate[8+1];
        bool      m_bProcInd;
        char      m_szProcInd[1+1];
        bool      m_bPdwnInd;
        char      m_szPdwnInd[1+1];
        bool      m_bCloseInd;
        char      m_szCloseInd[1+1];
        bool      m_bSimpInd;
        char      m_szSimpInd[1+1];
        bool      m_bLineInd;
        char      m_szLineInd[1+1];
        bool      m_bPoffMsg;
        char      m_szPoffMsg[40+1];
        bool      m_bCoffInd;
        char      m_szCoffInd[1+1];
        bool      m_bTakedownId;
        char      m_szTakedownId[3+1];
        bool      m_bFill0;
        char      m_szFill0[28+1];
      ...
      public:
        ...
        AsdWVAMPOQO ()  // Constructor
        {
            ...
            m_nPageSub = 0;
            m_bNumEntries = false;
            strcpy(m_szNumEntries, "+000");
            m_bPayoffAmt = false;
            strcpy(m_szPayoffAmt, "+0000000000000.00");
            m_bMinPoff = false;
            strcpy(m_szMinPoff, "+0000000000000.00");
            m_bMaxPoff = false;
            strcpy(m_szMaxPoff, "+0000000000000.00");
            m_bPnltyCd = false;
            strcpy(m_szPnltyCd, "");
            m_bCalcPnlty = false;
            strcpy(m_szCalcPnlty, "+0000000000000.00");
            m_bUserPnlty = false;
            strcpy(m_szUserPnlty, "+0000000000000.00");
            m_bDlyAmt = false;
            strcpy(m_szDlyAmt, "+0000000000.0000000");
            m_bPoffChgDate = false;
            strcpy(m_szPoffChgDate, "");
            m_bProcInd = false;
            strcpy(m_szProcInd, "");
            m_bPdwnInd = false;
            strcpy(m_szPdwnInd, "");
            ...
            strcpy(m_szCoffInd, "");
            m_bTakedownId = false;
            strcpy(m_szTakedownId, "");
            m_bFill0 = false;
            strcpy(m_szFill0, "");
            long lOccurs;
        
            for (lOccurs = 0; lOccurs < 48; lOccurs++)
            {
                TableData[lOccurs]  = &CTableData[lOccurs];
                CTableData[lOccurs].m_lIndex = lOccurs;
            }
        }
        ...
        long PageSub (const short nValue)
        {
            return SetShort(nValue, &m_nPageSub, &m_bPageSub);
        }
        
        //    NUMBER OF ENTRIES RETURNED FROM THE INQUIRY
        long lNumEntries () { return 4; };
        RWCString NumEntries (void)
        {
            return AceZeroSupp(m_szNumEntries, &m_szSuppressBuff[0]);
        }
        RWCString NumEntriesRaw (void)
        {
            return m_szNumEntries;
        }
        long NumEntries (const RWCString& rwc)
        {
            return SetString(rwc, m_szNumEntries, sizeof(m_szNumEntries), &m_bNumEntries);
        }
        ...
        //    CURRENT MINIMUM PAYOFF AMOUNT
        long lMinPoff () { return 17; };
        RWCString MinPoff (void)
        {
            return AceZeroSupp(m_szMinPoff, &m_szSuppressBuff[0]);
        }
        RWCString MinPoffRaw (void)
        {
            return m_szMinPoff;
        }
        long MinPoff (const RWCString& rwc)
        {
            return SetString(rwc, m_szMinPoff, sizeof(m_szMinPoff), &m_bMinPoff);
        }
        
        //    CURRENT MAXIMUM PAYOFF AMOUNT
        long lMaxPoff () { return 17; };
        RWCString MaxPoff (void)
        {
            return AceZeroSupp(m_szMaxPoff, &m_szSuppressBuff[0]);
        }
        RWCString MaxPoffRaw (void)
        {
            return m_szMaxPoff;
        }
        long MaxPoff (const RWCString& rwc)
        {
            return SetString(rwc, m_szMaxPoff, sizeof(m_szMaxPoff), &m_bMaxPoff);
        }
        
        //    INDICATES THE CURRENT USE OF THE PENALTY AMOUNT FIELDS
        long lPnltyCd () { return 1; };
        RWCString PnltyCd (void)
        {
            return m_szPnltyCd;
        }
        long PnltyCd (const RWCString& rwc)
        {
            return SetString(rwc, m_szPnltyCd, sizeof(m_szPnltyCd), &m_bPnltyCd);
        }
        
        //    CURRENT PAYOFF PENALTY AMOUNT
        long lCalcPnlty () { return 17; };
        RWCString CalcPnlty (void)
        {
            return AceZeroSupp(m_szCalcPnlty, &m_szSuppressBuff[0]);
        }
        RWCString CalcPnltyRaw (void)
        {
            return m_szCalcPnlty;
        }
        long CalcPnlty (const RWCString& rwc)
        {
            return SetString(rwc, m_szCalcPnlty, sizeof(m_szCalcPnlty), &m_bCalcPnlty);
        }
        
        //    USED ENTERED AND PROCESSED PENALTY AMOUNT
        long lUserPnlty () { return 17; };
        RWCString UserPnlty (void)
        {
            return AceZeroSupp(m_szUserPnlty, &m_szSuppressBuff[0]);
        }
        RWCString UserPnltyRaw (void)
        {
            return m_szUserPnlty;
        }
        long UserPnlty (const RWCString& rwc)
        {
            return SetString(rwc, m_szUserPnlty, sizeof(m_szUserPnlty), &m_bUserPnlty);
        }
        
        //    CURRENT DAILY INTEREST ACCRUAL AMOUNT
        long lDlyAmt () { return 19; };
        RWCString DlyAmt (void)
        {
            return AceZeroSupp(m_szDlyAmt, &m_szSuppressBuff[0]);
        }
        RWCString DlyAmtRaw (void)
        {
            return m_szDlyAmt;
        }
        long DlyAmt (const RWCString& rwc)
        {
            return SetString(rwc, m_szDlyAmt, sizeof(m_szDlyAmt), &m_bDlyAmt);
        }
        
        //    DATE ON WHICH THE CURRENT PAYOFF AMOUNT WILL CHANGE
        long lPoffChgDate () { return 8; };
        RWCString PoffChgDate (void)
        {
            return m_szPoffChgDate;
        }
        long PoffChgDate (const RWCString& rwc)
        {
            return SetString(rwc, m_szPoffChgDate, sizeof(m_szPoffChgDate), &m_bPoffChgDate);
        }
        
        //    INDICATES THAT THIS TRANSACTION IS TO BE PROCESSED
        long lProcInd () { return 1; };
        RWCString ProcInd (void)
        {
            return m_szProcInd;
        }
        long ProcInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szProcInd, sizeof(m_szProcInd), &m_bProcInd);
        }
        
        //    INDICATES THAT THIS TRANSACTION IS A PAYDOWN ONLY
        long lPdwnInd () { return 1; };
        RWCString PdwnInd (void)
        {
            return m_szPdwnInd;
        }
        long PdwnInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szPdwnInd, sizeof(m_szPdwnInd), &m_bPdwnInd);
        }
        
        //    INDICATES THAT THIS TRANSACTION WILL CLOSE THE LOAN
        long lCloseInd () { return 1; };
        RWCString CloseInd (void)
        {
            return m_szCloseInd;
        }
        long CloseInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szCloseInd, sizeof(m_szCloseInd), &m_bCloseInd);
        }
        
        //    INDICATES IF THIS LOAN IS A SIMPLE INTEREST LOAN
        long lSimpInd () { return 1; };
        RWCString SimpInd (void)
        {
            return m_szSimpInd;
        }
        long SimpInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szSimpInd, sizeof(m_szSimpInd), &m_bSimpInd);
        }
        
        //    INDICATES IF THIS LOAN IS A LINE OF CREDIT NOTE
        long lLineInd () { return 1; };
        RWCString LineInd (void)
        {
            return m_szLineInd;
        }
        long LineInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szLineInd, sizeof(m_szLineInd), &m_bLineInd);
        }
        
        //    MESSAGE TO BE DISPLAYED FROM THE TICKLER FILE
        long lPoffMsg () { return 40; };
        RWCString PoffMsg (void)
        {
            return m_szPoffMsg;
        }
        long PoffMsg (const RWCString& rwc)
        {
            return SetString(rwc, m_szPoffMsg, sizeof(m_szPoffMsg), &m_bPoffMsg);
        }
        
        //    INDICATES IF THIS LOAN IS A FULLY CHARGED OFF NOTE
        long lCoffInd () { return 1; };
        RWCString CoffInd (void)
        {
            return m_szCoffInd;
        }
        long CoffInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szCoffInd, sizeof(m_szCoffInd), &m_bCoffInd);
        }
        
        //    TAKEDOWN IDENTIFIER
        long lTakedownId () { return 3; };
        RWCString TakedownId (void)
        {
            return m_szTakedownId;
        }
        long TakedownId (const RWCString& rwc)
        {
            return SetString(rwc, m_szTakedownId, sizeof(m_szTakedownId), &m_bTakedownId);
        }
        
        long lFill0 () { return 28; };
        ...
        {
            if (m_bHostInitOverride) return true;
            if (m_bPageSub) return true;
            if (m_bNumEntries) return true;
            if (m_bPayoffAmt) return true;
            if (m_bMinPoff) return true;
            if (m_bMaxPoff) return true;
            if (m_bPnltyCd) return true;
            if (m_bCalcPnlty) return true;
            if (m_bUserPnlty) return true;
            if (m_bDlyAmt) return true;
            if (m_bPoffChgDate) return true;
            if (m_bProcInd) return true;
            if (m_bPdwnInd) return true;
            if (m_bCloseInd) return true;
            if (m_bSimpInd) return true;
            if (m_bLineInd) return true;
            if (m_bPoffMsg) return true;
            if (m_bCoffInd) return true;
            if (m_bTakedownId) return true;
            if (m_bFill0) return true;
            long lOccurs;
            for (lOccurs = 0; lOccurs < 48; lOccurs++)
            {
                if(CTableData[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "WVAMPOQO", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "PageSub", m_nPageSub, &m_bPageSub);
                AddXMLField(pSess, "NumEntries", m_szNumEntries, &m_bNumEntries);
                AddXMLField(pSess, "PayoffAmt", m_szPayoffAmt, &m_bPayoffAmt);
                AddXMLField(pSess, "MinPoff", m_szMinPoff, &m_bMinPoff);
                AddXMLField(pSess, "MaxPoff", m_szMaxPoff, &m_bMaxPoff);
                AddXMLField(pSess, "PnltyCd", m_szPnltyCd, &m_bPnltyCd);
                AddXMLField(pSess, "CalcPnlty", m_szCalcPnlty, &m_bCalcPnlty);
                AddXMLField(pSess, "UserPnlty", m_szUserPnlty, &m_bUserPnlty);
                AddXMLField(pSess, "DlyAmt", m_szDlyAmt, &m_bDlyAmt);
                AddXMLField(pSess, "PoffChgDate", m_szPoffChgDate, &m_bPoffChgDate);
                AddXMLField(pSess, "ProcInd", m_szProcInd, &m_bProcInd);
                AddXMLField(pSess, "PdwnInd", m_szPdwnInd, &m_bPdwnInd);
                AddXMLField(pSess, "CloseInd", m_szCloseInd, &m_bCloseInd);
                AddXMLField(pSess, "SimpInd", m_szSimpInd, &m_bSimpInd);
                AddXMLField(pSess, "LineInd", m_szLineInd, &m_bLineInd);
                AddXMLField(pSess, "PoffMsg", m_szPoffMsg, &m_bPoffMsg);
                AddXMLField(pSess, "CoffInd", m_szCoffInd, &m_bCoffInd);
                AddXMLField(pSess, "TakedownId", m_szTakedownId, &m_bTakedownId);
                AddXMLField(pSess, "Fill0", m_szFill0, &m_bFill0);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 48; lOccurs++)
                {
                    CTableData[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "WVAMPOQO");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "WVAMPOQO", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "PageSub", &m_nPageSub);
                GetXMLField(pSess, "NumEntries", m_szNumEntries);
                GetXMLField(pSess, "PayoffAmt", m_szPayoffAmt);
                GetXMLField(pSess, "MinPoff", m_szMinPoff);
                GetXMLField(pSess, "MaxPoff", m_szMaxPoff);
                GetXMLField(pSess, "PnltyCd", m_szPnltyCd);
                GetXMLField(pSess, "CalcPnlty", m_szCalcPnlty);
                GetXMLField(pSess, "UserPnlty", m_szUserPnlty);
                GetXMLField(pSess, "DlyAmt", m_szDlyAmt);
                GetXMLField(pSess, "PoffChgDate", m_szPoffChgDate);
                GetXMLField(pSess, "ProcInd", m_szProcInd);
                GetXMLField(pSess, "PdwnInd", m_szPdwnInd);
                GetXMLField(pSess, "CloseInd", m_szCloseInd);
                GetXMLField(pSess, "SimpInd", m_szSimpInd);
                GetXMLField(pSess, "LineInd", m_szLineInd);
                GetXMLField(pSess, "PoffMsg", m_szPoffMsg);
                GetXMLField(pSess, "CoffInd", m_szCoffInd);
                GetXMLField(pSess, "TakedownId", m_szTakedownId);
                GetXMLField(pSess, "Fill0", m_szFill0);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 48; lOccurs++)
                {
                    CTableData[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "WVAMPOQO");
            };
        }
        
        //**************** Start AsdTableData Definition ****************
        //                 TABLE OF DUE AMOUNTS USED BY THE PROCESSING
        ...
        class AsdTableData
        {
          private:
            ...
            char      m_szRptGrp[1+1];
            bool      m_bAmountDue;
            char      m_szAmountDue[17+1];
            bool      m_bCurrentBalance;
            char      m_szCurrentBalance[17+1];
            bool      m_bRebate;
            char      m_szRebate[17+1];
            bool      m_bAdjustmentAmt;
            char      m_szAdjustmentAmt[17+1];
        
          public:
            long      m_lIndex;

            AsdTableData ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bTr03Id = false;
                ...
                strcpy(m_szRptGrp, "");
                m_bAmountDue = false;
                strcpy(m_szAmountDue, "+0000000000000.00");
                m_bCurrentBalance = false;
                strcpy(m_szCurrentBalance, "+0000000000000.00");
                m_bRebate = false;
                strcpy(m_szRebate, "+0000000000000.00");
                m_bAdjustmentAmt = false;
                strcpy(m_szAdjustmentAmt, "+0000000000000.00");
            ...
            //    FUNDS IDENTIFIER FOR THIS ENTRY
            long lTr03Id () { return 5; };
            RWCString Tr03Id (void)
            {
                return m_szTr03Id;
            }
            long Tr03Id (const RWCString& rwc)
            {
                return SetString(rwc, m_szTr03Id, sizeof(m_szTr03Id), &m_bTr03Id);
            }
            
            //    THE GENERAL LEDGER REPORT GROUP TO EXTRACT
            long lRptGrp () { return 1; };
            RWCString RptGrp (void)
            {
                return m_szRptGrp;
            }
            long RptGrp (const RWCString& rwc)
            {
                return SetString(rwc, m_szRptGrp, sizeof(m_szRptGrp), &m_bRptGrp);
            }
            
            //    AMOUNT DUE FOR THIS ACCOUNT FUND
            long lAmountDue () { return 17; };
            RWCString AmountDue (void)
            {
                return AceZeroSupp(m_szAmountDue, &m_szSuppressBuff[0]);
            }
            RWCString AmountDueRaw (void)
            {
                return m_szAmountDue;
            }
            long AmountDue (const RWCString& rwc)
            {
                return SetString(rwc, m_szAmountDue, sizeof(m_szAmountDue), &m_bAmountDue);
            }
            
            //    CURRENT BALANCE FOR THIS ACCOUNT FUND
            long lCurrentBalance () { return 17; };
            RWCString CurrentBalance (void)
            {
                return AceZeroSupp(m_szCurrentBalance, &m_szSuppressBuff[0]);
            }
            RWCString CurrentBalanceRaw (void)
            {
                return m_szCurrentBalance;
            }
            long CurrentBalance (const RWCString& rwc)
            {
                return SetString(rwc, m_szCurrentBalance, sizeof(m_szCurrentBalance), &m_bCurrentBalance);
            }
            
            //    REBATE TO BE APPLIED TO DUE BALANCES OR FEES
            long lRebate () { return 17; };
            RWCString Rebate (void)
            {
                return AceZeroSupp(m_szRebate, &m_szSuppressBuff[0]);
            }
            RWCString RebateRaw (void)
            {
                return m_szRebate;
            }
            long Rebate (const RWCString& rwc)
            {
                return SetString(rwc, m_szRebate, sizeof(m_szRebate), &m_bRebate);
            }
            
            //    ADJUSTMENT TO BE MADE TO THIS FINANCIAL DAG
            long lAdjustmentAmt () { return 17; };
            RWCString AdjustmentAmt (void)
            {
                return AceZeroSupp(m_szAdjustmentAmt, &m_szSuppressBuff[0]);
            }
            RWCString AdjustmentAmtRaw (void)
            {
                return m_szAdjustmentAmt;
            }
            long AdjustmentAmt (const RWCString& rwc)
            {
                return SetString(rwc, m_szAdjustmentAmt, sizeof(m_szAdjustmentAmt), &m_bAdjustmentAmt);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bTr03Id) return true;
                if (m_bRptGrp) return true;
                if (m_bAmountDue) return true;
                if (m_bCurrentBalance) return true;
                if (m_bRebate) return true;
                if (m_bAdjustmentAmt) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "TableData", m_lIndex);
                    AddXMLField(pSess, "Tr03Id", m_szTr03Id, &m_bTr03Id);
                    AddXMLField(pSess, "RptGrp", m_szRptGrp, &m_bRptGrp);
                    AddXMLField(pSess, "AmountDue", m_szAmountDue, &m_bAmountDue);
                    AddXMLField(pSess, "CurrentBalance", m_szCurrentBalance, &m_bCurrentBalance);
                    AddXMLField(pSess, "Rebate", m_szRebate, &m_bRebate);
                    AddXMLField(pSess, "AdjustmentAmt", m_szAdjustmentAmt, &m_bAdjustmentAmt);
                    AddXMLCloseRecord(pSess, "TableData");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "TableData", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "Tr03Id", m_szTr03Id);
                    GetXMLField(pSess, "RptGrp", m_szRptGrp);
                    GetXMLField(pSess, "AmountDue", m_szAmountDue);
                    GetXMLField(pSess, "CurrentBalance", m_szCurrentBalance);
                    GetXMLField(pSess, "Rebate", m_szRebate);
                    GetXMLField(pSess, "AdjustmentAmt", m_szAdjustmentAmt);
                    CloseXMLRecord(pSess, "TableData");
                };
            }
        };

        AsdTableData  CTableData[48];
        AsdTableData *TableData[48];
        
        //**************** End AsdTableData Definition ****************
        
    };

    AsdWVAMPOQO CWVAMPOQO;
    AsdWVAMPOQO *WVAMPOQO;
    
    //**************** End AsdWVAMPOQO Definition ****************

    
    //**************** Start AsdWVAMPOQI Definition ****************
    //                 CCW INTERFACE WITH ALS - PAYOFF INQUIRY                     
    ...
    class AsdWVAMPOQI
    {
      ...
      public:
        ...
        //    THE DATE ON WHICH THIS TRANSACTION IS TO BE EFFECTIVE.
        ...
        //    DEPARTMENT
        long lTrDept () { return 3; };
        RWCString TrDept (void)
        {
            return m_szTrDept;
        }
        long TrDept (const RWCString& rwc)
        {
            return SetString(rwc, m_szTrDept, sizeof(m_szTrDept), &m_bTrDept);
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "WVAMPOQI", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                ...
                AddXMLField(pSess, "TrDept", m_szTrDept, &m_bTrDept);
                AddXMLField(pSess, "TrBatch", m_szTrBatch, &m_bTrBatch);
                AddXMLField(pSess, "TrSeq", m_szTrSeq, &m_bTrSeq);
                AddXMLCloseRecord(pSess, "WVAMPOQI");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "WVAMPOQI", m_lIndex, &m_bReceived))
            {
                ...
                GetXMLField(pSess, "TrDept", m_szTrDept);
                GetXMLField(pSess, "TrBatch", m_szTrBatch);
                GetXMLField(pSess, "TrSeq", m_szTrSeq);
                CloseXMLRecord(pSess, "WVAMPOQI");
            };
        }
    };

    AsdWVAMPOQI CWVAMPOQI;
    AsdWVAMPOQI *WVAMPOQI;
    
    //**************** End AsdWVAMPOQI Definition ****************
...
//**************** End AsdWVPCAMPQData Definition ****************

typedef AsdWVPCAMPQData *LPWVPCAMPQ;
typedef AsdWVPCAMPQData::AsdTSHeader *LPWVPCAMPQ_TSHeader;
typedef AsdWVPCAMPQData::AsdWVAMPOQO *LPWVPCAMPQ_WVAMPOQO;
typedef AsdWVPCAMPQData::AsdWVAMPOQO::AsdTableData *LPWVPCAMPQ_WVAMPOQO_TableData;
typedef AsdWVPCAMPQData::AsdWVAMPOQI *LPWVPCAMPQ_WVAMPOQI;
typedef AsdWVPCAMPQData::AsdTSMDA *LPWVPCAMPQ_TSMDA;
typedef AsdWVPCAMPQData::AsdTSMDA::AsdMdaTrmMsg *LPWVPCAMPQ_TSMDA_MdaTrmMsg;
typedef AsdWVPCAMPQData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPWVPCAMPQ_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdWVPCAMPQData_H
