#ifndef AsdSDSAVBNDData_H
#define AsdSDSAVBNDData_H

#include <stdlib.h>
#ifdef  AsdSDSAVBND_INTEGRITY_STRING
#undef  AsdSDSAVBND_INTEGRITY_STRING
#endif
#define AsdSDSAVBND_INTEGRITY_STRING        ""

#ifdef  AsdSDSAVBND_CRC_STRING
#undef  AsdSDSAVBND_CRC_STRING
#endif
#define AsdSDSAVBND_CRC_STRING "1249003356"
...
//**************** Start AsdSDSAVBNDData Definition ****************
//                 Bond Redemption

//                 SDSAVBNDData.h generated by AceGen2 ver. 2.5.09

class AsdSDSAVBNDData
{
  public:
  ...
  public:
    AsdSDSAVBNDData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDSAVBND.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDSAVBND_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDSAVBND_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDSAVBND_CRC_STRING, NULL);
        AddXMLRecord(&m_Sess, m_Sess.pDataTag, -1);       // DATA
        CTSHeader.Save(&m_Sess);
        CSDBNDRED.Save(&m_Sess);
        CTSMDA.Save(&m_Sess);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDSAVBND", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDBNDRED.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDSAVBND");
                    }
    ...
    //**************** Start AsdSDBNDRED Definition ****************
    //                 SERVICE DELIVERY SAVINGS BOND REDEMPTION DAG                
    ...
    class AsdSDBNDRED
    {
      private:
        ...
        char      m_szSuppressBuff[100];
        bool      m_bTaxKeyCtl1;
        char      m_szTaxKeyCtl1[2+1];
        bool      m_bTaxKeyCtl2;
        char      m_szTaxKeyCtl2[3+1];
        bool      m_bTaxKeyCtl3;
        char      m_szTaxKeyCtl3[3+1];
        bool      m_bTaxYear;
        char      m_szTaxYear[4+1];
        bool      m_bTaxId;
        char      m_szTaxId[9+1];
        bool      m_bName1;
        char      m_szName1[40+1];
        ...
        char      m_szZip[9+1];
        bool      m_bForeignInd;
        char      m_szForeignInd[1+1];
    
      public:
        long      m_lIndex;

        AsdSDBNDRED ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            m_lIndex = -1;
            m_bTaxKeyCtl1 = false;
            strcpy(m_szTaxKeyCtl1, "00");
            m_bTaxKeyCtl2 = false;
            strcpy(m_szTaxKeyCtl2, "000");
            m_bTaxKeyCtl3 = false;
            strcpy(m_szTaxKeyCtl3, "000");
            m_bTaxYear = false;
            strcpy(m_szTaxYear, "0000");
            m_bTaxId = false;
            strcpy(m_szTaxId, "");
            m_bName1 = false;
            strcpy(m_szName1, "");
            ...
            strcpy(m_szZip, "");
            m_bForeignInd = false;
            strcpy(m_szForeignInd, "");
            long lOccurs;
        
            for (lOccurs = 0; lOccurs < 3; lOccurs++)
            {
                InterestFields[lOccurs]  = &CInterestFields[lOccurs];
                CInterestFields[lOccurs].m_lIndex = lOccurs;
            }
        }
        ...
        //    TAX KEY CONTROL 1
        long lTaxKeyCtl1 () { return 2; };
        RWCString TaxKeyCtl1 (void)
        {
            return m_szTaxKeyCtl1;
        }
        long TaxKeyCtl1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szTaxKeyCtl1, sizeof(m_szTaxKeyCtl1), &m_bTaxKeyCtl1);
        }
        
        //    TAX KEY CONTROL 2
        long lTaxKeyCtl2 () { return 3; };
        RWCString TaxKeyCtl2 (void)
        {
            return m_szTaxKeyCtl2;
        }
        long TaxKeyCtl2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szTaxKeyCtl2, sizeof(m_szTaxKeyCtl2), &m_bTaxKeyCtl2);
        }
        
        //    TAX KEY CONTROL 3
        long lTaxKeyCtl3 () { return 3; };
        RWCString TaxKeyCtl3 (void)
        {
            return m_szTaxKeyCtl3;
        }
        long TaxKeyCtl3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szTaxKeyCtl3, sizeof(m_szTaxKeyCtl3), &m_bTaxKeyCtl3);
        }
        
        //    TAX YEAR
        long lTaxYear () { return 4; };
        RWCString TaxYear (void)
        {
            return m_szTaxYear;
        }
        long TaxYear (const RWCString& rwc)
        {
            return SetString(rwc, m_szTaxYear, sizeof(m_szTaxYear), &m_bTaxYear);
        }
        
        //    TAX ID
        long lTaxId () { return 9; };
        RWCString TaxId (void)
        {
            return m_szTaxId;
        }
        long TaxId (const RWCString& rwc)
        {
            return SetString(rwc, m_szTaxId, sizeof(m_szTaxId), &m_bTaxId);
        }
        
        //    NAME LINE 1
        long lName1 () { return 40; };
        RWCString Name1 (void)
        {
            return m_szName1;
        }
        long Name1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szName1, sizeof(m_szName1), &m_bName1);
        }
        
        //    NAME LINE 2
        long lName2 () { return 40; };
        RWCString Name2 (void)
        {
            return m_szName2;
        }
        long Name2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szName2, sizeof(m_szName2), &m_bName2);
        }
        
        //    ADDRESS LINE 3
        long lAddr3 () { return 40; };
        RWCString Addr3 (void)
        {
            return m_szAddr3;
        }
        long Addr3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szAddr3, sizeof(m_szAddr3), &m_bAddr3);
        }
        
        //    CITY
        long lCity () { return 40; };
        RWCString City (void)
        {
            return m_szCity;
        }
        ...
        long Zip (const RWCString& rwc)
        {
            return SetString(rwc, m_szZip, sizeof(m_szZip), &m_bZip);
        }
        
        //    FOREIGN ADDRESS INDICATOR
        long lForeignInd () { return 1; };
        RWCString ForeignInd (void)
        {
            return m_szForeignInd;
        }
        long ForeignInd (const RWCString& rwc)
        {
            return SetString(rwc, m_szForeignInd, sizeof(m_szForeignInd), &m_bForeignInd);
        }
        
        bool HasDataToSave (void)
        {
            if (m_bHostInitOverride) return true;
            if (m_bTaxKeyCtl1) return true;
            if (m_bTaxKeyCtl2) return true;
            if (m_bTaxKeyCtl3) return true;
            if (m_bTaxYear) return true;
            if (m_bTaxId) return true;
            if (m_bName1) return true;
            if (m_bName2) return true;
            if (m_bAddr3) return true;
            if (m_bCity) return true;
            if (m_bState) return true;
            if (m_bZip) return true;
            if (m_bForeignInd) return true;
            long lOccurs;
            for (lOccurs = 0; lOccurs < 3; lOccurs++)
            {
                if(CInterestFields[lOccurs].HasDataToSave())
                {
                    return true;
                }
            }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDBNDRED", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "TaxKeyCtl1", m_szTaxKeyCtl1, &m_bTaxKeyCtl1);
                AddXMLField(pSess, "TaxKeyCtl2", m_szTaxKeyCtl2, &m_bTaxKeyCtl2);
                AddXMLField(pSess, "TaxKeyCtl3", m_szTaxKeyCtl3, &m_bTaxKeyCtl3);
                AddXMLField(pSess, "TaxYear", m_szTaxYear, &m_bTaxYear);
                AddXMLField(pSess, "TaxId", m_szTaxId, &m_bTaxId);
                AddXMLField(pSess, "Name1", m_szName1, &m_bName1);
                AddXMLField(pSess, "Name2", m_szName2, &m_bName2);
                AddXMLField(pSess, "Addr3", m_szAddr3, &m_bAddr3);
                AddXMLField(pSess, "City", m_szCity, &m_bCity);
                AddXMLField(pSess, "State", m_szState, &m_bState);
                AddXMLField(pSess, "Zip", m_szZip, &m_bZip);
                AddXMLField(pSess, "ForeignInd", m_szForeignInd, &m_bForeignInd);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 3; lOccurs++)
                {
                    CInterestFields[lOccurs].Save(pSess);
                }
                AddXMLCloseRecord(pSess, "SDBNDRED");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDBNDRED", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "TaxKeyCtl1", m_szTaxKeyCtl1);
                GetXMLField(pSess, "TaxKeyCtl2", m_szTaxKeyCtl2);
                GetXMLField(pSess, "TaxKeyCtl3", m_szTaxKeyCtl3);
                GetXMLField(pSess, "TaxYear", m_szTaxYear);
                GetXMLField(pSess, "TaxId", m_szTaxId);
                GetXMLField(pSess, "Name1", m_szName1);
                GetXMLField(pSess, "Name2", m_szName2);
                GetXMLField(pSess, "Addr3", m_szAddr3);
                GetXMLField(pSess, "City", m_szCity);
                GetXMLField(pSess, "State", m_szState);
                GetXMLField(pSess, "Zip", m_szZip);
                GetXMLField(pSess, "ForeignInd", m_szForeignInd);
                long lOccurs;
                for (lOccurs = 0; lOccurs < 3; lOccurs++)
                {
                    CInterestFields[lOccurs].Load(pSess);
                }
                CloseXMLRecord(pSess, "SDBNDRED");
            };
        }
        
        //**************** Start AsdInterestFields Definition ****************
        //                 TAX INTEREST FIELDS
        
        class AsdInterestFields
        {
          private:
            bool      m_bReceived;
            char      m_szSuppressBuff[100];
            bool      m_bType;
            char      m_szType[1+1];
            bool      m_bTaxBondInterest;
            char      m_szTaxBondInterest[17+1];
        
          public:
            long      m_lIndex;

            AsdInterestFields ()  // Constructor
            {
                m_bReceived = false;
                m_lIndex = -1;
                m_bType = false;
                strcpy(m_szType, "");
                m_bTaxBondInterest = false;
                strcpy(m_szTaxBondInterest, "+0000000000000.00");
            ...
            //    SAVINGS BOND INTEREST EARNED
            long lTaxBondInterest () { return 17; };
            RWCString TaxBondInterest (void)
            {
                return AceZeroSupp(m_szTaxBondInterest, &m_szSuppressBuff[0]);
            }
            RWCString TaxBondInterestRaw (void)
            {
                return m_szTaxBondInterest;
            }
            long TaxBondInterest (const RWCString& rwc)
            {
                return SetString(rwc, m_szTaxBondInterest, sizeof(m_szTaxBondInterest), &m_bTaxBondInterest);
            }
            
            bool HasDataToSave (void)
            {
                if (m_bType) return true;
                if (m_bTaxBondInterest) return true;
                return false;
            }
            ...
            void Save (SESSIONDATA *pSess)
            {
                if (HasDataToSave())
                {
                    AddXMLRecord(pSess, "InterestFields", m_lIndex);
                    AddXMLField(pSess, "Type", m_szType, &m_bType);
                    AddXMLField(pSess, "TaxBondInterest", m_szTaxBondInterest, &m_bTaxBondInterest);
                    AddXMLCloseRecord(pSess, "InterestFields");  // ACE
                };
            }

            void Load (SESSIONDATA *pSess)
            {
                if (GetXMLRecord(pSess, "InterestFields", m_lIndex, &m_bReceived))
                {
                    GetXMLField(pSess, "Type", m_szType);
                    GetXMLField(pSess, "TaxBondInterest", m_szTaxBondInterest);
                    CloseXMLRecord(pSess, "InterestFields");
                };
            }
        };

        AsdInterestFields  CInterestFields[3];
        AsdInterestFields *InterestFields[3];
        
        //**************** End AsdInterestFields Definition ****************
        
    };

    AsdSDBNDRED CSDBNDRED;
    AsdSDBNDRED *SDBNDRED;
    
    //**************** End AsdSDBNDRED Definition ****************
...
//**************** End AsdSDSAVBNDData Definition ****************

typedef AsdSDSAVBNDData *LPSDSAVBND;
typedef AsdSDSAVBNDData::AsdTSHeader *LPSDSAVBND_TSHeader;
typedef AsdSDSAVBNDData::AsdSDBNDRED *LPSDSAVBND_SDBNDRED;
typedef AsdSDSAVBNDData::AsdSDBNDRED::AsdInterestFields *LPSDSAVBND_SDBNDRED_InterestFields;
typedef AsdSDSAVBNDData::AsdTSMDA *LPSDSAVBND_TSMDA;
typedef AsdSDSAVBNDData::AsdTSMDA::AsdMdaTrmMsg *LPSDSAVBND_TSMDA_MdaTrmMsg;
typedef AsdSDSAVBNDData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDSAVBND_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDSAVBNDData_H
