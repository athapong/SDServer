#ifndef AsdSDPCIMP2Data_H
#define AsdSDPCIMP2Data_H

#include <stdlib.h>
#ifdef  AsdSDPCIMP2_INTEGRITY_STRING
#undef  AsdSDPCIMP2_INTEGRITY_STRING
#endif
#define AsdSDPCIMP2_INTEGRITY_STRING        ""

#ifdef  AsdSDPCIMP2_CRC_STRING
#undef  AsdSDPCIMP2_CRC_STRING
#endif
#define AsdSDPCIMP2_CRC_STRING "2689571749"
...
//**************** Start AsdSDPCIMP2Data Definition ****************
//                 Regular CC Stop/Hold Maintenance (Tran Type 52)

//                 SDPCIMP2Data.h generated by AceGen2 ver. 2.5.09

class AsdSDPCIMP2Data
{
  public:
  ...
  public:
    AsdSDPCIMP2Data ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCIMP2.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCIMP2_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCIMP2_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCIMP2", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDIMCMST.Load(&m_Sess);
                        CSDIMSHRC.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCIMP2");
                    }
    ...
    //**************** Start AsdSDIMSHRC Definition ****************
    //                 SERVICE DELIVERY IM REG CC HOLD PLACE INPUT                 
    ...
    class AsdSDIMSHRC
    {
      private:
        ...
        bool      m_bEntryDays1;
        char      m_szEntryDays1[2+1];
        bool      m_bEntryAmount1;
        char      m_szEntryAmount1[15+1];
        bool      m_bEntryDays2;
        char      m_szEntryDays2[2+1];
        bool      m_bEntryAmount2;
        char      m_szEntryAmount2[15+1];
        bool      m_bEntryDays3;
        char      m_szEntryDays3[2+1];
        bool      m_bEntryAmount3;
        char      m_szEntryAmount3[15+1];
        bool      m_bEntryDays4;
        char      m_szEntryDays4[2+1];
        bool      m_bEntryAmount4;
        char      m_szEntryAmount4[15+1];
    
      public:
        long      m_lIndex;

        AsdSDIMSHRC ()  // Constructor
        {
            m_bHostInitOverride = false;
            strcpy(m_szHostInitOverride, "");
            m_bReceived = false;
            ...
            strcpy(m_szTranCode, "");
            m_bEntryDays1 = false;
            strcpy(m_szEntryDays1, "00");
            m_bEntryAmount1 = false;
            strcpy(m_szEntryAmount1, "");
            m_bEntryDays2 = false;
            strcpy(m_szEntryDays2, "00");
            m_bEntryAmount2 = false;
            strcpy(m_szEntryAmount2, "");
            m_bEntryDays3 = false;
            strcpy(m_szEntryDays3, "00");
            m_bEntryAmount3 = false;
            strcpy(m_szEntryAmount3, "");
            m_bEntryDays4 = false;
            strcpy(m_szEntryDays4, "00");
            m_bEntryAmount4 = false;
            strcpy(m_szEntryAmount4, "");
        }
        ...
        //    DAYS OF UNAVAILALITY 1
        long lEntryDays1 () { return 2; };
        RWCString EntryDays1 (void)
        {
            return m_szEntryDays1;
        }
        long EntryDays1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryDays1, sizeof(m_szEntryDays1), &m_bEntryDays1);
        }
        
        //    AMOUNT OF UNAVAILABILITY 1
        long lEntryAmount1 () { return 15; };
        RWCString EntryAmount1 (void)
        {
            return m_szEntryAmount1;
        }
        long EntryAmount1 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryAmount1, sizeof(m_szEntryAmount1), &m_bEntryAmount1);
        }
        
        //    DAYS OF UNAVAILALITY 2
        long lEntryDays2 () { return 2; };
        RWCString EntryDays2 (void)
        {
            return m_szEntryDays2;
        }
        long EntryDays2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryDays2, sizeof(m_szEntryDays2), &m_bEntryDays2);
        }
        
        //    AMOUNT OF UNAVAILABILITY 2
        long lEntryAmount2 () { return 15; };
        RWCString EntryAmount2 (void)
        {
            return m_szEntryAmount2;
        }
        long EntryAmount2 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryAmount2, sizeof(m_szEntryAmount2), &m_bEntryAmount2);
        }
        
        //    DAYS OF UNAVAILALITY 3
        long lEntryDays3 () { return 2; };
        RWCString EntryDays3 (void)
        {
            return m_szEntryDays3;
        }
        long EntryDays3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryDays3, sizeof(m_szEntryDays3), &m_bEntryDays3);
        }
        
        //    AMOUNT OF UNAVAILABILITY 3
        long lEntryAmount3 () { return 15; };
        RWCString EntryAmount3 (void)
        {
            return m_szEntryAmount3;
        }
        long EntryAmount3 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryAmount3, sizeof(m_szEntryAmount3), &m_bEntryAmount3);
        }
        
        //    DAYS OF UNAVAILALITY 4
        long lEntryDays4 () { return 2; };
        RWCString EntryDays4 (void)
        {
            return m_szEntryDays4;
        }
        long EntryDays4 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryDays4, sizeof(m_szEntryDays4), &m_bEntryDays4);
        }
        
        //    AMOUNT OF UNAVAILABILITY 4
        long lEntryAmount4 () { return 15; };
        RWCString EntryAmount4 (void)
        {
            return m_szEntryAmount4;
        }
        long EntryAmount4 (const RWCString& rwc)
        {
            return SetString(rwc, m_szEntryAmount4, sizeof(m_szEntryAmount4), &m_bEntryAmount4);
        }
        ...
        bool HasDataToSave (void)
        {
            ...
            if (m_bEntryDays1) return true;
            if (m_bEntryAmount1) return true;
            if (m_bEntryDays2) return true;
            if (m_bEntryAmount2) return true;
            if (m_bEntryDays3) return true;
            if (m_bEntryAmount3) return true;
            if (m_bEntryDays4) return true;
            if (m_bEntryAmount4) return true;
            return false;
        }
        ...
        void Save (SESSIONDATA *pSess)
        {
            if (HasDataToSave())
            {
                AddXMLRecord(pSess, "SDIMSHRC", m_lIndex);
                AddXMLField(pSess, "HostInitOverride", m_szHostInitOverride, &m_bHostInitOverride);
                AddXMLField(pSess, "TranCode", m_szTranCode, &m_bTranCode);
                AddXMLField(pSess, "EntryDays1", m_szEntryDays1, &m_bEntryDays1);
                AddXMLField(pSess, "EntryAmount1", m_szEntryAmount1, &m_bEntryAmount1);
                AddXMLField(pSess, "EntryDays2", m_szEntryDays2, &m_bEntryDays2);
                AddXMLField(pSess, "EntryAmount2", m_szEntryAmount2, &m_bEntryAmount2);
                AddXMLField(pSess, "EntryDays3", m_szEntryDays3, &m_bEntryDays3);
                AddXMLField(pSess, "EntryAmount3", m_szEntryAmount3, &m_bEntryAmount3);
                AddXMLField(pSess, "EntryDays4", m_szEntryDays4, &m_bEntryDays4);
                AddXMLField(pSess, "EntryAmount4", m_szEntryAmount4, &m_bEntryAmount4);
                AddXMLCloseRecord(pSess, "SDIMSHRC");  // ACE
            };
        }

        void Load (SESSIONDATA *pSess)
        {
            if (GetXMLRecord(pSess, "SDIMSHRC", m_lIndex, &m_bReceived))
            {
                GetXMLField(pSess, "TranCode", m_szTranCode);
                GetXMLField(pSess, "EntryDays1", m_szEntryDays1);
                GetXMLField(pSess, "EntryAmount1", m_szEntryAmount1);
                GetXMLField(pSess, "EntryDays2", m_szEntryDays2);
                GetXMLField(pSess, "EntryAmount2", m_szEntryAmount2);
                GetXMLField(pSess, "EntryDays3", m_szEntryDays3);
                GetXMLField(pSess, "EntryAmount3", m_szEntryAmount3);
                GetXMLField(pSess, "EntryDays4", m_szEntryDays4);
                GetXMLField(pSess, "EntryAmount4", m_szEntryAmount4);
                CloseXMLRecord(pSess, "SDIMSHRC");
            };
        }
    };

    AsdSDIMSHRC CSDIMSHRC;
    AsdSDIMSHRC *SDIMSHRC;
    
    //**************** End AsdSDIMSHRC Definition ****************
...
//**************** End AsdSDPCIMP2Data Definition ****************

typedef AsdSDPCIMP2Data *LPSDPCIMP2;
typedef AsdSDPCIMP2Data::AsdTSHeader *LPSDPCIMP2_TSHeader;
typedef AsdSDPCIMP2Data::AsdSDIMCMST *LPSDPCIMP2_SDIMCMST;
typedef AsdSDPCIMP2Data::AsdSDIMSHRC *LPSDPCIMP2_SDIMSHRC;
typedef AsdSDPCIMP2Data::AsdTSMDA *LPSDPCIMP2_TSMDA;
typedef AsdSDPCIMP2Data::AsdTSMDA::AsdMdaTrmMsg *LPSDPCIMP2_TSMDA_MdaTrmMsg;
typedef AsdSDPCIMP2Data::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCIMP2_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCIMP2Data_H
