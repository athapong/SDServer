#ifndef AsdTWMEGATRData_H
#define AsdTWMEGATRData_H

#include <stdlib.h>
#ifdef  AsdTWMEGATR_INTEGRITY_STRING
#undef  AsdTWMEGATR_INTEGRITY_STRING
#endif
#define AsdTWMEGATR_INTEGRITY_STRING        ""

#ifdef  AsdTWMEGATR_CRC_STRING
#undef  AsdTWMEGATR_CRC_STRING
#endif
#define AsdTWMEGATR_CRC_STRING "2681513845"
...
//**************** Start AsdTWMEGATRData Definition ****************
//                 Mega Tran

//                 TWMEGATRData.h generated by AceGen2 ver. 2.5.09

class AsdTWMEGATRData
{
  public:
  ...
  public:
    AsdTWMEGATRData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "TWMEGATR.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdTWMEGATR_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdTWMEGATR_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdTWMEGATR_CRC_STRING, NULL);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "TWMEGATR", NULL, NULL))
                    {
                        ...
                        CloseXMLRecord(&m_Sess, "TWMEGATR");
                    }
...
//**************** End AsdTWMEGATRData Definition ****************

typedef AsdTWMEGATRData *LPTWMEGATR;
typedef AsdTWMEGATRData::AsdTSHeader *LPTWMEGATR_TSHeader;
typedef AsdTWMEGATRData::AsdTWMEGAIN *LPTWMEGATR_TWMEGAIN;
typedef AsdTWMEGATRData::AsdTWMEGAIN::AsdDebitItems *LPTWMEGATR_TWMEGAIN_DebitItems;
typedef AsdTWMEGATRData::AsdTWMEGAIN::AsdCreditItems *LPTWMEGATR_TWMEGAIN_CreditItems;
typedef AsdTWMEGATRData::AsdTWMEGAIN::AsdDebitCreditItems *LPTWMEGATR_TWMEGAIN_DebitCreditItems;
typedef AsdTWMEGATRData::AsdTWMEGFEE *LPTWMEGATR_TWMEGFEE;
typedef AsdTWMEGATRData::AsdTWMEGFEE::AsdDbFeeDetails *LPTWMEGATR_TWMEGFEE_DbFeeDetails;
typedef AsdTWMEGATRData::AsdTWMEGFEE::AsdCrFeeDetails *LPTWMEGATR_TWMEGFEE_CrFeeDetails;
typedef AsdTWMEGATRData::AsdTSMDA *LPTWMEGATR_TSMDA;
typedef AsdTWMEGATRData::AsdTSMDA::AsdMdaTrmMsg *LPTWMEGATR_TSMDA_MdaTrmMsg;
typedef AsdTWMEGATRData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPTWMEGATR_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdTWMEGATRData_H
