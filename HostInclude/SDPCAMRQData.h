#ifndef AsdSDPCAMRQData_H
#define AsdSDPCAMRQData_H

#include <stdlib.h>
#ifdef  AsdSDPCAMRQ_INTEGRITY_STRING
#undef  AsdSDPCAMRQ_INTEGRITY_STRING
#endif
#define AsdSDPCAMRQ_INTEGRITY_STRING        ""

#ifdef  AsdSDPCAMRQ_CRC_STRING
#undef  AsdSDPCAMRQ_CRC_STRING
#endif
#define AsdSDPCAMRQ_CRC_STRING "783607206"
...
//**************** Start AsdSDPCAMRQData Definition ****************
//                 ALS Copy Request and Coupon Book

//                 SDPCAMRQData.h generated by AceGen2 ver. 2.5.09

class AsdSDPCAMRQData
{
  public:
  ...
  public:
    AsdSDPCAMRQData ()  // Constructors
    {
        InitializeSessionData(&m_Sess);                      // InitializeSessionData declared in bcAce2.h
        m_Sess.pFileName = "SDPCAMRQ.ace";                       // This variable is fixed at gen time
        m_Sess.pProtocol = "TLU0";                           // This variable is fixed at gen time
        m_Sess.pIntegrityString = AsdSDPCAMRQ_INTEGRITY_STRING;  // This variable is fixed at gen time
    ...
    RWCString HostLUName (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pIntegrityTag, AsdSDPCAMRQ_INTEGRITY_STRING, NULL);
    ...
    long Execute (void)
    {
        ...
        AddXMLField(&m_Sess, m_Sess.pCRCTag, AsdSDPCAMRQ_CRC_STRING, NULL);
        ...
        if ((ret = ExecuteXMLTransaction(&m_Sess)) == 0)
        {
            if (GetXMLRecord(&m_Sess, m_Sess.pAceTag, NULL, NULL))
            {
                ...
                {
                    if(GetXMLRecord(&m_Sess, "SDPCAMRQ", NULL, NULL))
                    {
                        CTSHeader.Load(&m_Sess);
                        CSDAMRQII.Load(&m_Sess);
                        CTSMDA.Load(&m_Sess);
    
                        CloseXMLRecord(&m_Sess, "SDPCAMRQ");
                    }
...
//**************** End AsdSDPCAMRQData Definition ****************

typedef AsdSDPCAMRQData *LPSDPCAMRQ;
typedef AsdSDPCAMRQData::AsdTSHeader *LPSDPCAMRQ_TSHeader;
typedef AsdSDPCAMRQData::AsdSDAMRQII *LPSDPCAMRQ_SDAMRQII;
typedef AsdSDPCAMRQData::AsdTSMDA *LPSDPCAMRQ_TSMDA;
typedef AsdSDPCAMRQData::AsdTSMDA::AsdMdaTrmMsg *LPSDPCAMRQ_TSMDA_MdaTrmMsg;
typedef AsdSDPCAMRQData::AsdTSMDA::AsdMdaTrmMsg::AsdMdaMsg *LPSDPCAMRQ_TSMDA_MdaTrmMsg_MdaMsg;
#endif    // AsdSDPCAMRQData_H
