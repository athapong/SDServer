...
/************************************************
   Tuxedo Service File : U:\ad\adLoginInformation\adSLoginInfo2.cpp
...
/**************************************************
**  Generated Tuxedo Service - adSLoginInfo2
**************************************************/
extern RWCString g_ComTraceSource;
extern "C" void adSLoginInfo2(TPSVCINFO *rqst)
{
   ...
   {   // scope block so that RWCString ImplMethod will call destructor before tpreturn
      ...
      g_ComTraceSource = RWCString("adSLoginInfo2") + RWCString(":") + ImplMethod;
      ...
      // Implementation of  Interface: AadILoginInfo2
      if (TranGuid == IID_IAadILoginInfo2)
      {
         ...
         if(ImplMethod == "Retrieve")
         {
            ...
            AadILoginInfo2 *IntObject;
            hresult = AbcCoCreateInstance(CLSID_AadPLoginInformation,NULL,CLSCTX_INPROC_SERVER,IID_IAadILoginInfo2,(LPVOID*) &IntObject);
            err = hresult;
            if(FAILED(hresult))
            {
               RWCString sCLSID;
               ...
               AbcStringFromCLSID(IID_IAadILoginInfo2,sIID);
               userlog("Error Creating Object {%s}, CLSID={%s}, Interface {%s}, IID={%s}, HRESULT=%ld","AadPLoginInformation",sCLSID.data(),"AadILoginInfo2", sIID.data(), hresult);
               IntObject = NULL;
            }
