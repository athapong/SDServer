...
int main(int argc, char *argv[]) {
	...
	char message_fmt[65536] ="POST /CoreGL/SD_All_Out HTTP/1.1\r\n";
	strcat(message_fmt,"POST http://10.200.115.196:9801/CoreGL/SD_All_Out HTTP/1.1\r\n");
	...
	strcat(message_fmt, "<ns:TMB_WS_PKG_MSG_Input xmlns:ns=\"http://xmlns.oracle.com/apps/gl/rest/TMB_WS_PKG/tmb_sd_all_out/\" xmlns:ns1=\"http://xmlns.oracle.com/apps/gl/rest/TMB_WS_PKG/header\">");
