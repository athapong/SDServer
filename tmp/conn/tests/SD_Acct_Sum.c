...
int main(int argc, char *argv[]) {
	...
	strcat(message_fmt,"Accept-Encoding: gzip,deflate\r\n");
	...
	strcat(message_fmt, contents);
	fclose(fp);
	// strcat(message_fmt, "<ns:TMB_WS_PKG_MSG_Input xmlns:ns=\"http://xmlns.oracle.com/apps/gl/rest/TMB_WS_PKG/tmb_sd_acct_sum/\" xmlns:ns1=\"http://xmlns.oracle.com/apps/gl/rest/TMB_WS_PKG/header\">");
